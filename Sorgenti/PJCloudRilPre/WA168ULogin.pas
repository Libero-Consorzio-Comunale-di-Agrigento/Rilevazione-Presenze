...
type
  TWA168FLogin = class(TWR101FLogin)
  private
...
implementation
uses WA168UIncentiviMaturati;

{$R *.dfm}

procedure TWA168FLogin.LanciaMainForm;
begin
  with TWA168FIncentiviMaturati.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
