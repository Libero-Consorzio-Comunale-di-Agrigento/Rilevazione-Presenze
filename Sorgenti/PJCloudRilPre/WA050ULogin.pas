...
type
  TWA050FLogin = class(TWR101FLogin)
  private
...
procedure TWA050FLogin.LanciaMainForm;
begin
  with TWA050FOrologi.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA050FLogin.SetAsMainForm;
