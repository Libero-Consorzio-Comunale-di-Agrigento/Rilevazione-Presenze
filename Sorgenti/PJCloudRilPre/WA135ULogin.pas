...
type
  TWA135FLogin = class(TWR101FLogin)
  private
...
procedure TWA135FLogin.LanciaMainForm;
begin
  with TWA135FTimbratureScartate.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
