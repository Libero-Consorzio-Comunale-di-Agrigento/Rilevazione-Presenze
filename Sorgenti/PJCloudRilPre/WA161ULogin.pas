...
type
  TWA161FLogin = class(TWR101FLogin)
  private
...
uses WA161UTipoAbbattimenti;

{$R *.dfm}

procedure TWA161FLogin.LanciaMainForm;
begin
  with TWA161FTipoAbbattimenti.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
