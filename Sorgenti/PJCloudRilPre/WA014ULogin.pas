...
type
  TWA014FLogin = class(TWR101FLogin)
  private
...
uses WA014UDebitiAggiuntivi;

{$R *.dfm}

procedure TWA014FLogin.LanciaMainForm;
begin
  with TWA014FDebitiAggiuntivi.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA014FLogin.SetAsMainForm;
