...
type
  TWA01FLogin = class(TWR101FLogin)
  private
...
uses WA017URaggrAsse;

{$R *.dfm}

procedure TWA01FLogin.LanciaMainForm;
begin
  with TWA017FRaggrAsse.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA01FLogin.SetAsMainForm;
