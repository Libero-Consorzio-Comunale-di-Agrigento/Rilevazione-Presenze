...
type
  TWA036FLogin = class(TWR101FLogin)
  private
...
procedure TWA036FLogin.LanciaMainForm;
begin
  with TWA036FTurniRep.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA036FLogin.SetAsMainForm;
