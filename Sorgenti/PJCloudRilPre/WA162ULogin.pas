...
uses
  ...
  meIWLink, WA162UIncentiviAssenze, IWApplication;

type
  TWA162FLogin = class(TWR101FLogin)
  protected
...
procedure TWA162FLogin.LanciaMainForm;
begin
  with TWA162FIncentiviAssenze.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
