...
type
  TWA085FLogin = class(TWR101FLogin)
  private
...
procedure TWA085FLogin.LanciaMainForm;
begin
  with TWA085FPartTime.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA085FLogin.SetAsMainForm;
