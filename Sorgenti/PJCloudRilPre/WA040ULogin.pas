...
uses
  ...
  IWControl, IWHTMLControls, meIWLink, IWApplication, meIWImageFile;

type
  TWA040FLogin = class(TWR101FLogin)
  private
...
uses WA040UPianifRep;

{$R *.dfm}

procedure TWA040FLogin.LanciaMainForm;
begin
  with TWA040FPianifRep.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA040FLogin.SetAsMainForm;
