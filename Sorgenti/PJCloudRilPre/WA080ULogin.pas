...
type
  TWA080FLogin = class(TWR101FLogin)
  private
...
uses WA080UTipologieCartellini;

{$R *.dfm}

procedure TWA080FLogin.LanciaMainForm;
begin
  with TWA080FTipologieCartellini.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA080FLogin.SetAsMainForm;
