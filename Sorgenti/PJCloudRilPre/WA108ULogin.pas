...
type
  TWA108FLogin = class(TWR101FLogin)
  private
...
uses WA108UInsAssAuto;

{$R *.dfm}

procedure TWA108FLogin.LanciaMainForm;
begin
  with TWA108FInsAssAuto.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWA108FLogin.SetAsMainForm;
