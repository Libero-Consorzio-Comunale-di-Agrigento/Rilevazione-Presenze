...
type
  TWA076FLogin = class(TWR101FLogin)
  private
...
uses WA076UIndGruppo;

{$R *.dfm}

procedure TWA076FLogin.LanciaMainForm;
begin
  with TWA076FIndGruppo.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWA076FLogin.SetAsMainForm;
