...
type
  TWA019FLogin = class(TWR101FLogin)
  private
...
uses WA019URaggrGiustif;

{$R *.dfm}

procedure TWA019FLogin.LanciaMainForm;
begin
  with TWA019FRaggrGiustif.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA019FLogin.SetAsMainForm;
