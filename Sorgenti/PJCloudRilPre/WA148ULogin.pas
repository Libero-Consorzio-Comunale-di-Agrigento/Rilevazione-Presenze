...
type
  TWA148FLogin = class(TWR101FLogin)
  private
...
uses WA148UProfiliImportazioneCertificatiINPS;

{$R *.dfm}

procedure TWA148FLogin.LanciaMainForm;
begin
  with TWA148FProfiliImportazioneCertificatiINPS.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWA148FLogin.SetAsMainForm;
