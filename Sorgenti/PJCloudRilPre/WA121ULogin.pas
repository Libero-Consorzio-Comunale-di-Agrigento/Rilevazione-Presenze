...
type
  TWA121FLogin = class(TWR101FLogin)
  private
...
uses WA121UOrganizzSindacali;

{$R *.dfm}

procedure TWA121FLogin.LanciaMainForm;
begin
  with TWA121FOrganizzSindacali.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA121FLogin.SetAsMainForm;
