...
type
  TWA018FLogin = class(TWR101FLogin)
  private
...
uses WA018URaggrPres;

{$R *.dfm}

procedure TWA018FLogin.LanciaMainForm;
begin
  with TWA018FRaggrPres.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA018FLogin.SetAsMainForm;
