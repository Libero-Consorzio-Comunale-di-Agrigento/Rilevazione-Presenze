...
type
  TWA020FLogin = class(TWR101FLogin)
  private
...
uses WA020UCausPresenze;

{$R *.dfm}

procedure TWA020FLogin.LanciaMainForm;
begin
  with TWA020FCausPresenze.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWA020FLogin.SetAsMainForm;
