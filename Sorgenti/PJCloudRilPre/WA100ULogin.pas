...
uses
  ...
  meIWLink,WA100UMissioni, IWApplication;

type
  TWA100FLogin = class(TWR101FLogin)
  protected
...
procedure TWA100FLogin.LanciaMainForm;
begin
  with TWA100FMissioni.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
