...
type
  TWA084FLogin = class(TWR101FLogin)
  private
...
uses WA084UTipoRapporto;

{$R *.dfm}

procedure TWA084FLogin.LanciaMainForm;
begin
  with TWA084FTipoRapporto.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA084FLogin.SetAsMainForm;
