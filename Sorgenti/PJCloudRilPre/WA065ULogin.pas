...
type
  TWA065FLogin = class(TWR101FLogin)
  private
...
uses WA065UStampaBudget;

{$R *.dfm}

procedure TWA065FLogin.LanciaMainForm;
begin
  with TWA065FStampaBudget.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
