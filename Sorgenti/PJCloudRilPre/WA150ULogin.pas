...
type
  TWA150FLogin = class(TWR101FLogin)
  private
...
uses WA150UAccorpamentoCausali;

{$R *.dfm}

procedure TWA150FLogin.LanciaMainForm;
begin
  inherited;
  with TWA150FAccorpamentoCausali.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA150FLogin.SetAsMainForm;
