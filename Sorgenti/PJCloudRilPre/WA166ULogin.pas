...
uses
  ...
  meIWLink, IWApplication, WA166UQuoteIndividuali;

type
  TWA166FLogin = class(TWR101FLogin)
  protected
...
procedure TWA166FLogin.LanciaMainForm;
begin
  with TWA166FQuoteIndividuali.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
