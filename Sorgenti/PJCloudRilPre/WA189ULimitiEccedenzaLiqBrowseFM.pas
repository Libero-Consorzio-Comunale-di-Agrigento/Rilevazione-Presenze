unit WA189ULimitiEccedenzaLiqBrowseFM;
...
uses
  ...
  WA189ULimitiEccedenzaLiqDM, meIWEdit, IWCompEdit, meIWLabel, medpIWMultiColumnComboBox,
  OracleData, Vcl.Menus;

type
  TWA189FLimitiEccedenzaLiqBrowseFM = class(TWR204FBrowseTabellaFM)
    procedure IWFrameRegionCreate(Sender: TObject);
    procedure grdTabellaDataSet2Componenti(Row: Integer);
  private
    procedure EditAsyncChange(Sender: TObject; EventParams: TStringList);
    procedure CaricaComboCampo(Row: Integer; NumeroCampo: String; NomeCampo: String);
  end;
...
procedure TWA189FLimitiEccedenzaLiqBrowseFM.IWFrameRegionCreate(
  Sender: TObject);
begin
  inherited;
...
procedure TWA189FLimitiEccedenzaLiqBrowseFM.grdTabellaDataSet2Componenti(
  Row: Integer);
var Edit: TmeIWEdit;
begin
  inherited;
...
procedure TWA189FLimitiEccedenzaLiqBrowseFM.CaricaComboCampo(Row:Integer;NumeroCampo: String;NomeCampo: String);
var
...
begin
  ...
  Combo.Items.Clear;
  Combo.Enabled:=True;
  with (WR302DM as TWA189FLimitiEccedenzaLiqDM).A094FSkLimitiStraordMW do
  begin
...
procedure TWA189FLimitiEccedenzaLiqBrowseFM.EditAsyncChange(Sender: TObject;
...
begin
  with (WR302DM as TWA189FLimitiEccedenzaLiqDM).A094FSkLimitiStraordMW do
  begin
    CambiaData((Sender as TmeIWEdit).Text,'L');
