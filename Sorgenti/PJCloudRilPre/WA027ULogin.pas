...
type
  TWA027FLogin = class(TWR101FLogin)
  private
...
procedure TWA027FLogin.LanciaMainForm;
begin
  with TWA027FCarMen.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA027FLogin.SetAsMainForm;
