...
type
  TWA066FLogin = class(TWR101FLogin)
  private
...
uses WA066UValutaStr;

{$R *.dfm}

procedure TWA066FLogin.LanciaMainForm;
begin
  with TWA066FValutaStr.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
