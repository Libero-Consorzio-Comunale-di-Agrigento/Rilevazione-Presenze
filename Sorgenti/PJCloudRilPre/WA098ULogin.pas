...
uses
  ...
  meIWLink, IWApplication, WA098UCalendarioOraLegaleSolare;

type
  TWA098FLogin = class(TWR101FLogin)
  protected
...
procedure TWA098FLogin.LanciaMainForm;
begin
  with TWA098FCalendarioOraLegaleSolare.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
