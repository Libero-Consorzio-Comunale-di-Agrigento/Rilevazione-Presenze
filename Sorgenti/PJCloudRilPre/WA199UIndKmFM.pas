...
uses
  ...
  OracleData, Data.DB, medpIWMultiColumnComboBox;

type
  TWA199FIndKmFM = class(TWR203FGestDetailFM)
...
procedure TWA199FIndKmFM.IWFrameRegionCreate(Sender: TObject);
begin
  inherited;
  // nasconde action
...
procedure TWA199FIndKmFM.CaricaDettaglio(DataSet: TDataSet;
...
procedure TWA199FIndKmFM.grdTabellaComponenti2DataSet(Row: Integer);
var
...
procedure TWA199FIndKmFM.grdTabellaDataSet2Componenti(Row: Integer);
begin
  inherited;
...
procedure TWA199FIndKmFM.actConfermaExecute(Sender: TObject);
begin
  inherited;
