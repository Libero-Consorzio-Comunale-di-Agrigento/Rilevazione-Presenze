...
uses
  ...
  meIWLink,IWApplication, WA170UGestioneGruppi;

type
  TWA170FLogin = class(TWR101FLogin)
  protected
...
{$R *.dfm}
 procedure TWA170FLogin.LanciaMainForm;
begin
  with TWA170FGestioneGruppi.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
