unit WA119UPartecipazioneScioperi;
...
type
  TWA119FPartecipazioneScioperi = class(TWR103FGestMasterDetail)
...
uses WA119UPartecipazioneScioperiDM,
     WA119UPartecipazioneScioperiBrowseFM,
     WA119UPartecipazioneScioperiDettFM;

{$R *.dfm}

{ TWA119FScioperi }

function TWA119FPartecipazioneScioperi.InizializzaAccesso: Boolean;
var
  LId: Integer;
begin
  Result:=True;
...
procedure TWA119FPartecipazioneScioperi.IWAppFormCreate(Sender: TObject);
begin
  inherited;
  ...
  WR302DM:=TWA119FPartecipazioneScioperiDM.Create(Self);
  WBrowseFM:=TWA119FPartecipazioneScioperiBrowseFM.Create(Self);
  WDettaglioFM:=TWA119FPartecipazioneScioperiDettFM.Create(Self);
  ...
  WA119FRichiesteFM.CaricaDettaglio((WR302DM as TWA119FPartecipazioneScioperiDM).A119MW.selT251,
                                    (WR302DM as TWA119FPartecipazioneScioperiDM).A119MW.dsrT251);
  WA119FRichiesteFM.PreparaComponenti;
  AggiornaDetails;
end;

procedure TWA119FPartecipazioneScioperi.ImpostazioniWC700;
begin
...
procedure TWA119FPartecipazioneScioperi.ResultWC700(Sender: TObject; Result: Boolean);
var S:String;
