...
uses
  ...
  meIWLink, WA172USchedeQuantIndividuali, IWApplication;

type
  TWA172FLogin = class(TWR101FLogin)
  protected
...
procedure TWA172FLogin.LanciaMainForm;
begin
  with TWA172FSchedeQuantIndividuali.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA172FLogin.SetAsMainForm;
end.
