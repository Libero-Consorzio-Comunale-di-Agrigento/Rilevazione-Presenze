...
type
  TWA043FLogin = class(TWR101FLogin)
  private
...
uses WA043UStampaRep;

{$R *.dfm}

procedure TWA043FLogin.LanciaMainForm;
begin
  with TWA043FStampaRep.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
