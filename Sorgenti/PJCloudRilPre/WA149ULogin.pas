...
uses
  ...
  meIWLink, WA149UCategRimborsi, IWApplication;

type
  TWA149FLogin = class(TWR101FLogin)
  private
...
procedure TWA149FLogin.LanciaMainForm;
begin
  TWA149FCategRimborsi.Create(GGetWebApplicationThreadVar).OpenPage
end;

initialization

TWA149FLogin.SetAsMainForm;
