...
type
  TWA057FLogin = class(TWR101FLogin)
  private
...
uses WA057USpostSquadra;

{$R *.dfm}

procedure TWA057FLogin.LanciaMainForm;
begin
  with TWA057FSpostSquadra.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWA057FLogin.SetAsMainForm;
