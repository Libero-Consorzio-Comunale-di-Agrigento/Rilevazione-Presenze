...
type
  TWA058FLogin = class(TWR101FLogin)
  private
...
uses WA058UPianifTurni;

{$R *.dfm}

procedure TWA058FLogin.LanciaMainForm;
begin
  with TWA058FPianifTurni.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
