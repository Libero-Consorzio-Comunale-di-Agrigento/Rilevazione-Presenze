...
type
  TWA112FLogin = class(TWR101FLogin)
  private
...
uses WA112UInvioMessaggi;

{$R *.dfm}

procedure TWA112FLogin.LanciaMainForm;
begin
  with TWA112FInvioMessaggi.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
