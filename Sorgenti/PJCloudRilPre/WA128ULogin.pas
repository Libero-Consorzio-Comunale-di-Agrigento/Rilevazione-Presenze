...
type
  TWA128FLogin = class(TWR101FLogin)
  private
...
procedure TWA128FLogin.LanciaMainForm;
begin
  with TWA128FPianPrestazioniAggiuntive.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA128FLogin.SetAsMainForm;
