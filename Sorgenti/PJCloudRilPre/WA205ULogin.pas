...
type
  TWA205FLogin = class(TWR101FLogin)
  private
...
procedure TWA205FLogin.LanciaMainForm;
begin
  with TWA205FSquadre.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA205FLogin.SetAsMainForm;
