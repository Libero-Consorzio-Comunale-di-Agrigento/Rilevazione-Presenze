...
type
  TWA155FLogin = class(TWR101FLogin)
  protected
...
uses WA155URicercaDocumentale;

{ TWA155FLogin }

procedure TWA155FLogin.LanciaMainForm;
begin
  with TWA155FRicercaDocumentale.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
