...
type
  TWA142FLogin = class(TWR101FLogin)
  private
...
uses WA142UQualifMinisteriali;

{$R *.dfm}

procedure TWA142FLogin.LanciaMainForm;
begin
  with TWA142FQualifMinisteriali.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWA142FLogin.SetAsMainForm;
