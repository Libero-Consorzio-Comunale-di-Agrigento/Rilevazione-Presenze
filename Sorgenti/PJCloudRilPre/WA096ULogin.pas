...
type
  TWA096FLogin = class(TWR101FLogin)
  private
...
uses WA096UProfiliLibProf;

{$R *.dfm}

procedure TWA096FLogin.LanciaMainForm;
begin
  with TWA096FProfiliLibProf.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
