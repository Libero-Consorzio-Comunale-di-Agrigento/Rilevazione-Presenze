...
type
  ...
  TQueryDataRetribuzione = class(TOracleDataSet)
  private
    { Private declarations }
  protected
    { Protected declarations }
  public
    ...
    constructor Create(AOwner:TComponent); override;
    destructor Destroy; override;
    function ImpostaDataRetribuzione(Progressivo:Integer;DataCedolino,DataRetribuzione:TDateTime;TipoCedolino:String):TDateTime;
  published
    { Published declarations }
  end;
...
const
  ...
  VFStipendioONAOSI:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'00025'; CodVoceSpeciale:'BASE');
  ...
  VFSommaErediIndennitaPreavviso:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'06004'; CodVoceSpeciale:'BASE');
  ...
  VFImponibileCPDELDecontrib:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'10018'; CodVoceSpeciale:'BASE');
  VFImponibileCPSDecontrib:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'10028'; CodVoceSpeciale:'BASE');
  VFImponibileTFSDip:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'10040'; CodVoceSpeciale:'BASE');
  VFVariazImponibiliTFSTFR:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'10042'; CodVoceSpeciale:'BASE');
  VFVariazImponibiliTFSTFRDipEnte:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'10043'; CodVoceSpeciale:'BASE');
  ...
  VFImponibileTFRDipEnte:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'10070'; CodVoceSpeciale:'ENTE');
  ...
  VFAbbattImponibileIRPEF:TVF =
     (CodContratto:''; CodVoce:'10203'; CodVoceSpeciale:'BASE');
  VFAbbattImponibileIRPEFCong:TVF =
     (CodContratto:''; CodVoce:'10203'; CodVoceSpeciale:'CONG');
  ...
  VFImponibileENPAMAssicGenerici:TVF =
     (CodContratto:'''EDPSC'''; CodVoce:'10415'; CodVoceSpeciale:'BASE');
  VFImponibileIRPEFAcconto:TVF =
     (CodContratto:''; CodVoce:'10500'; CodVoceSpeciale:'BASE');
  ...
  VFRitenutaCPDEL1PerCentoCong:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'11017'; CodVoceSpeciale:'CONG');
  VFRitenutaCPS1PerCentoCong:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'11027'; CodVoceSpeciale:'CONG');
  ...
  VFDetrazioniPerLavDipUlteriori:TVF =
     (CodContratto:''; CodVoce:'13015'; CodVoceSpeciale:'BASE');
  VFDetrazioniPerLavDipUlterioriCong:TVF =
     (CodContratto:''; CodVoce:'13017'; CodVoceSpeciale:'CONG');
  VFDetrazioniPerLavDipUlterioriRate:TVF =
     (CodContratto:''; CodVoce:'13018'; CodVoceSpeciale:'BASE');
  ...
  VFCreditoRiconosPerFamNumeroseAnnuo:TVF =
  ...
  VFTrattIntegrLavDip:TVF =
     (CodContratto:''; CodVoce:'13165'; CodVoceSpeciale:'BASE');
  VFTrattIntegrLavDipCong:TVF =
     (CodContratto:''; CodVoce:'13165'; CodVoceSpeciale:'CONG');
  VFTrattIntegrLavDipRate:TVF =
     (CodContratto:''; CodVoce:'13168'; CodVoceSpeciale:'BASE');
  VFRedditiAssimilatiNoDetrazioni:TVF =
     (CodContratto:''; CodVoce:'14010'; CodVoceSpeciale:'BASE');
  VFRedditiAssegniDalConiuge:TVF =
     (CodContratto:''; CodVoce:'14015'; CodVoceSpeciale:'BASE');
  ...
  VFImponibileTFSOptanti:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'14130'; CodVoceSpeciale:'BASE');
  VFCompetenzeCorrentiINPS:TVF =
     (CodContratto:'''EDP'',''EDPEL'''; CodVoce:'14200'; CodVoceSpeciale:'BASE');
  VFMalattiaPrimi10ggAl100:TVF =
     (CodContratto:''; CodVoce:'15028'; CodVoceSpeciale:'BASE');
  EccezioniElenco:array [1..6] of TEccezioniElenco =
    (
      ...
      (Codice:'e';Descrizione:'Dettaglio oneri riflessi per impegno di spesa'),
      (Codice:'f';Descrizione:'Esclusione assoggettamento assicurazione malattia generici')
    );

  //Vettore contenente le parti della CU che hanno necessità di essere spezzate in più moduli
  VetGruppiTotali: array[1..3] of TGruppiTotali = ((Parte:'C21'; Numero:'017'),(Parte:'C26'; Numero:'059'),(Parte:'E21'; Numero:'033'));
...
begin
  ...
  SQL.Add('COD_VOCE_LINK_ASSOG,COD_VOCE_SPECIALE_LINK_ASSOG');
...
constructor TQueryDataRetribuzione.Create(AOwner:TComponent);
begin
  inherited Create(AOwner);
  SQL.Add('SELECT P430.RETRIB_MESE_PREC FROM P430_ANAGRAFICO P430');
  SQL.Add('WHERE P430.PROGRESSIVO = :Progressivo');
  SQL.Add('AND :DataCedolino BETWEEN P430.DECORRENZA AND P430.DECORRENZA_FINE');
  DeclareVariable('Progressivo',otInteger);
  DeclareVariable('DataCedolino',otDate);
end;

function TQueryDataRetribuzione.ImpostaDataRetribuzione(Progressivo:Integer;DataCedolino,DataRetribuzione:TDateTime;TipoCedolino:String):TDateTime;
//Verifica se Tipo retribuzione vale Mese precedente
begin
  Result:=DataRetribuzione;
  if (DataCedolino <> DataRetribuzione) or (TipoCedolino <> 'NR') then
    exit;
  if (Progressivo <> GetVariable('Progressivo'))
  or (DataCedolino <> GetVariable('DataCedolino')) then
  begin
    SetVariable('Progressivo',Progressivo);
    SetVariable('DataCedolino',DataCedolino);
    Close;
    Open;
  end;
  if Eof then
    exit
  else if FieldByName('RETRIB_MESE_PREC').AsString = 'P' then
    //Gestione Tipo retribuzione valorizzata a Mese precedente
    Result:=R180InizioMese(DataCedolino) - 1;
end;

destructor TQueryDataRetribuzione.Destroy;
begin
  Close;
  inherited Destroy;
end;
