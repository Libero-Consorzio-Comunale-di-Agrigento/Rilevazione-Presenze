...
begin
  FreeAndNil(FComboRows);//.Free;
  FreeAndNil(FColumnTitles);//.Free;
...
begin
  ...
  try
    ...
    js:=js + '$("#' + HTMLName + '").removeClass().addClass("' + cssInputText + '"); ' + #13#10;
