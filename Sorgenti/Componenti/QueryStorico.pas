...
type
  ...
  public
    ...
    class function GiorniServizio(Progressivo:Integer; Dal,Al:TDateTime; TipoPeriodo:String = 'S'):Integer;
  published
    { Published declarations }
  end;
...
class function TDipendenteInServizio.GiorniServizio(Progressivo: Integer; Dal, Al: TDateTime; TipoPeriodo: String = 'S'):Integer;
begin
  with TOracleQuery.Create(nil) do
  try
    Session:=SessioneOracle;
    SQL.Text:='select T430F_GIORNISERVIZIO(:PROGRESSIVO,:DAL,:AL,:TIPOPERIODO) from dual';
    DeclareAndSet('PROGRESSIVO',otInteger,Progressivo);
    DeclareAndSet('DAL',otDate,Dal);
    DeclareAndSet('AL',otDate,Al);
    DeclareAndSet('TIPOPERIODO',otString,TipoPeriodo);
    Execute;
