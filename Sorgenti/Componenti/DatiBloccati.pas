...
type
  ...
  public
    ...
    procedure BloccaRiepilogo(Progressivo:Integer; Dal,Al:TDateTime; Riepilogo:String);
...
procedure TDatiBloccati.BloccaRiepilogo(Progressivo:Integer; Dal,Al:TDateTime; Riepilogo:String);
begin
  with TOracleQuery.Create(nil) do
  try
    Session:=Self.Session;
    SQL.Add('begin');
    SQL.Add('T180P_BLOCCARIEPILOGHI(:progressivo,:riepilogo,:dal,:al);');
    SQL.Add('end;');
