  ...
  try
    ...
    try
      ...
      *)
        ...
        CommaText:=A052FParCarDtM1.selT950.FieldByName(A052FParCarDtM1.A052FParCarMW.FieldCausali).AsString;
    ...
    begin
      ...
      *)
        ...
        A052FParCarDtM1.selT950.FieldByName(A052FParCarDtM1.A052FParCarMW.FieldCausali).AsString:=S;
    end;
  finally
...
begin
  gpbCauPresEscluse.Caption:=IfThen(A052FParCarDtM1.A052FParCarMW.FieldCausali = 'CAUPRES_ESCLUSE','Causali di presenza da non visualizzare','Causali di presenza da riepilogare');
  dedtCauPresEscluse.DataField:=A052FParCarDtM1.A052FParCarMW.FieldCausali;//IfThen(CausaliDaVisualizzare,'CAUPRES','CAUPRES_ESCLUSE');
end;
