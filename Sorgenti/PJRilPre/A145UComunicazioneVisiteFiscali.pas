...
uses
  ...
  OracleData, Menus, Printers, DBCtrls, Math, Oracle, TypInfo, A000UMessaggi, InputPeriodo;
...
begin
  ...
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.InizioElaborazione(Esenzioni);

  // ciclo principale sulle persone selezionate
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.SelAnagrafe.First;
  while not A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.SelAnagrafe.Eof do
  begin
    ...
    A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.ElaboraElemento(Esenzioni);
    // passa all'anagrafica successiva
    A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.SelAnagrafe.Next;
...
begin
  // pulizia variabili
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataElaborazione:=0;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataDa:=0;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataA:=0;
  ...
  begin
    ...
    if DataI > 0 then A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataDa:= DataI
    else
    begin
      if tipoModulo = 'CS' then
    ...
    if DataF > 0 then A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataA:= DataF
    else
    begin
      if tipoModulo = 'CS' then
...
var
  i: Integer;
begin
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bAggiorna:=chkAggiorna.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bPeriodiComunicati:=chkPeriodiComunicati.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bNumProt:=chkNumProt.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sNumProt:=edtNumProt.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bLuogo:=chkLuogo.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sLuogo:=edtLuogo.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sDato1:=memDato1.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sDato2:=memDato2.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sFirma:=memFirma.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bProl:=chkProl.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sMedicineLegali:='';
  if dcmbMedicineLegali.KeyValue <> null then
    A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sMedicineLegali:=VarToStr(dcmbMedicineLegali.KeyValue);
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bEsenzioneAutomatica:=chkEsenzioneAutomatica.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.iTipoStampa:=rgpTipoStampa.ItemIndex;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sMaxGiorniContinuativi:=edtMaxGiorniContinuativi.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sMesiVerificaEventi:=edtMesiVerificaEventi.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.sNumeroMinimoEventi:=edtNumeroMinimoEventi.Text;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bFiltroDataComun:=chkFiltroDataComun.Checked;
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bSoloCont:=chkSoloCont.Checked;

  // valorizza la stringlist dei campi di dettaglio richiesti
  A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Clear;
  if TipoModulo = 'CS' then
  begin
    for i:=0 to chkLDettaglio.Items.Count - 1 do
      if chkLDettaglio.Checked[i] then
        A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Add(VarToStr(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.selI010.Lookup('NOME_LOGICO',chkLDettaglio.Items[i],'NOME_CAMPO')));
  end
  else
  begin
    for i:=0 to lstElementiDettaglioCOM.Count - 1 do
      A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Add(VarToStr(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.selI010.Lookup('NOME_LOGICO',lstElementiDettaglioCOM[i],'NOME_CAMPO')));
  end;
end;
...
begin
  ...
  DataInizio:=IfThen(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bPeriodiComunicati,A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataDa,A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataElaborazione);
  DataFine:=IfThen(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bPeriodiComunicati,A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataA,A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataElaborazione);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        A145FStampaComunicazioneVisiteFiscali.QRep.Page.Orientation:=poLandscape;
        // crea il report
        A145FStampaComunicazioneVisiteFiscali.CreaReport;
        A145FStampaComunicazioneVisiteFiscali.DistruggiLstObj;
      end
      else
        // crea il report
...
begin
  ...
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.Close;
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.SetVariable('DATA_ANNULLAMENTO',DataUltimaComunicazione);
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.Open;

  // impostazioni progressbar
  ProgressBar.Position:=0;
  ProgressBar.Max:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.RecordCount;

  // ciclo di annullamento
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.First;
  while not A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.Eof do
  begin
    A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.AnnullaDataComunicazione(DataUltimaComunicazione);
    A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.selT047PAnnullato.Next;
    ProgressBar.StepBy(1);
  end;
  ...
  StatusBar.Panels[1].Text:='Ottimizzazione periodi di assenza in corso...';
  StatusBar.Repaint;
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.CompensaPeriodi;
  A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.UnificaPeriodi;
  StatusBar.Panels[1].Text:='';
  StatusBar.Repaint;
  MessaggioDCOM:='';
  if TipoModulo = 'CS' then
...
begin
  ...
  A145FStampaIndividuale.QRep.PrinterSettings.UseStandardPrinter:=(TipoModulo = 'COM') and Parametri.UseStandardPrinter;
...
begin
  ...
  R180AbilitaOggetti(frmInputPeriodo, chkPeriodiComunicati.Checked);
...
begin
  ...
  if Length(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Text) > 80 then
    A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Text:=Copy(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Text,1,80);
  C004FParamForm.PutParametro('LISTA_DETTAGLI',A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.ListaDettaglio.Text);
...
begin
  chkIns.Enabled:=(not chkAnnulla.Checked);
  chkProl.Enabled:=(not chkAnnulla.Checked);
...
begin
  ...
  R180AbilitaOggetti(frmInputPeriodo, chkPeriodiComunicati.Checked or chkFiltroDataComun.Checked or chkFiltroDataComun.Checked);
  DataI:= IfThen(chkPeriodiComunicati.Checked or chkFiltroDataComun.Checked  or chkFiltroDataComun.Checked, Parametri.DataLavoro, 0);
  DataF:= IfThen(chkPeriodiComunicati.Checked or chkFiltroDataComun.Checked  or chkFiltroDataComun.Checked, Parametri.DataLavoro, 0);
...
begin
  ...
  frmInputPeriodo.CaptionDataOutI:= 'Data iniziale del periodo';
  frmInputPeriodo.CaptionDataOutI:= 'Data finale del periodo';
end;
...
{ DataF }
function TA145FComunicazioneVisiteFiscali._GetDataF: TDateTime;
begin
  Result := frmInputPeriodo.DataFine;
end;
procedure TA145FComunicazioneVisiteFiscali._PutDataF(const Value: TDateTime);
begin
  frmInputPeriodo.DataFine := Value;
end;
{ ----DataF }
{ DataI }
function TA145FComunicazioneVisiteFiscali._GetDataI: TDateTime;
begin
  Result := frmInputPeriodo.DataInizio;
end;
procedure TA145FComunicazioneVisiteFiscali._PutDataI(const Value: TDateTime);
begin
