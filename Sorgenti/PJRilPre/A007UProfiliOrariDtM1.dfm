inherited A007FProfiliOrariDtM1: TA007FProfiliOrariDtM1
  ...
  object Q220: TOracleDataSet
    ...
    object Q220PESO_SCOSTENTRATA_S: TIntegerField
      FieldName = 'PESO_SCOSTENTRATA_S'
      ReadOnly = True
    end
    object Q220PESO_TIMBESTERNE: TIntegerField
      FieldName = 'PESO_TIMBESTERNE'
      ReadOnly = True
    end
    object Q220PESO_TIMBNONAPPOGGIATE_S: TIntegerField
      FieldName = 'PESO_TIMBNONAPPOGGIATE_S'
      ReadOnly = True
    end
    object Q220PESO_TIMBNONAPPOGGIATE_N: TIntegerField
      FieldName = 'PESO_TIMBNONAPPOGGIATE_N'
      ReadOnly = True
    end
    object Q220PESO_PRITIMSC_S: TIntegerField
      FieldName = 'PESO_PRITIMSC_S'
      ReadOnly = True
    end
    object Q220PESO_PRITIMSC_A: TIntegerField
      FieldName = 'PESO_PRITIMSC_A'
      ReadOnly = True
    end
    object Q220PESO_MINANTSCELTA: TIntegerField
      FieldName = 'PESO_MINANTSCELTA'
      ReadOnly = True
    end
    object Q220PESO_RITARDO_ENTRATA: TIntegerField
      FieldName = 'PESO_RITARDO_ENTRATA'
      ReadOnly = True
    end
    object Q220IGNORA_STACCOPMT: TStringField
