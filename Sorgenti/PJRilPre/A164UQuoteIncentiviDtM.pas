...
type
  TA164FQuoteIncentiviDtM = class(TR004FGestStoricoDtM)
    ...
    selT770CONSIDERA_PROVA: TStringField;
    selT770TIPIRAPPORTO_SOSPENSIONE: TStringField;
    selT770DURATA_SOSPENSIONE: TFloatField;
    selT770ESCLUSIONE_VALORI: TStringField;
