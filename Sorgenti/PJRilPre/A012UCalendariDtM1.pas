...
begin
  with DataSet do
    if FieldByName('ANNO').AsInteger > 0 then
      EncodeDate(FieldByName('ANNO').AsInteger,FieldByName('MESE').AsInteger,FieldByName('Giorno').AsInteger)
    else
      EncodeDate(R180Anno(Date),FieldByName('MESE').AsInteger,FieldByName('Giorno').AsInteger);
end;
