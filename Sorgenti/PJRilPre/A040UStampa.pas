...
uses
  ...
  Variants, QRExport, QRWebFilt, QRPDFFilt, Math, StrUtils;
...
procedure TA040FStampa.CreaReport;
...
begin
  ...
  if A040FPianifRepDtM1.CampoGruppo1 <> '' then
  begin
    QRGroup1.Expression:=A040FPianifRepDtM1.CampoGruppo1 + IfThen(A040FPianifRepDtM1.CampoGruppo2 <> '',' + ' + A040FPianifRepDtM1.CampoGruppo2);
    QRLRaggruppamento1.Caption:=A040FPianifRepDtM1.NomeLogicoCampoGruppo1;
    QRDBTGruppo1.DataField:=A040FPianifRepDtM1.CampoGruppo1;
    QRLRaggruppamento2.Caption:=A040FPianifRepDtM1.NomeLogicoCampoGruppo2;
    QRDBTGruppo2.DataField:=A040FPianifRepDtM1.CampoGruppo2;
    QRDBTGruppo2.Enabled:=A040FPianifRepDtM1.CampoGruppo2 <> '';//Altimenti va in errore perché, anche se il DataField viene svuotato, in qualche modo il componente rimane ancora legato ad un campo di Q380St che non esiste più
    QRGroup1.Enabled:=True;
    QRGroup1.Height:=IfThen(A040FPianifRepDtM1.NomeLogicoCampoGruppo2 <> '',48,30);
  end
  else
