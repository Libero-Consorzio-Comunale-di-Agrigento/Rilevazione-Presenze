...
begin
  ...
  R003FGeneratoreStampeMW.TipoModulo:=A077FGeneratoreStampe.TipoModulo;
  inherited;
...
begin
  ...
  begin
    ...
    AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,'T920_KEY' + NumTab,'VARCHAR2(2000)',otString);
    AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,'T920_KEYTOT' + NumTab,'VARCHAR2(2000)',otString);
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'DESCINDPRESENZA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
    ...
    CD920.SQL.Add(') ' + T920StorageParam);
    CD920.Execute;
    CreateIndexX920_xx(NumTab);
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'DESCRIZIONEPRESENZE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'GIUSTIFICATIVI' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'TURNIREPERIBILITA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(17)',otString) else
        ...
        if D = 'ASSENZADESCRIZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'PRESENZADESCRIZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'LIBERAPROFESSIONEDESCRIZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'ANOMALIEGGDESCRIZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'CONVENZIONATISTRUTTURA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(30)',otString) else
        if D = 'CONVENZIONATIOREPREVISTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'NUMBER',otInteger) else
        if D = 'CONVENZIONATIORERESE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'NUMBER',otInteger)
        ;
      end;
    CD920.SQL.Add(CreateTable);
    CD920.SQL.Add(') ' + T920StorageParam);
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'NOTEDIVARIAZIONESALDOANNO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'NOTEACQUISTOBUONITICKET' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'MT_PARTENZA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'MT_DESTINAZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'MT_NOTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'MT_COMMESSA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(80)',otString) else
        if D = 'MT_VOCEPAGHE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString);
      end;
    CD920.SQL.Add(CreateTable);
    CD920.SQL.Add(') ' + T920StorageParam);
    CD920.Execute;
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'MR_DESCRIZIONERIMBORSO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        // nuovi dati 8.5.fine
        if D = 'MR_VOCEPAGHE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'VP_DESCRIZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'IR_VP_TURNO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
        if D = 'IR_VP_SPEZZONI' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
        if D = 'IR_VP_OREMAGGIORATE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
        if D = 'IR_VP_ORENONMAGG' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
        if D = 'IR_VP_TURNIOLTREMAX' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
        if D = 'IR_VP_GETTONECHIAMATA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'CF_TITOLO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'CF_D_PROFILO_CREDITI' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'CF_TIPO_CORSO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(5)',otString) else
        if D = 'CF_D_TIPO_CORSO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'CF_D_LUOGO_CORSO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'CF_METODO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(15)',otString) else
        if D = 'CF_D_METODO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'CF_D_ENTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'CF_TIPOLOGIA_ENTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(5)',otString) else
        if D = 'CF_D_TIPOLOGIA_ENTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'CF_D_NUMERO_GIORNO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'MK_DESCRIZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'MK_VOCEPAGHE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(10)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        else if D = 'QI_DESC_TIPO_QUOTA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString)
        ...
        else if D = 'QI_TIPOABBATTIMENTO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString)
        ...
        else if D = 'QI_DESC_TIPO_IMPORTO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString)
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'MA_NOTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
  ...
  begin
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      ...
      begin
        ...
        if D = 'VA_DESC_STATO_SCHEDA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'VA_DATA_COMPILAZIONE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'DATE',otDate) else
        if D = 'VA_PROGRESSIVI_VALUTATORI' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'VA_DESC_VALUTATORI' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_VALUTAZIONE_INTERMEDIA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_OBIETTIVI_AZIONI' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_PROPOSTE_FORMATIVE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_DATA_ACCETTAZIONE_VALUTATO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'DATE',otDate) else
        if D = 'VA_COMMENTI_VALUTATO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        if D = 'VA_STORIA_COMMENTI_VALUTATO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(4000)',otString) else
        if D = 'VA_NOTE' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_DESC_AREA' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_DESC_ELEMENTO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString) else
        ...
        if D = 'VA_NOTE_PUNTEGGIO' then AddDatoTabCollegata(Ins920x,CreateTable,InsertList,InsertVal,D,'VARCHAR2(2000)',otString);
      end;
    CD920.SQL.Add(CreateTable);
    CD920.SQL.Add(') ' + T920StorageParam);
    CD920.Execute;
...
begin
  ...
  with A077FGeneratoreStampe do
  begin
    R003FGeneratoreStampeMW.DaData:=A077FGeneratoreStampe.DataI;
    R003FGeneratoreStampeMW.AData:=A077FGeneratoreStampe.DataF;
    ...
    for i:=0 to High(R003FGeneratoreStampeMW.DatiStampa) do
      if (R003FGeneratoreStampeMW.Dati[R003FGeneratoreStampeMW.DatiStampa[i].N].R = 1) and
         ...
         (Copy(UpperCase(R003FGeneratoreStampeMW.DatiStampa[i].D),1,8) <> 'CDCPERC_') and
         (not R003FGeneratoreStampeMW.DatiStampa[i].D.ToUpper.StartsWith('I060')) then
      begin
        if SAnagra <> '' then
          SAnagra:=SAnagra + ',';
    ...
    begin
      ...
      if EsisteRoutine(30) then
        GetFamiliari{Eredito da R003Dtm};
      R003FGeneratoreStampeMW.InserisciT920(DataF);
      C700SelAnagrafe.Next;
    end;
    finally
...
begin
  with R003FGeneratoreStampeMW do
    ...
    else if Dato = 'SALDONEGRECUPERATOCONRIEPASS' then
      PutValore(i,DatiStampa[i].V,IntToStr(R450DtM1.RiepAssCompensateAnno),Key,KeyTot,1,Valido)
    ...
    else if Dato = 'BANCAORERECINTERNNELMESE' then
      PutValore(i,DatiStampa[i].V,IntToStr(R450DtM1.BancaOreRecInternaMensile),Key,KeyTot,0,True)
    ...
    else if Dato = 'OREPERMESSIADDEBITATE' then
      PutValore(i,DatiStampa[i].V,IntToStr(R450DtM1.OrePermesso.Addebitate),Key,KeyTot,0,True)
    else if Dato = 'OREPERMESSIDARECUPERARE' then
      PutValore(i,DatiStampa[i].V,IntToStr(R450DtM1.OrePermesso.DaRecuperare),Key,KeyTot,0,True);
end;
...
begin
  ...
  begin
    ...
    if Dato = 'INDPRESENZATOTALI' then
      ...
      PutValore(i,DatiStampa[i].V,R450DtM1.LeggiValoreT077(I011RIENTRIPOM_TEORICI,D),Key,KeyTot,1,True)
    else if Dato = 'RIENTRIPOMREALIDOVUTI' then
      PutValore(i,DatiStampa[i].V,R450DtM1.LeggiValoreT077(I011RIENTRIPOM_REALI,D),Key,KeyTot,1,True)
    else if Dato = 'RIENTRIPOMRESI' then
      PutValore(i,DatiStampa[i].V,R450DtM1.LeggiValoreT077(I011RIENTRIPOM_RESI,D),Key,KeyTot,1,True)
    else if Dato = 'SALDORIENTRIPOM' then
      PutValore(i,DatiStampa[i].V,R450DtM1.LeggiValoreT077(I011RIENTRIPOM_SALDO,D),Key,KeyTot,1,True)
    ...
    else if Dato = 'NOTEACQUISTOBUONITICKET' then
      PutValore(i,DatiStampa[i].V,R450DtM1.NoteAcquistoBuoniTicket,Key,KeyTot,0,True);
  end;
end;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          else if Dato = 'COMPASSTOTALI1' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.ResiduiVal[1] + R600DtM1.VisCompetenzeAC[1]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'COMPASSTOTALI2' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.ResiduiVal[2] + R600DtM1.VisCompetenzeAC[2]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'COMPASSTOTALI3' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.ResiduiVal[3] + R600DtM1.VisCompetenzeAC[3]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'COMPASSTOTALI4' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.ResiduiVal[4] + R600DtM1.VisCompetenzeAC[4]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'COMPASSTOTALI5' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.ResiduiVal[5] + R600DtM1.VisCompetenzeAC[5]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'COMPASSTOTALI6' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.ResiduiVal[6] + R600DtM1.VisCompetenzeAC[6]),Key,KeyTot,TipoCumulo,True)
          ...
          else if Dato = 'ASSENZEFRUITE1' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.VisFruitoAP[1] + R600DtM1.VisFruitoAC[1]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZEFRUITE2' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.VisFruitoAP[2] + R600DtM1.VisFruitoAC[2]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZEFRUITE3' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.VisFruitoAP[3] + R600DtM1.VisFruitoAC[3]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZEFRUITE4' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.VisFruitoAP[4] + R600DtM1.VisFruitoAC[4]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZEFRUITE5' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.VisFruitoAP[5] + R600DtM1.VisFruitoAC[5]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZEFRUITE6' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.VisFruitoAP[6] + R600DtM1.VisFruitoAC[6]),Key,KeyTot,TipoCumulo,True)
          ...
          else if Dato = 'ASSENZERESIDUE1' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.Competenze[1]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZERESIDUE2' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.Competenze[2]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZERESIDUE3' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.Competenze[3]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZERESIDUE4' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.Competenze[4]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZERESIDUE5' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.Competenze[5]),Key,KeyTot,TipoCumulo,True)
          else if Dato = 'ASSENZERESIDUE6' then
            PutValore(j,R003FGeneratoreStampeMW.DatiStampa[j].V,FloatToStr(R600DtM1.Competenze[6]),Key,KeyTot,TipoCumulo,True)
  ...
  begin
    ...
    for i:=0 to chklstAssenze.Items.Count - 1 do
      ...
      begin
        ...
        begin
          if CompAssenze then
            selDataNas:=R600DtM1.selSG101DataNasCausale
          else
            selDataNas:=R600DtM1.selT040DataNas;
          with selDataNas do
          begin
            Close;
            SetVariable('Progressivo',C700Progressivo);
            ...
            if dchkPeriodoStorico.Checked then
            begin
              SetVariable('Data1',Max(R003FGeneratoreStampeMW.DaData,DipendenteCorrente.Dal));
...
const RInterno = 8;
  procedure SettaPeriodoConteggioDalleAlle;
  var Dalle,Alle:String;
  begin
    R502ProDtM1.f03_com:='';
    Dalle:=Trim(StringReplace(A077FGeneratoreStampe.edtDalleOre.Text,'.','',[]));
    Alle:=Trim(StringReplace(A077FGeneratoreStampe.edtAlleOre.Text,'.','',[]));
    if (Dalle <> '') and (Alle <> '') then
    begin
      Dalle:=Dalle.PadLeft(4,'0');
      Alle:=Alle.PadLeft(4,'0');
      if Dalle >= Alle then
        //Conteggio a cavallo di mezzanotte
        R502ProDtM1.f03_com:='DALLE*' + Dalle + 'ALLE*' + Alle + '+'
      else
        //Conteggio normale
        R502ProDtM1.f03_com:='DALLE*' + Dalle + '*ALLE*' + Alle;
    end;
        ...
        try
          ...
          begin
            ...
            begin
              ...
              PutPrimoValore(IntToStr(prpStrgiorn),blocca = 0)
            ...
            else if Dato = 'CONVENZIONATISTRUTTURA' then
            begin
              if iCiclo - 1 <= High(RiepStruttureConvenzionate) then
                PutValore(j,DatiStampa[j].V,RiepStruttureConvenzionate[iCiclo - 1].Causale,Key,KeyTot,DatiStampa[j].F,blocca = 0)
              else
                PutValore(j,DatiStampa[j].V,'',Key,KeyTot,DatiStampa[j].F,blocca = 0);
            end
            else if Dato = 'CONVENZIONATIOREPREVISTE' then
            begin
              if iCiclo - 1 <= High(RiepStruttureConvenzionate) then
                PutValore(j,DatiStampa[j].V,IntToStr(RiepStruttureConvenzionate[iCiclo - 1].OrePianificate),Key,KeyTot,DatiStampa[j].F,blocca = 0)
              else
                PutValore(j,DatiStampa[j].V,'0',Key,KeyTot,DatiStampa[j].F,blocca = 0);
            end
            else if Dato = 'CONVENZIONATIORERESE' then
            begin
              if iCiclo - 1 <= High(RiepStruttureConvenzionate) then
                PutValore(j,DatiStampa[j].V,IntToStr(RiepStruttureConvenzionate[iCiclo - 1].OreRese),Key,KeyTot,DatiStampa[j].F,blocca = 0)
              else
                PutValore(j,DatiStampa[j].V,'0',Key,KeyTot,DatiStampa[j].F,blocca = 0);
            end
            ;
...
begin
  ...
  R502ProDtM1.ConsideraRichiesteWeb:=A077FGeneratoreStampe.chkConteggiGGIter.Checked;
  ...
  begin
    SettaPeriodoConteggioDalleAlle;
    ...
    with R003FGeneratoreStampeMW.Serbatoi[A077FGeneratoreStampe.GetIdxSerbatoi(RInterno)] do
      ...
      begin
        ...
        if Dato = 'RILEVATORIDELGIORNO' then
          ...
          HighCiclo:=max(HighCiclo,Length(R502ProDtM1.RiepStruttureConvenzionate))
        ;
      end;
    if HighCiclo = 0 then
      HighCiclo:=1;
    ...
    begin
      ...
      with R003FGeneratoreStampeMW.Serbatoi[A077FGeneratoreStampe.GetIdxSerbatoi(RInterno)] do
        ...
        begin
          ...
          else if (Dato = 'CONVENZIONATISTRUTTURA') and (iCiclo - 1 <= High(R502ProDtM1.RiepStruttureConvenzionate)) then
            S:=R502ProDtM1.RiepStruttureConvenzionate[iCiclo - 1].Causale
          ;
          Key:=Key + S;
          if KeyCumulo[kc].Totale then
            KeyTot:=KeyTot + S;
...
const RInterno = 22;
  ...
  begin
    ...
    if selC20Incarichi.VariableIndex('DECORRENZA') >= 0 then
      R180SetVariable(selC20Incarichi,'DECORRENZA',{R003FGeneratoreStampeMW.AData}DipendenteCorrente.DettaglioPeriodicoAl);//Dipendentecorrente.Al?;
    ...
    begin
      ...
      with A077FGeneratoreStampe do
        ...
        begin
          ...
          DipendenteCorrente.DettaglioPeriodicoAl:=IfThen(FieldByName('IN_DATA_SCADENZA_PROROGATA').IsNull,
                                                          IfThen(FieldByName('IN_DATA_SCADENZA').IsNull,DipendenteCorrente.Al,FieldByName('IN_DATA_SCADENZA').AsDateTime),
                                                          Max(FieldByName('IN_DATA_SCADENZA').AsDateTime,FieldByName('IN_DATA_SCADENZA_PROROGATA').AsDateTime));
        end;
      if not PeriodoStoricoValido(RInterno) then
      begin
        Next;
  ...
  begin
    ...
    begin
      ...
      if selVT850_T851.FieldByName('IA_ITER').AsString = ITER_GIUSTIF then
        ...
        ODS:=selT105
      else if selVT850_T851.FieldByName('IA_ITER').AsString = ITER_DISPTURNI then
        ODS:=selT600
      ;
      if ODS <> nil then
      begin
