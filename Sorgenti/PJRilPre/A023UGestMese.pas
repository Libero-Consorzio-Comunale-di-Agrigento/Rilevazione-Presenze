...
uses
  ...
  ImgList, Menus, A000UCostanti, A000USessione,A023UTimbratureMW, System.Actions;
...
begin
  ...
  begin
    ...
    if SelDatiBloccati.DatoBloccato(Progressivo,R180InizioMese(DataAss),'T320') then
...
begin
  ...
  begin
    ...
    try
      ...
      // TORINO_COMUNE - commessa 2012/046.ini
      if (chkEventiStraordinari.Checked) (*and (CausAss = A023FTimbratureDtM1.selT722.FieldByName('CAUSALE_STR').AsString)*) then
      begin
...
begin
  ...
  begin
    ...
    if SelDatiBloccati.DatoBloccato(Progressivo,R180InizioMese(DataGiustif),'T040') then
      raise Exception.Create(selDatiBloccati.MessaggioLog);
