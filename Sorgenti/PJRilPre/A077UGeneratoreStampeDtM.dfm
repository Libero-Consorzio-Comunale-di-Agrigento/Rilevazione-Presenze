inherited A077FGeneratoreStampeDtM: TA077FGeneratoreStampeDtM
  ...
  inherited selT920Stampa: TOracleDataSet
    Left = 305
    Top = 104
  end
  ...
  object selVT248: TOracleDataSet
    SQL.Strings = (
      ...
      'PS_DATA_DA <= :DATA2 AND PS_DATA >= :DATA1'
  ...
  object selVSG303: TOracleDataSet
    SQL.Strings = (
      ...
      '  VSG303.PROGRESSIVO18 = :progressivo and'
        ...
        '((:data2 >= IN_DATA_AFFIDAMENTO and :data1 <= nvl(greatest(IN_DA' +
        'TA_SCADENZA,nvl(IN_DATA_SCADENZA_PROROGATA,to_date('#39'01011900'#39','#39'd' +
        'dmmyyyy'#39'))),to_date('#39'31123999'#39','#39'ddmmyyyy'#39'))) OR'
  ...
  object selSG710: TOracleDataSet
    SQL.Strings = (
      ...
      '  SG710.accettazione_valutato VA_ACCETTAZIONE_VALUTATO,'
        ...
        '  DECODE(SG710.accettazione_valutato,'#39'S'#39','#39'Accettata'#39',DECODE(SG71' +
        '0.accettazione_valutato,'#39'N'#39','#39'Non accettata'#39','#39#39')) VA_DESC_ACCETTA' +
        'ZIONE_VALUTATO,'
      
        '  SG710.data_accettazione_valutato VA_DATA_ACCETTAZIONE_VALUTATO' +
        ','
      
        '  REPLACE(REPLACE(TRIM(SG710.commenti_valutato),chr(13)||chr(10)' +
        ','#39' '#39'),chr(10),'#39' '#39') VA_COMMENTI_VALUTATO,'
      
        '  REPLACE(REPLACE(SG710F_STORIA_COMM_VAL(SG710.data,SG710.progre' +
        'ssivo,SG710.tipo_valutazione,SG710.stato_avanzamento + 1),chr(13' +
        ')||chr(10),'#39' '#39'),chr(10),'#39' '#39') VA_STORIA_COMMENTI_VALUTATO,'
