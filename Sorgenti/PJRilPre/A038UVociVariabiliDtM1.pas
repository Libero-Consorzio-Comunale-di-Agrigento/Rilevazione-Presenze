...
begin
  ...
  begin
    ...
    selT195.SetVariable('DATA1',A038FVociVariabili.DataI);
    selT195.SetVariable('DATA2',A038FVociVariabili.DataF);
...
begin
  ...
  if Par = 'PROGRESSIVO' then
    ...
    begin
      //Close;
      SetVariable('DATA1',A038FVociVariabili.DataI);
      //Open;
    end
    ...
    begin
      //Close;
      SetVariable('DATA2',A038FVociVariabili.DataF);
      //Open;
    end
  else if Par = 'T' then
    with A038FVociVariabiliMW.selT195 do
...
begin
  A038FVociVariabili.frmSelAnagrafe.Enabled:=not(A038FVociVariabiliMW.DsrT195.State in [dsEdit,dsInsert]);
end;
