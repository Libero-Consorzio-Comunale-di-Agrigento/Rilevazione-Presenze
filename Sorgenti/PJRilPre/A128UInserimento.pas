...
type
  TA128FInserimento = class(TForm)
    ...
    Panel3: TPanel;
    Label1: TLabel;
    lblCodiceTurno: TLabel;
    lblCodiceTurno2: TLabel;
    Label5: TLabel;
    LContratto: TLabel;
    ...
    lblPartTime: TLabel;
    dEdtOraInizioTurno1: TDBEdit;
    dEdtOraFineTurno1: TDBEdit;
    dEdtOraInizioTurno2: TDBEdit;
    dEdtOraFineTurno2: TDBEdit;
    lblOraInizioTurno1: TLabel;
    lblOraFineTurno1: TLabel;
    lblOraInizioTurno2: TLabel;
    lblOraFineTurno2: TLabel;
    grpTurno1: TGroupBox;
    grpTurno2: TGroupBox;
...
begin
  ...
  begin
    ...
    dEdtOraInizioTurno1.DataSource:=dsrParametri;
    dEdtOraFineTurno1.DataSource:=dsrParametri;
    dEdtOraInizioTurno2.DataSource:=dsrParametri;
    dEdtOraFineTurno2.DataSource:=dsrParametri;
  end;
...
begin
  with A128FPianPrestazioniAggiuntiveDtm.A128MW do
    try
      ...
      OraInizioTurno1:=IfThen(Trim(dEdtOraInizioTurno1.Text) <> '.', dEdtOraInizioTurno1.Text, '');
      OraFineTurno1:=IfThen(Trim(dEdtOraFineTurno1.Text) <> '.', dEdtOraFineTurno1.Text, '');
      OraInizioTurno2:=IfThen(Trim(dEdtOraInizioTurno2.Text) <> '.', dEdtOraInizioTurno2.Text, '');
      OraFineTurno2:=IfThen(Trim(dEdtOraFineTurno2.Text) <> '.', dEdtOraFineTurno2.Text, '');
...
procedure TA128FInserimento.PulisciValore(Sender: TObject);
begin
  if not((Sender as TDBEdit).DataSource.State in [dsInsert,dsEdit]) then exit;
