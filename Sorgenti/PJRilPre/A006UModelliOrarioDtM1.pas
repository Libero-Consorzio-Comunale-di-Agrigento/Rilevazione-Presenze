...
type
  TA006FModelliOrarioDtM1 = class(TR004FGestStoricoDtM)
    ...
    selT020PMT_STACCOMIN: TStringField;
    ...
    selT020CAUSALE_INIZIOORARIO: TStringField;
    selT020CAUSALE_FINEORARIO: TStringField;
    selT020MINUTICAUS_INIZIOORARIO: TStringField;
    selT020MINUTICAUS_FINEORARIO: TStringField;
    selT020RIPCOM_DEBITOGG: TStringField;
    selT020COEFF_INDPRESMAG: TFloatField;
    selT020MMINDPRESMAG: TStringField;
    selT020ORETEOR_GGASS: TStringField;
    selT020PMT_TIMBRATURAMENSA: TStringField;
    selT020FRAZDEB_NO_TURNISTA: TStringField;
    selT020ANOM_BLOCC_23LIV: TStringField;
    selT020FORZA_TURNOPIANIFICATO: TStringField;
    selT020FESTLAV_GGSETT: TStringField;
    selT020CAUS_RIDUZPN: TStringField;
    selT020PMT_NOOREMIN_TIMBMENSA: TStringField;
    selT020FASCIA_NOTTFEST_COMPLETA: TStringField;
    selT020INDFESTIVA_USA_NOTTE_COMPLETA: TStringField;
    selT020DETRAZ_RIEPPR_NORM: TStringField;
    selT020XPARAM_COMP_OLDVERS: TStringField;
    selT020ORARI_SCAMBIO: TStringField;
    selT020STR_NOTTE_SPEZZATO: TStringField;
    selT020CAUS_RIDUZPN_CHECKPMT: TStringField;
    selT020DETRAZ_PARZ_STACCO_INF: TStringField;
    selT020TURNI_INIZIOORARIO: TStringField;
    selT020TURNI_FINEORARIO: TStringField;
    selT020MINUTICAUS_PRIORITARI: TStringField;
