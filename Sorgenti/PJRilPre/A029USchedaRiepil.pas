...
type
  TA029FSchedaRiepil = class(TR001FGestTab)
    ...
    lblRiepAssCompensateMese: TLabel;
    dedtRiepAssCompensateMese: TDBEdit;
    dedtRiepAssCompensateAnno: TDBEdit;
    lblRiepAssCompensateAnno: TLabel;
...
begin
  ...
  D:=IfThen(D=0, R180InizioMese(Parametri.DataLavoro), D); //Se D=0 (apertura della funzione) mi posiziono su DataLavoro
  ...
  begin
    ...
    begin
      ...
      begin
        //Se non è stata trovata la data esatta si posiziona su quella immediatamente precedente
        Last;
        while not Bof do
        begin
...
begin
  ...
  try
    ...
    Caption:='<A029> Riepilogo liquidazioni da inizio anno';
    GroupBox2.Caption:='';
    (*
