...
uses
  ...
  System.ImageList, A020UCausPresenzeStorico, A020UCausPresenzeStoricoDtM;
...
type
  TA020FCausPresenze = class(TR001FGestTab)
    ...
    dchkForzaCausEccedenza: TDBCheckBox;
    dchkLiquidazioneMesiPrec: TDBCheckBox;
    dchkNoLimiteAnnualeLiq: TDBCheckBox;
    dchkInserimentoTimb: TDBCheckBox;
    dchkInserimentoTimbVirt: TDBCheckBox;
    ...
    procedure grdParamStoricizDrawCell(Sender: TObject; ACol, ARow: Integer;
...
procedure TA020FCausPresenze.grdParamStoricizDrawCell(Sender: TObject; ACol,
...
begin
  ...
  begin
    ...
    try
      ...
      A020FCausPresenzeStoricoDtM:=TA020FCausPresenzeStoricoDtM.Create(Self,IdCausale);
      ...
      FreeAndNil(A020FCausPresenzeStoricoDtM);
...
procedure TA020FCausPresenze.dchkInserimentoTimbClick(Sender: TObject);
begin
  inherited;
  AbilitazioneControlli(Sender);
end;
...
begin
  ...
  dchkForzaCausEccedenza.Enabled:=DBRadioGroup1.ItemIndex = 3;
  ...
  *)
  ...
  dchkLiquidazioneMesiPrec.Enabled:=(EOreNormali.ItemIndex = 0);
  ...
  begin
    ...
    if not dchkInclusioneSaldiCausali.Enabled then
      dchkInclusioneSaldiCausali.Field.AsString:='N';
    if not dchkInserimentoTimbVirt.Enabled then
      dchkInserimentoTimbVirt.Field.AsString:='N';
  end;
