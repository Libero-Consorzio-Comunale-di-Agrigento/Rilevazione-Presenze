...
uses
  ...
  A083UMsgElaborazioni,A000UMessaggi, System.Actions, System.ImageList;
...
begin
  ...
  if AggiornaT195 and (DataCassa < Data) then
    raise Exception.Create(Format(A000MSG_A037_ERR_FMT_DATA_ANTE_SCARICO,[FormatDateTime('mmmm yyyy',DataCassa),FormatDateTime('mmmm yyyy',Data)]));
  if DataCassa = D then
  begin
    if AggiornaT195 and
  ...
  begin
    ...
    begin
      ...
      R180MessageBox('Elaborazione interrotta' + CRLF + Prosegui,ERRORE);
