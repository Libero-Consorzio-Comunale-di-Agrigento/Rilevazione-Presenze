...
var
  ...
  i:Integer;
begin
  A047FStampaGiornaliera.QRep.PrinterSettings.UseStandardPrinter:=(TipoModulo = 'COM') and Parametri.UseStandardPrinter;
  A047FStampaTimbMensa.RepR.PrinterSettings.UseStandardPrinter:=(TipoModulo = 'COM') and Parametri.UseStandardPrinter;
...
begin
  ...
  begin
    ...
    A047FStampaGiornaliera.QRep.ExportToFilter(TQRPDFDocumentFilter.Create(DocumentoPDF));
  end
  else
