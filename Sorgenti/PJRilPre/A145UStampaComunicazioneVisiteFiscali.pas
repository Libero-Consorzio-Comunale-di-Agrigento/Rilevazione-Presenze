...
begin
  ...
  try
    ...
    if A145FComunicazioneVisiteFiscali.TipoModulo = 'CS' then
...
begin
  ...
  QRLabel8.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRLabel9.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRLabel10.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRShape7.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRShape8.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRShape17.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  //(Band)QRCBDettaglio
  QRShape11.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRShape12.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  //(Band)QRBDettaglio
  QRShape3.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRShape4.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRDBTNumAssenze.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;
  QRDBTGiorniAssenza.Enabled:=A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked;

  //Posizionamento Label e Text
  ShiftCol1:=913;
  ShiftCol2:=970;
  if A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked then
  begin
    ShiftCol1:=778;
    ShiftCol2:=829;
  end;
  ...
  QRLPrognosiLbl.Left:=ShiftCol2 + 18 + IfThen(not A145FComunicazioneVisiteFiscali.chkStampaAssMal.Checked,-2);
  //------------------------------------
...
begin
  inherited;
  // titolo
  if A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bAggiorna then
    LEnte.Caption:='COMUNICAZIONI VISITE FISCALI DEL ' + DateToStr(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataElaborazione)
  else
    LEnte.Caption:='COMUNICAZIONI VISITE FISCALI - STAMPA PROVVISORIA';

  // sottotitolo: in funzione dell'opzione scelta
  if A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.bPeriodiComunicati then
    LTitolo.Caption:='ASSENZE NEL PERIODO DAL ' + DateToStr(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataDa) + ' AL ' + DateToStr(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataA)
  else if not A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.datiElab.bAggiorna then
    LTitolo.Caption:='DATA DI ELABORAZIONE: ' + DateToStr(A145FComunicazioneVisiteFiscaliDtm.A145FComVisiteFiscaliMW.DatiElab.DataElaborazione)
  else
    LTitolo.Caption:='';
end;
...
begin
  ...
  Dato:=QRep.DataSet.FieldByName('DataPrimaComunicazione').AsString;
  if not QRep.DataSet.FieldByName('NuovaDataFine').IsNull then
    Dato:=Dato + ' (' + QRep.DataSet.FieldByName('DataFineAssenza').AsString + ')';
...
begin
  inherited;
  Comunicato1:=(QRep.DataSet.FieldByName('NuovaDataFine').IsNull) and
               (not QRep.DataSet.FieldByName('DataPrimaComunicazione').IsNull);
  ComunicatoProl:=(not QRep.DataSet.FieldByName('NuovaDataFine').IsNull) and
                  (not QRep.DataSet.FieldByName('DataComunProlungamento').IsNull);
...
begin
  ...
  Value:=QRep.Dataset.FieldByName('DataInizioAssenza').AsString + ' - ';
...
begin
  ...
  QRDBTPrognosi.DataSet:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.TabellaStampa;
  QRDBTNumAssenze.DataSet:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.TabellaStampa;
  QRDBTGiorniAssenza.DataSet:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.TabellaStampa;
  QRDBTOperazione.DataSet:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.TabellaStampa;
  QRDBTDataPrimaComunicazione.DataSet:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.TabellaStampa;
  ...
  QRDBNote.DataSet:=A145FComunicazioneVisiteFiscaliDtM.A145FComVisiteFiscaliMW.TabellaStampa;
end;
