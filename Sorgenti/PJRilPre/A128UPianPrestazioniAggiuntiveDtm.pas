...
type
  TA128FPianPrestazioniAggiuntiveDtm = class(TDataModule)
    ...
    selT332ORAINIZIO_TURNO1: TStringField;
    selT332ORAFINE_TURNO1: TStringField;
    selT332ORAINIZIO_TURNO2: TStringField;
    selT332ORAFINE_TURNO2: TStringField;
    ...
    procedure selT332TURNOSetText(Sender: TField; const Text: String);
    procedure selT332TURNOValidate(Sender: TField);
    procedure selT332ORASetText(Sender: TField; const Text: string);
    procedure selT332ORAValidate(Sender: TField);
    procedure selT332TURNOChange(Sender: TField);
    procedure selT332ORAChange(Sender: TField);
  private
...
procedure TA128FPianPrestazioniAggiuntiveDtm.selT332ORAChange(Sender: TField);
begin
  A128MW.AzzeraTurni(Sender);
end;

procedure TA128FPianPrestazioniAggiuntiveDtm.selT332ORASetText(Sender: TField; const Text: string);
begin
  A128MW.ImpostaTesto(Sender,Text);
end;

procedure TA128FPianPrestazioniAggiuntiveDtm.selT332ORAValidate(Sender: TField);
begin
...
procedure TA128FPianPrestazioniAggiuntiveDtm.selT332TURNOSetText(Sender: TField; const Text: String);
begin
  A128MW.ImpostaTesto(Sender,Text);
end;

procedure TA128FPianPrestazioniAggiuntiveDtm.selT332TURNOValidate(Sender: TField);
begin
  A128MW.ValidaTurno(Sender);
end;

procedure TA128FPianPrestazioniAggiuntiveDtm.selT332TURNOChange(Sender: TField);
begin
