inherited A080FModConte: TA080FModConte
  ...
  object PageControl1: TPageControl [3]
    ...
    Width = 569
    Height = 457
    ActivePage = tbsIterAutStr
    Align = alClient
    TabOrder = 3
    object TabSheet1: TTabSheet
      HelpContext = 80200
      Caption = 'Recuperi'
      object lblCausRipComFasce: TLabel
        Left = 6
        Top = 241
        Width = 151
        Height = 13
      ...
      object GroupBox2: TGroupBox
        ...
        object drgpRecuperoDebitoTipo: TDBRadioGroup
          Left = 71
          Top = 81
          Width = 178
          Height = 50
        ...
        object drgpRecuperoDebitoPeriodicita: TDBRadioGroup
          Left = 3
          Top = 81
          Width = 66
          Height = 50
      ...
      object dedtCausRipComFasce: TDBLookupComboBox
        ...
        ListSource = A080FModConteDtM1.dsrT275EsclNorm
        TabOrder = 2
      end
      ...
      object dchkRipcomInclusiSaldo: TDBCheckBox
        Left = 4
        Top = 216
        Width = 288
        Height = 17
      ...
      object GroupBox10: TGroupBox
        ...
        Width = 253
        Height = 283
        Caption = 'Compensazione dei saldi negativi'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
        ...
        ParentFont = False
        TabOrder = 5
        object lblCausaliCompensabiliMensili: TLabel
          Left = 7
          Top = 17
          Width = 212
          Height = 13
          Caption = 'Ore escluse per compensare il saldo Mensile:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object lblRiepassCompensabiliMese: TLabel
          Left = 7
          Top = 88
          Width = 189
          Height = 13
          Caption = 'Causali per compensare il saldo mensile:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object lblCausaliCompensabili: TLabel
          Left = 7
          Top = 131
          Width = 207
          Height = 13
          Caption = 'Ore escluse per compensare il saldo Annuo:'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
          Font.Name = 'MS Sans Serif'
        ...
        object lblRiepassCompensabiliAnno: TLabel
          Left = 7
          Top = 243
          Width = 185
          Height = 13
        ...
        object dedtRiepassCompensabiliMese: TDBEdit
          Left = 7
          Top = 103
          Width = 226
          Height = 21
          Color = cl3DLight
          DataField = 'RIEPASS_COMPENSABILI_MESE'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object btnRiepassCompensabiliMese: TButton
          Left = 234
          Top = 104
          Width = 13
          Height = 21
        ...
        object drgpCausaliCompMensSaldo: TDBRadioGroup
          Left = 7
          Top = 54
          Width = 240
          Height = 34
          Caption = 'Residuo da usare per la compensazione'
          Columns = 2
          DataField = 'CAUSALI_COMP_MENS_SALDO'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object dedtRiepassCompensabiliAnno: TDBEdit
          Left = 7
          Top = 257
          Width = 226
          Height = 21
        ...
        object btnRiepassCompensabiliAnno: TButton
          Left = 234
          Top = 257
          Width = 13
          Height = 21
        ...
        object drgpCausaliCompAnnSaldo: TDBRadioGroup
          Left = 6
          Top = 167
          Width = 241
          Height = 34
          Caption = 'Residuo da usare per la compensazione'
          Columns = 2
          DataField = 'CAUSALI_COMP_ANN_SALDO'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object drgpCausaliCompAnnAddebPaghe: TDBRadioGroup
          Left = 6
          Top = 201
          Width = 241
          Height = 34
          Caption = 'Compens. prima/dopo il recupero del debito'
          Columns = 2
          DataField = 'CAUSALI_COMP_ANN_ADDEB_PAGHE'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
        ...
        object drgpCausaliCompMeseRecNeg: TDBRadioGroup
          Left = 7
          Top = 89
          Width = 241
          Height = 34
          ...
          Columns = 2
          DataField = 'CAUSALI_COMP_MESE_RECNEG'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlue
          Font.Height = -11
    ...
    object TabSheet2: TTabSheet
      ...
      object drgpGGVuotoTurnista: TDBRadioGroup
        Left = 280
        Top = 259
        Width = 261
        Height = 39
    ...
    object TabSheet4: TTabSheet
      ...
      object gpbLimitiMensiliEccedenzaResiduabile: TGroupBox
        ...
        ParentFont = False
        TabOrder = 1
        object lblLimitiCausali: TLabel
          Left = 5
          Top = 115
          Width = 175
          Height = 13
        ...
        object dedtLimiteCausali: TDBEdit
          Left = 5
          Top = 130
          Width = 246
          Height = 21
        ...
        object btnLimiteCausali: TButton
          Left = 253
          Top = 129
          Width = 18
          Height = 23
    ...
    object tbsIterAutStr: TTabSheet
      Caption = 'Iter autorizzativo straordinari'
      ImageIndex = 4
      object grpIterAutStr: TGroupBox
        Left = 3
        Top = 3
        Width = 294
        Height = 206
        ...
        object lblIterAutStrMinimoLiq: TLabel
          Left = 7
          Top = 177
          Width = 85
          Height = 13
        ...
        object lblIterAutStrCausale: TLabel
          Left = 7
          Top = 72
          Width = 41
          Height = 13
        ...
        object dtxtIterAutStrCausale: TDBText
          Left = 7
          Top = 95
          Width = 285
          Height = 17
          DataField = 'D_ITER_AUTSTR_CAUSALE'
          DataSource = DButton
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -11
        ...
        object lblIterAutStrArrotEcc: TLabel
          Left = 7
          Top = 46
          Width = 134
          Height = 13
        ...
        object dcmbIterAutStrCausale: TDBLookupComboBox
          Left = 206
          Top = 69
          Width = 82
          Height = 21
          DataField = 'ITER_AUTSTR_CAUSALE'
          DataSource = DButton
          DropDownWidth = 300
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object dedtIterAutStrMinimoLiq: TDBEdit
          Left = 248
          Top = 174
          Width = 40
          Height = 21
        ...
        object dedtIterAutStrArrotEcc: TDBEdit
          Left = 248
          Top = 43
          Width = 40
          Height = 21
