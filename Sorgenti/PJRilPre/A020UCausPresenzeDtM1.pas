...
type
  TA020FCausPresenzeDtM1 = class(TDataModule)
    ...
    selT275FORZA_CAUSECCEDENZA: TStringField;
    selT275LIQUIDAZIONE_MESIPREC: TStringField;
    selT275NO_LIMITE_ANNUALE_LIQ: TStringField;
    selT275INSERIMENTO_TIMB: TStringField;
    selT275INSERIMENTO_TIMBVIRT: TStringField;
    selT275TIMB_PM_H: TStringField;
