object A050FOrologiDtM1: TA050FOrologiDtM1
  ...
  object Q361: TOracleDataSet
    ...
    object Q361LAT: TFloatField
      DisplayLabel = 'Latitudine'
      FieldName = 'LAT'
      DisplayFormat = '0.00000000'
    end
    object Q361LNG: TFloatField
      DisplayLabel = 'Longitudine'
      FieldName = 'LNG'
      DisplayFormat = '0.00000000'
    end
    object Q361RAGGIO_VALIDITA: TIntegerField
  ...
  object SelLocalita: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT CODICE, DESCRIZIONE FROM M042_LOCALITA ORDER BY DESCRIZIO' +
        'NE')
    ReadBuffer = 2000
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
