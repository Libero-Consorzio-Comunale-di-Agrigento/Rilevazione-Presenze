...
uses
  ...
  StrUtils, Math, A024ULimitiInd, System.Actions, System.ImageList;
...
type
  TA024FRegoleIndennita = class(TR001FGestTab)
    ...
    dchkMaturazPropIgnoraScostNeg: TDBCheckBox;
    dchkConguaglioTurni: TDBCheckBox;
    ...
    procedure dchkConguaglioTurniClick(Sender: TObject);
    procedure dcmbCodice2Click(Sender: TObject);
  private
    { Private declarations }
    ListaAssenze:TStringList;
    ListaPresenze:TStringList;  //LORENA 29/07/2004
    procedure Abilitadgpbnmesi_equiturni;
...
procedure TA024FRegoleIndennita.Abilitadgpbnmesi_equiturni;
begin
  dgpbnmesi_equiturni.Visible:=(((ETipo.Text = 'A') or (ETipo.Text = 'B')) and (dcmbCodice2.Field.IsNull)) or (ETipo.Text = 'P');
  dgpbnmesi_equiturni.Enabled:=dgpbnmesi_equiturni.Visible and (dChkConguaglioTurni.Checked or dcmbCodice2.Field.IsNull);
end;
...
procedure TA024FRegoleIndennita.dchkConguaglioTurniClick(Sender: TObject);
begin
  inherited;
  Abilitadgpbnmesi_equiturni;
end;

procedure TA024FRegoleIndennita.dcmbCodice2Click(Sender: TObject);
begin
  inherited;
