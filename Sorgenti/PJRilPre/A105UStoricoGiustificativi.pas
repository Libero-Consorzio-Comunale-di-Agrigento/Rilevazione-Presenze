...
uses
  ...
  C180FunzioniGenerali, C700USelezioneAnagrafe, InputPeriodo;
...
type
  TA105FStoricoGiustificativi = class(TForm)
    ...
    pnlFunzioni: TPanel;
    btnEsegui: TBitBtn;
    frmInputPeriodoA: TfrmInputPeriodo;
  ...
  Private
    ...
    function _GetDataAI: TDateTime;
    procedure _PutDataAI(const Value: TDateTime);
    function _GetDataAF: TDateTime;
    procedure _PutDataAF(const Value: TDateTime);
  public
    { Public declarations }
    ...
    property DataAI:TDateTime read _GetDataAI write _PutDataAI;
    property DataAF:TDateTime read _GetDataAF write _PutDataAF;
  end;
...
begin
  ...
  DataAI:= R180InizioMese(Parametri.DataLavoro);
  DataAF:= R180FineMese(Parametri.DataLavoro);
  ...
  A105MW.Q265.First;
  while not A105MW.Q265.Eof do
  begin
    clbCausali.Items.Add(Format('%-5s %s',[A105MW.Q265.FieldByName('Codice').AsString,A105MW.Q265.FieldByName('Descrizione').AsString]));
    A105MW.Q265.Next;
  end;
...
begin
  ...
  A105FStampa.DaData:= DataI;
  A105FStampa.AData:= DataF;
...
begin
  ...
  begin
    ...
    A105MW.ElaboraDipendente(DataI,
                             DataF,
...
{ DataF }
function TA105FStoricoGiustificativi._GetDataF: TDateTime;
begin
  Result := frmInputPeriodoS.DataFine;
end;
procedure TA105FStoricoGiustificativi._PutDataF(const Value: TDateTime);
begin
  frmInputPeriodoS.DataFine := Value;
end;
{ ----DataF }
{ DataI }
function TA105FStoricoGiustificativi._GetDataI: TDateTime;
begin
  Result := frmInputPeriodoS.DataInizio;
end;
procedure TA105FStoricoGiustificativi._PutDataI(const Value: TDateTime);
begin
  frmInputPeriodoS.DataInizio := Value;
end;
{ ----DataI }

{ DataAF }
function TA105FStoricoGiustificativi._GetDataAF: TDateTime;
begin
  Result := frmInputPeriodoA.DataFine;
end;
procedure TA105FStoricoGiustificativi._PutDataAF(const Value: TDateTime);
begin
  frmInputPeriodoA.DataFine := Value;
end;
{ ----DataF }
{ DataAI }
function TA105FStoricoGiustificativi._GetDataAI: TDateTime;
begin
  Result := frmInputPeriodoA.DataInizio;
end;
procedure TA105FStoricoGiustificativi._PutDataAI(const Value: TDateTime);
begin
  frmInputPeriodoA.DataInizio := Value;
end;
{ ----DataAI }
