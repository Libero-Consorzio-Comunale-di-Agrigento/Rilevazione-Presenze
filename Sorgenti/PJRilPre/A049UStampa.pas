...
uses
  ...
  QRWebFilt, QRPDFFilt, A000UCostanti;
...
begin
  if (A049FStampaPastiDtM1.A049FStampaPastiMW.TipoModulo = TTipoModuloRec.COM) and
     (Trim(A049FStampaPastiDtM1.A049FStampaPastiMW.DocumentoPDF) <> '') and
     (Trim(A049FStampaPastiDtM1.A049FStampaPastiMW.DocumentoPDF) <> '<VUOTO>') then
  begin
    RepR.ShowProgress:=False;
    RepR.ExportToFilter(TQRPDFDocumentFilter.Create(A049FStampaPastiDtM1.A049FStampaPastiMW.DocumentoPDF));
  end
  else
    RepR.Preview;
end;
