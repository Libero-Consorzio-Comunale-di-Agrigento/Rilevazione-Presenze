...
type
  ...
  public
    { Public declarations }
    procedure StampaRiepTimb(var Temp:TListDip);
  end;
...
procedure TA058FStampaRiepTimb.StampaRiepTimb(var Temp:TListDip);
begin
  MyVista:=Temp;
...
begin
  QRRiepTimb.Font.Size:=A058FPianifTurniDtm1.selT082.FieldByName('DIMENSIONE_FONT').AsInteger;
end;
...
procedure TA058FStampaRiepTimb.FormDestroy(Sender: TObject);
begin
  if TabellaStampaTimb <> nil then
    FreeAndNil(TabellaStampaTimb);
end;
