...
begin
  ...
  with A049FStampaPastiDtM1.A049FStampaPastiMW do
  begin
    if not (TipoModulo = TTipoModuloRec.COM) then
      FiltroRilevatori:=GetFiltro;
    R300FAccessiMensaDtM.SettaPeriodo(Self.DataI, Self.DataF);
    R300FAccessiMensaDtM.FiltroRilevatori:=FiltroRilevatori;
  end;
