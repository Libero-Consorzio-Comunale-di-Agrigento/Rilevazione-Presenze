inherited A006FModelliOrarioDtM1: TA006FModelliOrarioDtM1
  ...
  object selT020: TOracleDataSet
    ...
    object selT020ORETEOR_GGASS: TStringField
    ...
    object selT020XPARAM_COMP_OLDVERS: TStringField
    ...
    object selT020PMT_STACCOMIN: TStringField
    ...
    object selT020CAUSALE_INIZIOORARIO: TStringField
      FieldName = 'CAUSALE_INIZIOORARIO'
      Size = 5
    end
    object selT020CAUSALE_FINEORARIO: TStringField
      FieldName = 'CAUSALE_FINEORARIO'
      Size = 5
    end
    object selT020MINUTICAUS_INIZIOORARIO: TStringField
      FieldName = 'MINUTICAUS_INIZIOORARIO'
      OnValidate = ValidateOreMinuti
      EditMask = '!90:00;1;_'
      Size = 5
    end
    object selT020MINUTICAUS_FINEORARIO: TStringField
      FieldName = 'MINUTICAUS_FINEORARIO'
      OnValidate = ValidateOreMinuti
      EditMask = '!90:00;1;_'
      Size = 5
    end
    object selT020TURNI_INIZIOORARIO: TStringField
      FieldName = 'TURNI_INIZIOORARIO'
      Size = 50
    end
    object selT020TURNI_FINEORARIO: TStringField
      FieldName = 'TURNI_FINEORARIO'
      Size = 50
    end
    object selT020MINUTICAUS_PRIORITARI: TStringField
      FieldName = 'MINUTICAUS_PRIORITARI'
      Size = 1
    end
    object selT020RIPCOM_DEBITOGG: TStringField
      FieldName = 'RIPCOM_DEBITOGG'
      Size = 1
    end
    object selT020COEFF_INDPRESMAG: TFloatField
      FieldName = 'COEFF_INDPRESMAG'
    end
    object selT020MMINDPRESMAG: TStringField
      FieldName = 'MMINDPRESMAG'
      OnValidate = ValidateOreMinuti
      EditMask = '!90:00;1;_'
      Size = 5
    end
    object selT020PMT_TIMBRATURAMENSA: TStringField
      FieldName = 'PMT_TIMBRATURAMENSA'
      Size = 1
    end
    object selT020FRAZDEB_NO_TURNISTA: TStringField
      FieldName = 'FRAZDEB_NO_TURNISTA'
      Size = 1
    end
    ...
    object selT020FORZA_TURNOPIANIFICATO: TStringField
      FieldName = 'FORZA_TURNOPIANIFICATO'
      Size = 1
    end
    object selT020FESTLAV_GGSETT: TStringField
      FieldName = 'FESTLAV_GGSETT'
      Size = 1
    end
    object selT020CAUS_RIDUZPN: TStringField
      FieldName = 'CAUS_RIDUZPN'
      Size = 100
    end
    object selT020CAUS_RIDUZPN_CHECKPMT: TStringField
      FieldName = 'CAUS_RIDUZPN_CHECKPMT'
      Size = 100
    end
    object selT020PMT_NOOREMIN_TIMBMENSA: TStringField
    ...
    object selT020DETRAZ_RIEPPR_NORM: TStringField
      FieldName = 'DETRAZ_RIEPPR_NORM'
      Size = 2
    end
    object selT020ORARI_SCAMBIO: TStringField
      FieldName = 'ORARI_SCAMBIO'
      Size = 2000
    end
    object selT020STR_NOTTE_SPEZZATO: TStringField
      FieldName = 'STR_NOTTE_SPEZZATO'
      Size = 1
    end
    object selT020DETRAZ_PARZ_STACCO_INF: TStringField
