...
uses
  ...
  A002UAnagrafeVistaPadre,A004UGiustifAssPres,A005UDatiLiberi,A006UModelliOrario,A007UProfiliOrari,A009UProfiliAsse,
  ...
  A030UResidui,A031UParScarico,A032UScarico,A033UStampaAnomalie,A034UIntPaghe,A035UParScarico,A036UTurniRep,A037UScaricoPaghe,A038UVociVariabili,A039URegReperib,
  A040UPianifRep,A041UInsRiposi,A042UDialogStampa,A043UDialogStampa,A045UDialogStampa,A046UTerMensa,A047UTimbMensa,A048UPastiMese,A049UDialogStampa,
  A050UOrologi,A051UTimbOrig,A052UParCar,A054UCicliTurni,A055UTurnazioni,A056UTurnazInd,A057USpostSquadra,A058UPianifTurni,A059UContSquadre,
  A060UTimbIrregolari,A061UDettAssenze,A062UQueryServizio,A063UBudgetGenerazione,A064UBudgetStraordinario,A065UStampaBudget,A066UValutaStr,A067URepSostB,A068UTurniGior, A069UBudgetEsterno,(*A069ULiquidProp,*)
  A071URegoleBuoni,A072UBuoniMese,A073UAcquistoBuoni,A074URiepilogoBuoni,A075UFineAnno,A076UIndGruppo,A077UGeneratoreStampe,A079UAssenzeAuto,
  A080UModConte,A081UTimbCaus,A084UTipoRapporto,A085UPartTime,A086UMotivazioniRichieste,A087UImpAttestatiMal,A088UDatiLiberiIterMissioni,
  A090UAssenzeAnno,A091ULiquidPresenze,A092UStampaStorico,A094USkLimitiStr,A095UStRiasStr,A096UProfiliLibProf,A097UPianifLibProf, A098UCalendarioOraLegSol,
  A100UMissioni,A101URaggrInterrogazioni,(*A101URipartizioneStr,*)A102UParScaricoGiust,A103UScaricoGiust,A104UDialogStampa,A105UStoricoGiustificativi,A106UDistanzeTrasferta,A107UInsAssAutoRegole,A108UInsAssAuto,A109UImmagini,
  A110UParametriConteggio,A111UParmessaggi,A112UInvioMessaggi,A113UParestrazioniStampe,A114UEstrazioniStampe,A115UIterAutorizzativi,A116ULiquidazioneOreAnniPrec,A117UOreLiquidateAnniPrec,A118UPubblicazioneDocumenti,A119UPartecipazioneScioperi,
  A120UTipiRimborsi,A121UOrganizzSindacali,A122UIscrizioniSindacati,A123UPartecipazioniSindacati,A124UPermessiSindacali,A125UBadgeServizio,A126UBloccoRiepiloghi,A127UTurniPrestazioniAggiuntive,A128UPianPrestazioniAggiuntive,A129UIndennitaKm,
  A130UOraLegaleSolare,A131UGestioneAnticipi,A132UMagazzinoBuoniPasto,A133UTariffeMissioni,A135UTimbratureScartate,A137UCalcoloSpeseAccesso, A138UAreeTurni, (*A139UPianifServizi,
  A140UTurniServizi,*)A141URegoleRiposi,A142UQualificaMinisteriale,A143UMedicineLegali,A144UComuniMedLegali,A145UComunicazioneVisiteFiscali,A147URepVincoliIndividuali,A148UProfiliImportazioneCertificatiINPS,A149UCategRimborsi,
  A150UAccorpamentoCausali,A151UAssenteismo,A152UEventiStraord,A153UPartecipEventiStraord,A154UGestioneDocumentale,A155URicercaDocumentale,A156UNotificheIrisWEB,A157UCapitoliTrasferte,A158UCapitoliRimborso,A159UArchiviazioneCartellini,
  A160URegoleIncentivi,A161UTipoAbbattimenti,A162UIncentiviAssenze,A163UTipoQuote,A164UQuoteIncentivi,A166UQuoteIndividuali,A167URegistraIncentivi,A168UIncentiviMaturati,A169UPesatureIndividuali,
  A170UGestioneGruppi,A171UXMLVisiteFiscali,A172USchedeQuantIndividuali,A173UImportAssestamento,A174UParPianifTurni,A175URegoleOrologi,A176URiepilogoIterAutorizzativi,A177UFerieSolidali,A178UPianifPersConv,
  A200UImportazioneMassivaDocumenti,A202URapportiLavoro,A203UDatiMensiliPersonalizzati,A204UModelliCertificazione,A205USquadre,A206UCondizioniTurni,A207UProfiliStampeRep,
  A210URegoleArchiviazioneDoc,A220UArchiviazioneLArchive,A208UAcquisizioneInfoEsterne,
  C180FunzioniGenerali,
  C700USelezioneAnagrafe,
  P030UValute,P032UCambi,P050UArrotondamenti,P150USetup, P501UCudSetup,
  P552URegoleContoAnnuale,P553URisorseResidueContoAnnuale,P554UElaborazioneContoAnnuale,P555UContoAnnuale,
  P651URelazioniTabelle,P652UINPDAPMMRegole,P655UDatiINPDAPMM,P656UElaborazioneFLUPER,
  ...
  S028UMotivazioni,S030UProvved,S031UFAmiliari,S130UOrdiniProfessionali,
  S700UAreeValutazioni,S706UValutatoriDipendente,S715UDialogStampa,S720UProfiliAree,S730UPunteggiValutazioni,S735UPunteggiFasceIncentivi,S740URegoleValutazioni,S746UStatiAvanzamento,S750UParProtocollo,
  Variants,SelAnagrafe,System.Actions, Data.DB, System.ImageList;
...
type
  TA002FAnagrafeVista = class(TA002FAnagrafeVistaPadre)
    ...
    Raggruppamentointerrogazioni1: TMenuItem;
    ...
    actRaggrInterrogazioniServizio: TAction;
    actAziendeBase: TAction;
    ...
    actRegoleOrologi: TAction;
    Regoleorologi1: TMenuItem;
    N11: TMenuItem;
    ...
    actRapportiLavoro: TAction;
    Riepilogorapportidilavoro1: TMenuItem;
    actDatiAtipici: TAction;
    Datiatipici1: TMenuItem;
    actTrasmissioneAdArchiviazioneSostitutiva: TAction;
    ArchiviazioneLArchive1: TMenuItem;
    ...
    Profilistampereperibilit1: TMenuItem;
    actAcquisizioneInfoEsterne: TAction;
    Acquisizioneinformazioniesterne1: TMenuItem;
    DatiLiberi: TMenuItem;
...
begin
  ...
  actControlloPianificazione.Visible:=False;//Nascosto per ristrutturazione pianificazione turni. Se nessuno lo reclama, eliminare
end;
...
begin
  ...
  try
    ...
    else if Sender = actRaggrInterrogazioniServizio then
    ...
    else if Sender = actArchiviazioneCartellini then
      OpenA159ArchiviazioneCartellini(R180InizioMese(Parametri.DataLavoro), R180FineMese(Parametri.DataLavoro))
    else if Sender = actSGProvvedimenti then
      OpenS030Provvedimento('',PProgressivo)
    else if Sender = actRapportiLavoro then
      OpenA202RapportiLavoro(PProgressivo)
    else if Sender = actValidazionePeriodiGiuridici then
      OpenA202ValidazioneDatiGiuridici(PProgressivo)
    ;
  finally
...
procedure TA002FAnagrafeVista.Datianagrafici1Click(Sender: TObject);
begin
  inherited;
  GetDatiDipendente(nil);
  frmSelAnagrafe.R003DatianagraficiClick(nil);
end;
...
begin
  ...
  else if Sender = actCalendariooraLegaleSolare then
  begin
    OpenA098CalendarioOraLegSol;
  end
  else if Sender = actAziendeBase then
  begin
    //OpenA085PartTime('');
    A002FAnagrafeDtM1.A002FAnagrafeMW.selT440.Refresh;
  end
  ...
  begin
    ...
    OpenP032FCambi
  else if Sender = actMotivazioni then
    OpenS028Motivazioni('')
  else if Sender = actDatiAziendali then
    OpenP501FCudSetup()
  else if Sender = actDatiAtipici then
    OpenA203DatiMensiliPersonalizzati;
end;
...
begin
  ...
  try
    ...
    else if Sender = actRegoleOrologi then
      OpenA175RegoleOrologi
    ...
    else if Sender = actNotificheIrisWEB then
      OpenA156NotificheIrisWEB
    else if Sender = actRegoleArchiviazioneDoc then
      OpenA210FRegoleArchiviazioneDoc
    else if Sender = actTrasmissioneAdArchiviazioneSostitutiva then
      OpenA220FArchiviazioneLArchive
    ...
    else if Sender = actPianifPersConv then
      OpenA178PianifPersConv(PProgressivo)
    else if Sender = actModelliCertificazione then
      OpenA204ModelliCertificazione
    else if Sender = actAcquisizioneInfoEsterne then
      OpenA208FAcquisizioneInfoEsterne(PProgressivo)
    ;
  finally
    (Sender as TAction).HelpContext:=0;
    if C700FSelezioneAnagrafe = nil then
...
begin
  ...
  try
    ...
    if Sender = actRegoleTurniRep then
      ...
      OpenA205Squadre('')
    else if Sender = actCondizioniTurni then
      OpenA206FCondizioniTurni(PProgressivo)
...
//    OpenA171IncQuantProfili
    else if Sender = actXMLVisiteFiscali then
      OpenA171XMLVisiteFiscali
    ...
    else if Sender = actRelazioniTabelle then
      OpenP651RelazioniTabelle('FL','')
    ...
    else if Sender = actContoAnnRelTab then
      OpenP651RelazioniTabelle('CA','')
      ...
      OpenP690StampaFondi
    else if Sender = actAreeTurni then
      OpenA138AreeTurni('')
    (*else if Sender = actServizi then
      ...
      OpenA119Scioperi
    else if Sender = actFerieSolidali then
      OpenA177FerieSolidali
    else if Sender = actGestioneDocumentale then
      OpenA154GestioneDocumentale(PProgressivo,0)
    else if Sender = actRicercaDocumentale then
      OpenA155RicercaDocumentale(PProgressivo)
    else if Sender = actCategRimborsi then
      OpenA149CategRimborsi
    else if Sender = actCapitoliTrasferte then
      OpenA157CapitoliTrasferta
    else if Sender = actCapitoliRimborso then
      OpenA158CapitoliRimborso
    else if Sender = actImportazioneMassivaDocumenti then
      OpenA200ImportazioneMassivaDocumenti
    else if Sender = actGestioneOrdiniProf then
      OpenS130OrdiniProfessionali
    else if Sender = actProfiliStampeRep then
      OpenA207ProfiliStampeRep;
  finally
    (Sender as TAction).HelpContext:=0;
    if C700FSelezioneAnagrafe = nil then
    begin
