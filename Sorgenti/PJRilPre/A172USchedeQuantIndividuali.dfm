inherited A172FSchedeQuantIndividuali: TA172FSchedeQuantIndividuali
  HelpContext = 172000
  BorderIcons = [biSystemMenu, biMinimize, biMaximize]
  Caption = '<A172> Schede quantitative individuali'
  ClientHeight = 538
  ClientWidth = 784
  OnActivate = nil
  ExplicitWidth = 800
  ...
  object Panel2: TPanel [3]
    ...
    object dtxtDescrizione: TDBText
      ...
      DataSource = A172FSchedeQuantIndividualiDtM.dsrT765
    end
    object lblTotOreAccett: TLabel
      Left = 624
      Top = 89
      Width = 82
      Height = 13
    ...
    object dcmbTipoQuota: TDBLookupComboBox
      ...
      ListSource = A172FSchedeQuantIndividualiDtM.dsrT765
      TabOrder = 6
      OnCloseUp = dcmbTipoQuotaCloseUp
      OnKeyDown = dcmbTipoQuotaKeyDown
      OnKeyUp = dcmbTipoQuotaKeyUp
    end
    ...
    object dchkSupervisione: TDBCheckBox
      Left = 6
      Top = 115
      Width = 81
      Height = 17
      ...
      ValueChecked = 'S'
      ValueUnchecked = 'N'
      OnClick = dchkSupervisioneClick
    end
    object dcmbSupervisore: TDBLookupComboBox
      Left = 85
      Top = 113
      Width = 142
      Height = 21
      ...
      ListField = 'VALUTATORE;PROGRESSIVO'
      TabOrder = 11
      OnKeyDown = dcmbTipoQuotaKeyDown
    end
    object edtNumOreTotale: TEdit
      Left = 362
      Top = 86
      Width = 70
      Height = 21
  ...
  object dgrdSchedeInd: TDBGrid [5]
    Left = 0
    Top = 270
    Width = 784
    Height = 234
    ...
    TitleFont.Style = []
    OnEditButtonClick = dgrdSchedeIndEditButtonClick
    Columns = <
      item
        Expanded = False
        FieldName = 'MATRICOLA'
      ...
      item
        Expanded = False
        FieldName = 'TOTQUOTAQUAL'
        ReadOnly = True
        Title.Caption = 'Qualitativo'
        Width = 60
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = 'NOTE'
        Title.Caption = 'Casi particolari'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clBlue
        Title.Font.Height = -11
        Title.Font.Name = 'MS Sans Serif'
      ...
      item
        Expanded = False
        FieldName = 'VALUTATORE'
        Title.Caption = 'Valutatore'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clBlue
        Title.Font.Height = -11
        Title.Font.Name = 'MS Sans Serif'
      ...
      item
        ...
        Title.Caption = 'Ore extra budget'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clBlue
        Title.Font.Height = -11
        Title.Font.Name = 'MS Sans Serif'
      ...
      item
        ...
        ReadOnly = True
        Title.Caption = 'Ore totali'
        Width = 60
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'NUMORE_PAGATE'
        ReadOnly = True
        Title.Caption = 'Ore pagate'
        Width = 60
        Visible = True
      end>
  end
  inline frmToolbarFiglio: TfrmToolbarFiglio [6]
    Left = 0
    Top = 247
    Width = 784
    Height = 23
    ...
    inherited actlstToolbarFiglio: TActionList
      ...
      inherited actTFAnnulla: TAction
        OnExecute = frmToolbarFiglioactTFAnnullaExecute
      end
  ...
  object btnObiettivi: TBitBtn [8]
    Left = 619
    Top = 244
    Width = 75
    Height = 25
    Hint = 'Obiettivi dei posizionati'
    Caption = 'Obiettivi posiz.'
    NumGlyphs = 2
    TabOrder = 7
    OnClick = mnuObiettiviClick
  end
  inherited MainMenu1: TMainMenu [9]
    Left = 400
    Top = 65534
  end
  inherited DButton: TDataSource [10]
    Left = 428
    Top = 65534
  end
  inherited PrinterSetupDialog1: TPrinterSetupDialog [11]
    Left = 456
    Top = 65534
  end
  ...
  object PopupMenu1: TPopupMenu
    ...
    Left = 488
    Top = 369
    object mnuObiettivi: TMenuItem
      Caption = 'Obiettivi dei posizionati'
      OnClick = mnuObiettiviClick
    end
    object mnuDatiAnagrafici: TMenuItem
      Caption = 'Dati anagrafici'
      OnClick = mnuDatiAnagraficiClick
    end
    object N4: TMenuItem
      Caption = '-'
    end
