...
begin
  ...
  TrovatoCogn:=False;
  for j:=0 to A042FDialogStampa.chkLIntestazione.Items.Count-1 do
    if (A042FDialogStampa.chkLIntestazione.Items[j] = 'COGNOME') and (A042FDialogStampa.chkLIntestazione.Checked[j]) then
      TrovatoCogn:=True;
  ...
  QRBData.Enabled:=A042FDialogStampa.chkRaggData.Checked;
  QRLIntData.Enabled:=not A042FDialogStampa.chkRaggData.Checked;
  QRDBTDettData.Enabled:=not A042FDialogStampa.chkRaggData.Checked;
  ...
  QRBTotaliGruppo.Enabled:=A042FDialogStampa.chkTotaliGruppo.Checked;
  QRBTotaliData.Enabled:=A042FDialogStampa.chkTotaliData.Checked;
  QRBTotali.Enabled:=A042FDialogStampa.chkTotali.Checked;
  QRBGruppo.ForceNewPage:=A042FDialogStampa.chkSaltoPagina.Checked;
  QRBData.ForceNewPage:=A042FDialogStampa.chkSaltoPaginaData.Checked;
