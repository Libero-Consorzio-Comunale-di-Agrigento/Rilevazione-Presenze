inherited A167FRegistraIncentiviDtM: TA167FRegistraIncentiviDtM
  ...
  object selT775: TOracleDataSet
    SQL.Strings = (
      '--quota fittizia'
        ...
        'select :PROGRESSIVO progressivo, :DINI decorrenza, :DFIN SCADENZ' +
        'A, :CODQUOTA codtipoquota, null importo, '
      
        '       null penalizzazione, null saltaprova, null num_ore, 100 p' +
        'erc_individuale, null perc_strutturale, null considera_saldo, '
      '       null percentuale, null sospendi_pt, null sospendi_quote, '
      '       :DFIN - :DINI + 1 GIORNI'
      '  from DUAL'
      ' where :CODQUOTA is not null'
      '   and not exists (select 1'
      '                     from T775_QUOTEINDIVIDUALI T'
      '                    where PROGRESSIVO = :PROGRESSIVO '
      '                      and DECORRENZA <= :DFIN'
      
        '                      and NVL(SCADENZA,TO_DATE('#39'31123999'#39','#39'DDMMY' +
        'YYY'#39')) >= :DINI'
    ...
    Variables.Data = {
      ...
      00000000120000003A0043004F004400510055004F0054004100050000000000
      000000000000}
    Left = 136
    Top = 62
  end
  ...
  object selT040: TOracleDataSet
    SQL.Strings = (
      ...
      '  AND T257.COD_TIPOACCORPCAUSALI = T769.COD_TIPOACCORPCAUSALI'
        ...
        '  AND (T769.CODTIPOQUOTA = '#39'*'#39' OR T769.CODTIPOQUOTA = :CODTIPOQU' +
        'OTA)'
    ...
    Optimize = False
    Variables.Data = {
      04000000070000000A0000003A00500052004F00470003000000000000000000
      ...
      540041000C00000000000000000000001A0000003A0043004F00440054004900
  ...
  object ControlloT257: TOracleDataSet
    SQL.Strings = (
        ...
        'select T769.DATO1,T769.DATO2,T769.DATO3,T769.CODTIPOQUOTA,T769.D' +
        'ECORRENZA,T257.COD_CAUSALE, COUNT(*) '
      ...
      'AND T769.COD_CODICIACCORPCAUSALI = T257.COD_CODICIACCORPCAUSALI'
        ...
        'GROUP BY T769.DATO1,T769.DATO2,T769.DATO3,T769.CODTIPOQUOTA,T769' +
        '.DECORRENZA,T257.COD_CAUSALE'
      'HAVING COUNT(*) > 1')
    Optimize = False
    Left = 32
    Top = 224
  ...
  object selT769: TOracleDataSet
    SQL.Strings = (
      ...
      '                            AND CODTIPOQUOTA = T769.CODTIPOQUOTA'
    ...
    Optimize = False
    Variables.Data = {
      04000000050000000C0000003A004400410054004F0031000500000000000000
      ...
      3A0044004100540041000C00000000000000000000001A0000003A0043004F00
      44005400490050004F00510055004F0054004100050000000000000000000000}
    Left = 428
    Top = 112
  end
  ...
  object selT134: TOracleDataSet
    SQL.Strings = (
      'select t134.*,t134.rowid '
      'from t134_oreliquidateanniprec t134'
      'where anno = :ANNO'
      '  and progressivo = :PROG'
      'order by data')
    Optimize = False
