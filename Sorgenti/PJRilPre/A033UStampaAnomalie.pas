...
type
  TA033FStampaAnomalie = class(TForm)
    ...
    chkConsideraRichiesteIter: TCheckBox;
...
begin
  ...
  begin
    ...
    QRLabel2.Caption:=Format('dal %s al %s',[frmInputPeriodo.edtInizio.Text, frmInputPeriodo.edtFine.Text]);
  end;
...
begin
  ...
  begin
    ...
    chkConsideraRichiesteIter.Checked:=C004FParamForm.GetParametro('CONSIDERARICHIESTEITER','N') = 'S';
...
begin
  ...
  with A033FStampaAnomalie do
    ...
    C004FParamForm.PutParametro('CONSIDERARICHIESTEITER',IfThen(chkConsideraRichiesteIter.Checked,'S','N'));
...
{ DataF }
function TA033FStampaAnomalie._GetDataF: TDateTime;
begin
  Result := frmInputPeriodo.DataFine;
end;

procedure TA033FStampaAnomalie._PutDataF(const Value: TDateTime);
begin
...
{ DataI }
function TA033FStampaAnomalie._GetDataI: TDateTime;
begin
  Result := frmInputPeriodo.DataInizio;
end;

procedure TA033FStampaAnomalie._PutDataI(const Value: TDateTime);
begin
