...
uses
  ...
  A000UMessaggi, A022UContrattiMW;
...
type
  TA022FContrattiDtM1 = class(TDataModule)
    ...
    procedure T200AfterCancel(DataSet: TDataSet);
  private
  ...
  public
    { Public declarations }
    A022FContrattiMW:TA022FContrattiMW;
  end;
...
begin
  ...
  A022FContrattiMW:=TA022FContrattiMW.Create(nil);
  A022FContrattiMW.T200:=T200;
...
begin
  ...
  A022FContrattiMW.T200AfterPost;
  if Inserimento then
  begin
    for i:= 1 to 9 do
    begin
...
procedure TA022FContrattiDtM1.T200AfterCancel(DataSet: TDataSet);
begin
  A022FContrattiMW.selT203.CancelUpdates;
end;
...
begin
  ...
  A022FContrattiMW.T200AfterScroll;
end;
