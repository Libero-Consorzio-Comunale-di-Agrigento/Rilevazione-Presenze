inherited A022FContratti: TA022FContratti
  ...
  object PageControl1: TPageControl [2]
    ...
    Width = 560
    Height = 291
    ActivePage = tabOreSupplPT
    Align = alClient
    TabOrder = 2
    object tabParametri: TTabSheet
      Caption = 'Parametri'
    ...
    object tabFasceMaggiorazione: TTabSheet
    ...
    object tabOreSupplPT: TTabSheet
      Caption = 'Ore supplementari Part-time'
      ImageIndex = 2
      object dgrdOreSupplPT: TDBGrid
        Left = 0
        Top = 24
        Width = 552
        Height = 239
      ...
      object ToolBar1: TToolBar
        ...
        object cmbT203Decorrenza: TComboBox
          Left = 74
          Top = 0
          Width = 95
          Height = 21
  ...
  inherited ActionList1: TActionList
    ...
    inherited actStoricizza: TAction
      OnExecute = actStoricizzaExecute
    end
