object A002FAnagrafeDtM1: TA002FAnagrafeDtM1
  ...
  object Q030: TOracleDataSet
    ...
    object Q030TIPO_SOGGETTO_BASE: TStringField
    ...
    object Q030I060EMAILPEC: TStringField
      FieldKind = fkCalculated
      FieldName = 'I060EMAILPEC'
      Size = 200
      Calculated = True
    end
    object Q030I060EMAILPERSONALE: TStringField
      FieldKind = fkCalculated
      FieldName = 'I060EMAILPERSONALE'
      Size = 200
      Calculated = True
    end
    object Q030I060CELLULARE: TStringField
      DisplayWidth = 20
      FieldKind = fkCalculated
    ...
    object Q030I060CELLULAREPERSONALE: TStringField
      FieldKind = fkCalculated
  ...
  object Q430: TOracleDataSet
    ...
    object Q430AZIENDA_BASE: TStringField
      FieldName = 'AZIENDA_BASE'
      Size = 5
    end
    object Q430RAPPORTI_UNIFICATI: TStringField
    ...
    object Q430D_Squadra: TStringField
      ...
      FieldKind = fkLookup
      FieldName = 'D_Squadra'
      LookupDataSet = A002FAnagrafeMW.selT603
      LookupKeyFields = 'CODICE'
    ...
    object Q430D_AZIENDA_BASE: TStringField
      DisplayWidth = 20
      FieldKind = fkLookup
      FieldName = 'D_AZIENDA_BASE'
      LookupDataSet = A002FAnagrafeMW.selT440
      LookupKeyFields = 'CODICE'
      LookupResultField = 'DESCRIZIONE'
      KeyFields = 'AZIENDA_BASE'
      Size = 200
      Lookup = True
    end
  end
  object Q430B: TOracleDataSet
    ...
    object Q430BAZIENDA_BASE: TStringField
      FieldName = 'AZIENDA_BASE'
      Size = 5
    end
    object Q430BRAPPORTI_UNIFICATI: TStringField
      FieldName = 'RAPPORTI_UNIFICATI'
      Size = 1
    end
  end
