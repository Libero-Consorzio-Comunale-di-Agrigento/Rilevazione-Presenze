...
uses
  ...
  A121UOrganizzSindacali, Menus, DB, C180FunzioniGenerali, StrUtils;
...
begin
  OpenA121OrganizzSindacali(IfThen(R180In(DBGrid1.SelectedIndex,[2,3]),'S','O'),
                            A123FPartecipazioniSindacatiDtM.A123MW.selT247A.FieldByName(IfThen(R180In(DBGrid1.SelectedIndex,[2,3]),'COD_SINDACATO','COD_ORGANISMO')).AsString);
end;

procedure TA123FVisualizzazione.PopupMenu1Popup(Sender: TObject);
begin
  NuovoElemento1.Visible:=R180In(DBGrid1.SelectedIndex,[0,1,2,3]);
end;
