  ...
  with A009FProfiliAsseDtM1 do
    begin
      ...
      begin
        ...
        dchkPropGG.Enabled:=(DBComboBox1.ItemIndex in [1,2,3]) and (DBRadioGroup3.ItemIndex <> 2);
      end;
    end;
end;
...
begin
  ...
  dchkPropGG.Enabled:=(DBComboBox1.ItemIndex in [1,2,3]) and (DBRadioGroup3.ItemIndex <> 2);
  if (DButton.State in [dsEdit,dsInsert]) and (not dchkPropGG.Enabled) then
    dchkPropGG.Field.AsString:='N';
end;
