...
begin
  if A025FPianif.DataF <= 0 then
    A025FPianif.DataF:=Date;
  try
    Result:=A025FPianif.DataF;
  except
...
begin
  if A025FPianif.DataI <= 0 then
    A025FPianif.DataI:=Date;
  try
    Result:=A025FPianif.DataI;
  except
...
begin
  ...
  A025FPianif.CaricaPickListTurni;
