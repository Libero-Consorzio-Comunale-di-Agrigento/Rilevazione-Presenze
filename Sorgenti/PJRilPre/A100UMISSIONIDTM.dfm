  ...
  object M040: TOracleDataSet
    SQL.Strings = (
      ...
      '       T850.TIPO_RICHIESTA, '
        ...
        '       M140.ID, M140.FLAG_DESTINAZIONE, M140.FLAG_ISPETTIVA, M14' +
        '0.MISSIONE_RIAPERTA'
    ...
    object M040DescDestinazione: TStringField
      FieldKind = fkCalculated
      FieldName = 'DescDestinazione'
      Size = 200
      Calculated = True
    end
    object M040DescPartenza2: TStringField
      FieldKind = fkLookup
      FieldName = 'DescPartenza2'
      LookupDataSet = A100FMissioniMW.QSede
      LookupKeyFields = 'CODICE'
      LookupResultField = 'DESCRIZIONE'
      KeyFields = 'PARTENZA'
      Size = 80
