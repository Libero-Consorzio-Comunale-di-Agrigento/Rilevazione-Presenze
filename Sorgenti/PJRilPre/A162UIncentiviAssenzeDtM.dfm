  ...
  object selT769: TOracleDataSet
    SQL.Strings = (
      ...
      'from t769_incentiviassenze t769'
        ...
        'order by dato1,dato2,dato3,codtipoquota,cod_tipoaccorpcausali,co' +
        'd_codiciaccorpcausali,causale,decorrenza,decorrenza_fine'
      '')
    Optimize = False
    ...
    object selT769CODTIPOQUOTA: TStringField
      DisplayLabel = 'Codice quota'
      FieldName = 'CODTIPOQUOTA'
      Size = 5
    end
    object selT769D_TIPOQUOTA: TStringField
      FieldKind = fkLookup
    ...
    object selT769COD_TIPOACCORPCAUSALI: TStringField
      DisplayLabel = 'Tipo accorpamento ass.'
