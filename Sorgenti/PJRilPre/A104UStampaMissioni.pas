...
begin
  ...
  if A104FDialogStampa.rgpOrdinamento.ItemIndex = 1 then
  begin
    A104FStampaMissioniDtM1.TabellaStampa.IndexDefs.Add('Indice','cognome;nome;matricola;mesescarico;contatore',[ixPrimary]);
    QRGroup4.Expression:='TabellaStampa.PROGRESSIVO';
    QRGroup4.Enabled:=A104FDialogStampa.chkSaltoPagina.Checked;
  end
  else
  begin
    A104FStampaMissioniDtM1.TabellaStampa.IndexDefs.Add('Indice','mesescarico;contatore',[ixPrimary]);
    QRGroup4.Expression:='TabellaStampa.MESESCARICO';
    QRGroup4.Enabled:=True;
  end;
  A104FStampaMissioniDtM1.TabellaStampa.IndexName:='Indice';
  A104FStampaMissioniDtM1.TabellaStampa.Close;
  A104FStampaMissioniDtM1.TabellaStampa.Open;
  ...
  begin
    ...
    if A104FDialogStampa.StampaTXT then
      A104FStampaMissioni.ExportToFilter(TQRAsciiExportFilter.Create(A104FDialogStampa.DocumentoPDF))
    else
...
begin
  ...
  if A104FDialogStampa.rgpOrdinamento.ItemIndex = 1 then
    QRLblCompetenza.Caption:='Periodo scarico: ' + A104FDialogStampa.edtMeseScaricoDa.Text + '-' + A104FDialogStampa.edtMeseScaricoA.Text
  else
