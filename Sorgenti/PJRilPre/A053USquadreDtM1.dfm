object A053FSquadreDtM1: TA053FSquadreDtM1
  ...
  object Q600: TOracleDataSet
    ...
    object Q600MAX_NOTTI_MESE: TIntegerField
  ...
  object Q601: TOracleDataSet
    ...
    ReadOnly = True
    CachedUpdates = True
    BeforePost = Q601BeforePost
    BeforeDelete = Q601BeforeDelete
  ...
  object Q651: TOracleDataSet
    ...
    object Q651d_Area: TStringField
      DisplayLabel = 'Area'
      FieldKind = fkLookup
      FieldName = 'd_Area'
  ...
  object selT650: TOracleDataSet
    SQL.Strings = (
        ...
        'select CODICE, CODICE||'#39'-'#39'||DESCRIZIONE DECODIFICA from T650_ARE' +
        'E_TURNI'
      'order by CODICE')
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
