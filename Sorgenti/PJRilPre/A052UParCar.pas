...
uses
  ...
  C013UCheckList, System.Actions,A052UParCarMW, System.ImageList{, Vcl.DBLookup};
...
begin
  ...
  with A052FProprieta do
    try
      ...
      T:=PopupMenu1.PopupComponent.Tag;
      A052FParCarDtM1.A052FParCarMW.TagComponent:=T;
      //
      GiorniMese.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableGiorniMese(T);
      DBCheckBox1.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableGiorniMese(T);
      DBCheckBox2.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableGiorniMese(T);
      DBCheckBox3.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableGiorniMese(T);
      //
      Orologio.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      LAnomOrologio.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      EAnomOrologio.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      dchkTimbratureManuali.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      btnAnomalie2.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      btnAnomalie3.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      //R180AbilitaOggetti(gpbCauPresEscluse,A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T) or A052FParCarDtM1.A052FParCarMW.CausaliDaVisualizzare(T));
      gpbCauPresEscluse.Visible:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T) or A052FParCarDtM1.A052FParCarMW.CausaliDaVisualizzare(T);
      //
      Giustificativi.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableGiustificativi(T);
      Causale.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T);
      //
      Turno.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTurno(T);
      //
      Totali.Enabled:=A052FParCarDtM1.A052FParCarMW.EnableTotali(T);

      if A052FParCarDtM1.A052FParCarMW.EnableTimbrature(T) then
      begin
        Orologio.Checked:=A052FParCarDtM1.A052FParCarMW.GetCheckedOrologio(T);
        Causale.ItemIndex:=A052FParCarDtM1.A052FParCarMW.GetItemIndexCausale(T);
      end;

      if Giustificativi.Enabled then
        Giustificativi.ItemIndex:=A052FParCarDtM1.A052FParCarMW.GetItemIndexGiustificativi(T);

      if A052FParCarDtM1.A052FParCarMW.EnableTurno(T) then
        Turno.ItemIndex:=A052FParCarDtM1.A052FParCarMW.GetItemIndexTurno(T);

      if A052FParCarDtM1.A052FParCarMW.EnableTotali(T) then
        Totali.Checked:=A052FParCarDtM1.A052FParCarMW.GetCheckedTotali(T);

      //CausaliDaVisualizzare:=A052FParCarDtM1.A052FParCarMW.CausaliDaVisualizzare(T);

      if ShowModal = mrOk then
      begin
        //Assegnazione delle proprietà indicate
        //Giustificativi
        if A052FParCarDtM1.A052FParCarMW.EnableGiustificativi(T) then
        ...
        if A052FParCarDtM1.A052FParCarMW.EnableTotali(T) then
          T:=A052FParCarDtM1.A052FParCarMW.GetTagTotali(Totali.Checked,T);
