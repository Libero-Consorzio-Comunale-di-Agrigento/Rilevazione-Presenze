...
uses
  ...
  A132UMagazzinoBuoniPasto, System.Actions, System.ImageList;
...
type
  TA073FAcquistoBuoni = class(TR001FGestTab)
    ...
    actImportaDaFile: TAction;
    N6: TMenuItem;
    Importazioneacquistidafileexcel1: TMenuItem;
    ...
    procedure actImportaDaFileExecute(Sender: TObject);
  private
...
uses
  ...
  A073UControllo,
  A073UImportazioneAcquistiExcel;
...
procedure TA073FAcquistoBuoni.actImportaDaFileExecute(Sender: TObject);
var
  LA073ImportForm: TA073FImportazioneAcquistiExcel;
begin
  ...
  LA073ImportForm:=TA073FImportazioneAcquistiExcel.Create(nil);
  try
    LA073ImportForm.ShowModal;
    DButton.DataSet.Refresh;
  finally
    FreeAndNil(LA073ImportForm);
  end;
end;
...
begin
  ...
  C700DatiSelezionati:=C700CampiBase + ', T030.CODFISCALE';
