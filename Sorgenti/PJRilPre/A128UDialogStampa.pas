...
begin
  ...
  begin
    ...
    begin
      ...
      SQLSelect:=SQLSelect + ',' + Alias + '.ORAINIZIO_TURNO1';
      SQLSelect:=SQLSelect + ',' + Alias + '.ORAFINE_TURNO1';
      SQLSelect:=SQLSelect + ',' + Alias + '.ORAINIZIO_TURNO2';
      SQLSelect:=SQLSelect + ',' + Alias + '.ORAFINE_TURNO2';
      case DataBaseDrv of
         //Sintassi ORACLE
         dbOracle:begin
                  if i <> 1 then
