...
type
  TA162FIncentiviAssenzeDtM = class(TR004FGestStoricoDtM)
    ...
    selT769CODTIPOQUOTA: TStringField;
    selT769D_TIPOQUOTA: TStringField;
    dsrT765: TDataSource;
...
begin
  ...
  selT769.FieldByName('D_TIPOQUOTA').LookupDataSet:=A162FIncentiviAssenzeMW.selT765;
  ...
  dsrT765.DataSet:=A162FIncentiviAssenzeMW.selT765;
