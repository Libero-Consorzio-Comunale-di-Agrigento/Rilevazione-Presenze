...
begin
  ...
  while not A116MW.selI010.Eof do
  begin
    if (Copy(A116MW.selI010.FieldByname('NOME_CAMPO').AsString,1,6) <> 'T430D_') and
       (A116MW.selI010.FieldByname('NOME_CAMPO').AsString <> 'COGNOME') and
       (A116MW.selI010.FieldByname('NOME_CAMPO').AsString <> 'NOME') and
       (A116MW.selI010.FieldByname('NOME_CAMPO').AsString <> 'MATRICOLA') then
      clbIntestazione.Items.Add(A116MW.selI010.FieldByname('NOME_LOGICO').AsString);
    clbDettaglio.Items.Add(A116MW.selI010.FieldByname('NOME_LOGICO').AsString);
    A116MW.selI010.Next;
  end;
...
begin
  ...
  if (A116MW.AnnoRif <> R180Anno(A116MW.Data) - 1) and (A116MW.AnnoRif <> R180Anno(A116MW.Data) - 2) then
  ...
  A116MW.INomeCampo.Clear;
  A116MW.INomeLogico.Clear;
  A116MW.DNomeCampo.Clear;
  A116MW.DNomeLogico.Clear;
  ...
  begin
    ...
    begin
      ...
      D_C:=VarToStr(A116MW.selI010.Lookup('NOME_LOGICO',C,'NOME_CAMPO'));
      A116MW.INomeCampo.Add(D_C);
      A116MW.INomeLogico.Add(C);
      if R180InserisciColonna(S,D_C) then
        C700SelAnagrafe.CloseAll;
      Insert('D_',D_C,5);
      if A116MW.selI010.Locate('NOME_CAMPO',D_C,[]) then
        if R180InserisciColonna(S,D_C) then
          C700SelAnagrafe.CloseAll;
    end;
  end;
  ...
  begin
    ...
    begin
      ...
      D_C:=VarToStr(A116MW.selI010.Lookup('NOME_LOGICO',C,'NOME_CAMPO'));
      A116MW.DNomeCampo.Add(D_C);
      A116MW.DNomeLogico.Add(C);
      if R180InserisciColonna(S,D_C) then
        C700SelAnagrafe.CloseAll;
    end;
  end;
  ...
  StatusBar.SimpleText:=IntToStr(C700SelAnagrafe.RecordCount) + ' Records';
