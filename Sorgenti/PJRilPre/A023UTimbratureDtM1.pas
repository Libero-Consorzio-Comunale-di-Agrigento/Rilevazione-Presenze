...
begin
  ...
  begin
    ...
    if Accept and selT722.Active then
      Accept:=Accept and R180In(DataSet.FieldByName('CODICE').AsString,[selT722.FieldByName('CAUSALE_STR').AsString,selT722.FieldByName('CAUSALE_STR_DOM').AsString]);
  end;
end;
