...
uses
  ...
  C700USelezioneAnagrafe, USelT004, Variants, QRExport, QRWebFilt, QRPDFFilt, QRPrntr, StrUtils, A000UMessaggi;
...
var i:Integer;
  ...
  begin
    ...
    begin
      ...
      R600DtM1.RiepilogaAssenze(Prog,RiepAData,G,GesDataNas,R600DtM1.RiferimentoDataNascita.Data);
