  ...
  object selT770: TOracleDataSet
    SQL.Strings = (
      ...
      'where T770.CODTIPOQUOTA = T765.CODICE (+)'
        ...
        'and nvl(T765.DECORRENZA765,to_date('#39'31123999'#39','#39'ddmmyyyy'#39')) = nvl' +
        '((select max(T765B.DECORRENZA)'
      
        '                                                                ' +
        '  from T765_TIPOQUOTE T765B'
      
        '                                                                ' +
        '  where T765B.CODICE = T765.CODICE'
      
        '                                                                ' +
        '  and T765B.DECORRENZA <= T770.DECORRENZA)'
