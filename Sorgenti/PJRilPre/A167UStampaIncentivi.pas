...
begin
  ...
  LTitolo.Caption:='Elaborazione da ' + A167FregistraIncentivi.frmInputPeriodo.edtInizio.Text + ' a ' + A167FregistraIncentivi.frmInputPeriodo.edtFine.Text + ': ' + A167FRegistraIncentivi.cmbTipoCalcolo.Items[A167FRegistraIncentivi.cmbTipoCalcolo.ItemIndex];
  Dec:='0';
