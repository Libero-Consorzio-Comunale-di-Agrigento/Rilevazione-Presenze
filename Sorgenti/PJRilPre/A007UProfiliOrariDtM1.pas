...
type
  ...
  TA007FProfiliOrariDtM1 = class(TR004FGestStoricoDtM)
    ...
    Q220PESO_SCOSTENTRATA_S: TIntegerField;
    Q220PESO_TIMBNONAPPOGGIATE_N: TIntegerField;
    Q220PESO_TIMBNONAPPOGGIATE_S: TIntegerField;
    Q220PESO_TIMBESTERNE: TIntegerField;
    Q220PESO_PRITIMSC_S: TIntegerField;
    Q220PESO_PRITIMSC_A: TIntegerField;
    Q220PESO_MINANTSCELTA: TIntegerField;
    Q220PESO_RITARDO_ENTRATA: TIntegerField;
    Q220IGNORA_STACCOPMT: TStringField;
    procedure Q220ANTICIPOUSCITAGetText(Sender: TField; var Text: string; DisplayText: Boolean);
    ...
    procedure T220AnticipoUscitaSetText(Sender: TField; const Text: string);
...
procedure TA007FProfiliOrariDtM1.AfterDelete(DataSet: TDataSet);
begin
  Cancellazione:=True;
  try
    inherited;
...
begin
  ...
  if Cancellazione or (Dataset.Name = 'Q221') then
    inherited
  else
  begin
