...
uses
  ...
  System.Actions, C180FunzioniGenerali, StrUtils;
...
begin
  inherited;
  OpenA121OrganizzSindacali(IfThen(R180In(grdIscrizioni.SelectedIndex,[2,3]),'S','O'),
                            A123FPartecipazioniSindacatiDtM.selT247.FieldByName(IfThen(R180In(grdIscrizioni.SelectedIndex,[2,3]),'COD_SINDACATO','COD_ORGANISMO')).AsString);
end;
