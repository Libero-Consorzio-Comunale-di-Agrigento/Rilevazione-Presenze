inherited A162FIncentiviAssenze: TA162FIncentiviAssenze
  ...
  object dgrdAbbattimenti: TDBGrid [3]
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = '% abb. supero franch.'
        Width = 105
        Visible = True
      end>
  end
  object Panel1: TPanel [4]
    ...
    object dcmbCodTipoQuota: TDBLookupComboBox
      Left = 156
      Top = 76
      Width = 113
      Height = 21
      DataField = 'CODTIPOQUOTA'
      DataSource = DButton
      DropDownWidth = 500
      KeyField = 'CODICE'
      ListField = 'CODICE;DESCRIZIONE'
      ListSource = A162FIncentiviAssenzeDtM.dsrT765
      PopupMenu = pmnCodTipoQuota
      TabOrder = 3
      OnCloseUp = dcmbDato3CloseUp
      OnKeyDown = dcmbDato1KeyDown
      OnKeyUp = dcmbDato3KeyUp
