...
uses Data.DB, OracleData, System.Classes,
  Forms, Oracle, SysUtils, Variants, Controls,
  A000UInterfaccia, A000UMessaggi, A000USessione, A056UTurnazIndMW,
...
begin
  ...
  begin
    ...
    if EPartenza.Value > EPartenza.MaxValue then
      EPartenza.Value:=0;
  end;
end;
