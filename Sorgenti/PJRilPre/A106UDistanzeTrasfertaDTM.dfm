inherited A106FDistanzeTrasfertaDTM: TA106FDistanzeTrasfertaDTM
  ...
  object SelM041: TOracleDataSet
    ...
    object SelM041desc_citta1: TStringField
      FieldKind = fkCalculated
      FieldName = 'desc_citta1'
      Size = 60
      Calculated = True
    end
    object SelM041desc_citta2: TStringField
      FieldKind = fkCalculated
      FieldName = 'desc_citta2'
      Size = 60
      Calculated = True
    end
  end
  object SelM041B: TOracleDataSet
    SQL.Strings = (
      ...
      '        union all'
        ...
        '        select ('#39'P'#39' || m042.codice), m042.descrizione, t480.citt' +
        'a, t480.cap, t480.provincia'
      ...
      '        ) c1,'
        ...
        'ione, citta as citta2, cap as cap2 ,provincia as prov2'
      '        from   t480_comuni'
      '        union all'
    ...
    object SelM041BCITTA1: TStringField
      FieldName = 'CITTA1'
      Size = 60
    end
    object SelM041BCITTA2: TStringField
      FieldName = 'CITTA2'
      Size = 60
    end
  end
