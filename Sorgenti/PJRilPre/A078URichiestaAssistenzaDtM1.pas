...
const
  A078ElencoQuery:array[1..127] of String =
...
{10} 'SELECT * FROM P272_RETRIBUZIONE_CONTRATTUALE WHERE PROGRESSIVO = <PROGRESSIVO>',
     'SELECT * FROM P430_ANAGRAFICO WHERE PROGRESSIVO = <PROGRESSIVO>',
...
{20} 'SELECT * FROM P663_FLUSSIDATIINDIVIDUALI WHERE PROGRESSIVO = <PROGRESSIVO>',
     'SELECT * FROM P673_XMLDATIINDIVIDUALI WHERE PROGRESSIVO = <PROGRESSIVO>',
...
{30} 'SELECT * FROM T040_GIUSTIFICATIVI WHERE PROGRESSIVO = <PROGRESSIVO>',
     ...
     'SELECT * FROM T073_SCHEDACAUSPRES WHERE PROGRESSIVO = <PROGRESSIVO>',
{40} 'SELECT * FROM T074_CAUSPRESFASCE WHERE PROGRESSIVO = <PROGRESSIVO>',
     ...
     'SELECT * FROM T130_RESIDANNOPREC WHERE PROGRESSIVO = <PROGRESSIVO>',
{50} 'SELECT * FROM T131_RESIDPRESENZE WHERE PROGRESSIVO = <PROGRESSIVO>',
     ...
     'SELECT * FROM T264_RESIDASSANN WHERE PROGRESSIVO = <PROGRESSIVO>',
     'SELECT * FROM T280_MESSAGGIWEB WHERE PROGRESSIVO = <PROGRESSIVO>',
{60} 'SELECT * FROM T295_MESSAGGIINVIATI WHERE PROGRESSIVO = <PROGRESSIVO>',
     ...
     'SELECT * FROM T410_PASTI WHERE PROGRESSIVO = <PROGRESSIVO>',
     'SELECT * FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>',
{70} 'SELECT * FROM T433_CDC_PERCENT WHERE PROGRESSIVO = <PROGRESSIVO>',
     ...
     'SELECT * FROM T762_INCENTIVIMATURATI WHERE PROGRESSIVO = <PROGRESSIVO>',
     'SELECT * FROM T775_QUOTEINDIVIDUALI WHERE PROGRESSIVO = <PROGRESSIVO>',
{80} 'SELECT * FROM T820_LIMITIIND WHERE PROGRESSIVO = <PROGRESSIVO>',
...
{84} 'SELECT * FROM T020_ORARI WHERE CODICE IN (' +
...
{85} 'SELECT * FROM T021_FASCEORARI WHERE CODICE IN ( ' +
     'SELECT ORARIO FROM T080_PIANIFORARI WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT LUNEDI FROM T221_PROFILISETTIMANA WHERE CODICE IN (SELECT DISTINCT PORARIO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>) ' +
     'UNION ' +
     ...
     'SELECT FESTIVO FROM T221_PROFILISETTIMANA WHERE CODICE IN (SELECT DISTINCT PORARIO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)) ',
     //'AND CODICE NOT IN (SELECT CODICE FROM T020_ORARI WHERE CODICE IN (SELECT DISTINCT ORARIO FROM T080_PIANIFORARI WHERE PROGRESSIVO = <PROGRESSIVO>))'*),
{86} 'SELECT * FROM T025_CONTMENSILI  WHERE CODICE IN (SELECT DISTINCT PERSELASTICO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{87} 'SELECT * FROM T460_PARTTIME WHERE CODICE IN (SELECT DISTINCT PARTTIME FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{88} 'SELECT * FROM T160_PROFILIINDENNITA WHERE CODICE IN (' +
...
{89} 'SELECT * FROM T162_INDENNITA WHERE CODICE IN ( ' +
     'SELECT INDENNITA FROM ' +
     'T160_PROFILIINDENNITA WHERE CODICE IN ( ' +
     'SELECT IPRESENZA FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT INDPRESENZA FROM T080_PIANIFORARI WHERE PROGRESSIVO = <PROGRESSIVO>))',
{90} 'SELECT * FROM T171_LIMITI WHERE CODICE IN ( ' +
     'SELECT INDENNITA FROM ' +
     'T160_PROFILIINDENNITA WHERE CODICE IN ( ' +
     'SELECT IPRESENZA FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT INDPRESENZA FROM T080_PIANIFORARI WHERE PROGRESSIVO = <PROGRESSIVO>))',
{91} 'SELECT * FROM T164_ASSOCIAZIONIINDENNITA WHERE CODICE IN ( ' +
     'SELECT INDENNITA FROM ' +
     'T160_PROFILIINDENNITA WHERE CODICE IN ( ' +
     'SELECT IPRESENZA FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT INDPRESENZA FROM T080_PIANIFORARI WHERE PROGRESSIVO = <PROGRESSIVO>))',
{92} 'SELECT * FROM T265_CAUASSENZE WHERE CODICE IN (SELECT DISTINCT CAUSALE FROM T040_GIUSTIFICATIVI WHERE PROGRESSIVO = <PROGRESSIVO>)',
{93} 'select T230.*' +
     '  from T230_CAUASSENZE_PARSTO T230, T265_CAUASSENZE T265, (select distinct CAUSALE' +
     '                                                             from T040_GIUSTIFICATIVI' +
     '                                                            where PROGRESSIVO = <PROGRESSIVO>) T040' +
     ' where T265.CODICE = T040.CAUSALE' +
     '   and T265.ID = T230.ID',
{94} 'SELECT * FROM T260_RAGGRASSENZE WHERE CODICE IN (SELECT DISTINCT CODRAGGR FROM T265_CAUASSENZE WHERE CODICE IN (SELECT DISTINCT CAUSALE FROM T040_GIUSTIFICATIVI WHERE PROGRESSIVO = <PROGRESSIVO>))',
{95} 'SELECT * FROM T262_PROFASSANN WHERE CODPROFILO IN (SELECT DISTINCT PASSENZE FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>) ',
{96} 'SELECT * FROM T275_CAUPRESENZE WHERE CODICE IN ( ' +
...
{97} 'select T235.*' +
     ' from T235_CAUPRESENZE_PARSTO T235, T275_CAUPRESENZE T275, (select distinct CAUSALE' +
     '                                                             from T040_GIUSTIFICATIVI' +
     '                                                             where PROGRESSIVO = <PROGRESSIVO>) T040' +
     ' where T275.CODICE = T040.CAUSALE and T275.ID = T235.ID',
{98} 'SELECT * FROM T270_RAGGRPRESENZE WHERE CODICE IN (SELECT DISTINCT CODRAGGR FROM T275_CAUPRESENZE WHERE CODICE IN ( ' +
     'SELECT DISTINCT CAUSALE FROM T100_TIMBRATURE WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT DISTINCT CAUSALE FROM T040_GIUSTIFICATIVI WHERE PROGRESSIVO = <PROGRESSIVO>))',
{99} 'SELECT * FROM T276_VOCIPAGHEPRESENZA WHERE CODICE IN ( ' +
     'SELECT DISTINCT CAUSALE FROM T100_TIMBRATURE WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT DISTINCT CAUSALE FROM T040_GIUSTIFICATIVI WHERE PROGRESSIVO = <PROGRESSIVO>)',
{100}'SELECT * FROM T277_CAUFASCEABILITATE WHERE CODICE IN ( ' +
     'SELECT DISTINCT CAUSALE FROM T100_TIMBRATURE WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT DISTINCT CAUSALE FROM T040_GIUSTIFICATIVI WHERE PROGRESSIVO = <PROGRESSIVO>)',
{101}'SELECT * FROM T350_REGREPERIB WHERE CODICE IN ( ' +
...
{102}'SELECT * FROM T360_TERMENSA',
{103}'SELECT * FROM T670_REGOLEBUONI',
{104}'SELECT * FROM T305_CAUGIUSTIF WHERE CODICE IN ( ' +
     'SELECT DISTINCT CAUSALE FROM T100_TIMBRATURE WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
...
{105}'SELECT * FROM T300_RAGGRGIUSTIF WHERE CODICE IN (SELECT DISTINCT CODRAGGR FROM T305_CAUGIUSTIF WHERE CODICE IN ( ' +
     'SELECT DISTINCT CAUSALE FROM T100_TIMBRATURE WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT DISTINCT CAUSALE1MINASS FROM T070_SCHEDARIEPIL WHERE PROGRESSIVO = <PROGRESSIVO> ' +
     'UNION ' +
     'SELECT DISTINCT CAUSALE2MINASS FROM T070_SCHEDARIEPIL WHERE PROGRESSIVO = <PROGRESSIVO>))',
{106}'SELECT * FROM T163_CODICIINDENNITA WHERE CODICE IN (SELECT DISTINCT IPRESENZA FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{107}'SELECT * FROM T200_CONTRATTI WHERE CODICE IN (SELECT DISTINCT CONTRATTO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{108}'SELECT * FROM T201_MAGGIORAZIONI WHERE CODICE IN (SELECT DISTINCT CONTRATTO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{109}'SELECT * FROM T210_MAGGIORAZIONI',
{110}'SELECT * FROM T450_TIPORAPPORTO WHERE CODICE IN (SELECT DISTINCT TIPORAPPORTO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{111}'SELECT * FROM T010_CALENDIMPOSTAZ WHERE CODICE IN (SELECT DISTINCT CALENDARIO FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{112}'SELECT * FROM M040_MISSIONI WHERE PROGRESSIVO = <PROGRESSIVO>',
{113}'SELECT * FROM M010_PARAMETRICONTEGGIO M010 WHERE M010.CODICE IN (SELECT DISTINCT(<C8_MISSIONE>) FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{114}'SELECT * FROM M065_TARIFFE_INDENNITA WHERE CODICE IN (SELECT <C8_MISSIONE> FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{115}'SELECT * FROM M066_RIDUZIONI WHERE CODICE IN (SELECT <C8_MISSIONE> FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>)',
{116}'SELECT * FROM M060_ANTICIPI WHERE PROGRESSIVO = <PROGRESSIVO>',
{117}'SELECT * FROM M052_INDENNITAKM WHERE PROGRESSIVO = <PROGRESSIVO>',
{118}'SELECT * FROM M051_DETTAGLIORIMBORSO WHERE PROGRESSIVO = <PROGRESSIVO>',
{119}'SELECT * FROM M050_RIMBORSI WHERE PROGRESSIVO = <PROGRESSIVO>',
{120}'SELECT * FROM M011_TIPOMISSIONE WHERE CODICE IN (SELECT DISTINCT TIPOREGISTRAZIONE FROM M040_MISSIONI WHERE PROGRESSIVO = <PROGRESSIVO>)',
{121}'SELECT * FROM M020_TIPIRIMBORSI M020 WHERE EXISTS (SELECT ''X'' FROM M010_PARAMETRICONTEGGIO M010 WHERE M010.CODICE IN (SELECT DISTINCT(<C8_MISSIONE>) ' +
     'FROM T430_STORICO WHERE PROGRESSIVO = <PROGRESSIVO>) AND CODICI_RIMBORSI IS NOT NULL AND INSTR('',''||CODICI_RIMBORSI||'','', M020.CODICE) > 0)',
{122}'SELECT * FROM M025_MOTIVAZIONI',
{123}'SELECT * FROM M140_RICHIESTE_MISSIONI WHERE PROGRESSIVO = <PROGRESSIVO>',
{124}'SELECT M150.* FROM M150_RICHIESTE_RIMBORSI M150, M140_RICHIESTE_MISSIONI M140 WHERE M150.ID = M140.ID AND M140.PROGRESSIVO = <PROGRESSIVO>',
{125}'SELECT M160.* FROM M160_RICHIESTE_ANTICIPI M160, M140_RICHIESTE_MISSIONI M140 WHERE M160.ID = M140.ID AND M140.PROGRESSIVO = <PROGRESSIVO>',
{126}'SELECT M170.* FROM M170_RICHIESTE_MEZZI M170, M140_RICHIESTE_MISSIONI M140 WHERE M170.ID = M140.ID AND M140.PROGRESSIVO = <PROGRESSIVO>',
{127}'SELECT M175.* FROM M175_RICHIESTE_MOTIVAZIONI M175, M140_RICHIESTE_MISSIONI M140 WHERE M175.ID = M140.ID AND M140.PROGRESSIVO = <PROGRESSIVO>');
var
