...
begin
  ...
  RepR.PrinterSettings.UseStandardPrinter:=(A105FStoricoGiustificativi.A105MW.TipoModulo = 'COM') and Parametri.UseStandardPrinter;
  RepR.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText1.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText2.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText3.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText4.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText5.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText6.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText7.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBText8.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRdlblFlag.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBTGruppo.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBTCognome.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
  QRDBTBadge.DataSet:=A105FStoricoGiustificativi.A105MW.TabellaStampa;
end;
...
begin
  ...
  if (A105FStoricoGiustificativi.A105MW.TipoModulo = 'COM') and (Trim(A105FStoricoGiustificativi.A105MW.DocumentoPDF) <> '') and (Trim(A105FStoricoGiustificativi.A105MW.DocumentoPDF) <> '<VUOTO>') then
  begin
    RepR.ShowProgress:=False;
    RepR.ExportToFilter(TQRPDFDocumentFilter.Create(A105FStoricoGiustificativi.A105MW.DocumentoPDF));
  end
...
begin
  if (A105FStoricoGiustificativi.A105MW.TabellaStampa.FieldByName('Minuti').AsInteger) > 0 then
    Value:=R180MinutiOre(A105FStoricoGiustificativi.A105MW.TabellaStampa.FieldByName('Minuti').AsInteger);
end;
