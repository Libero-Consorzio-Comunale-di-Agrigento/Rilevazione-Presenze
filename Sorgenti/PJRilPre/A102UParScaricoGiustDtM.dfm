inherited A102FParScaricoGiustDtM: TA102FParScaricoGiustDtM
  ...
  object selI150: TOracleDataSet
    ...
    object selI150CHIAVE: TStringField
      DisplayLabel = 'Chiave'
      DisplayWidth = 15
      FieldName = 'CHIAVE'
      Size = 80
    end
    object selI150EXPR_CHIAVE: TStringField
      FieldName = 'EXPR_CHIAVE'
      Size = 2000
    end
    object selI150TRIGGER_BEFORE: TStringField
      FieldName = 'TRIGGER_BEFORE'
      Size = 1
    end
    object selI150TRIGGER_AFTER: TStringField
