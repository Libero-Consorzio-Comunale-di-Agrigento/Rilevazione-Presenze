...
type
  TA106FDistanzeTrasfertaDTM = class(TR004FGestStoricoDtM)
    ...
    SelM041BCITTA1: TStringField;
    SelM041BCITTA2: TStringField;
    SelM041desc_citta1: TStringField;
    SelM041desc_citta2: TStringField;
...
begin
  ...
  if SelM041.FieldByName('LOCALITA1').AsString <> '' then
  // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.fine
  begin
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.ini
    CodIstat:=SelM041.FieldByName('LOCALITA1').AsString;
    if SelM041.FieldByName('TIPO1').AsString = 'P' then
      CodIstat:=VarToStr(A106FDistanzeTrasfertaMW.selM042.Lookup('CODICE',CodIstat,'COD_ISTAT'));
    //A106FDistanzeTrasfertaMW.SelT480.SearchRecord('CODICE',SelM041.FieldByName('LOCALITA1').AsString,[srFromBeginning]);
    A106FDistanzeTrasfertaMW.SelT480.SearchRecord('CODICE',CodIstat,[srFromBeginning]);
    SelM041.FieldByName('desc_citta1').AsString:=A106FDistanzeTrasfertaMW.SelT480.FieldByName('CITTA').AsString;
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.fine
  ...
  begin
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.ini
    SelM041.FieldByName('desc_citta1').AsString:='';
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.fine
  ...
  if SelM041.FieldByName('LOCALITA2').AsString <> '' then
  // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.fine
  begin
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.ini
    CodIstat:=SelM041.FieldByName('LOCALITA2').AsString;
    if SelM041.FieldByName('TIPO2').AsString = 'P' then
      CodIstat:=VarToStr(A106FDistanzeTrasfertaMW.selM042.Lookup('CODICE',CodIstat,'COD_ISTAT'));
    //A106FDistanzeTrasfertaMW.SelT480.SearchRecord('CODICE',SelM041.FieldByName('LOCALITA2').AsString,[srFromBeginning]);
    A106FDistanzeTrasfertaMW.SelT480.SearchRecord('CODICE',CodIstat,[srFromBeginning]);
    SelM041.FieldByName('desc_citta2').AsString:=A106FDistanzeTrasfertaMW.SelT480.FieldByName('CITTA').AsString;
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.fine
  ...
  begin
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.ini
    SelM041.FieldByName('desc_citta2').AsString:='';
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.fine
