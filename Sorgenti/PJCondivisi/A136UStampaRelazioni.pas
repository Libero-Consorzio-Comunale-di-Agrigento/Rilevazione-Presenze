...
uses
  ...
  ComCtrls, A000UMessaggi, System.Actions;
...
begin
  ...
  if (Trim(medtDataStampa.Text) = '') or (medtDataStampa.Text = '  /  /    ') then
    raise Exception.Create(A000MSG_A136_NO_DATA);
...
begin
  ...
  begin
    ...
    raise exception.Create(Format(A000MSG_A136_ERR_FMT_RANGE_LIVELLI,[IntToStr(udLivelliDaEstrarre.Min),IntToStr(udLivelliDaEstrarre.Max)]));
  end;
end;
