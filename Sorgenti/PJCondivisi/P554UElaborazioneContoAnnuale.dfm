object P554FElaborazioneContoAnnuale: TP554FElaborazioneContoAnnuale
  ...
  object pnlPeriodoElab: TPanel
    ...
    object lblDAziendaBase: TLabel
      Left = 330
      Top = 10
      Width = 360
      Height = 13
      AutoSize = False
      Caption = 'lblDAziendaBase'
    end
    ...
    object cmbCodAziendaBase: TDBLookupComboBox
      Left = 257
      Top = 7
      Width = 66
      Height = 21
      ...
      TabOrder = 1
      OnClick = cmbCodAziendaBaseClick
      OnKeyDown = cmbCodAziendaBaseKeyDown
    end
  end
  object pnlImpostaDati: TPanel
    ...
    object chkEseguiScriptIniziali: TCheckBox
      Left = 481
      Top = 36
      Width = 168
      Height = 17
    ...
    object chkSvuotaTabella: TCheckBox
      Left = 199
      Top = 36
      Width = 168
      Height = 17
