object A062FQueryServizio: TA062FQueryServizio
  ...
  object pnlMail: TPanel
    ...
    object grpMail: TGroupBox
      ...
      object pnlControlliMail: TPanel
        Left = 2
        Top = 152
        Width = 820
        Height = 47
        ...
        ParentBackground = False
        TabOrder = 2
        object btnInvioAuto: TBitBtn
          Left = 703
          Top = 16
          Width = 114
          Height = 25
          Hint = 
            'Invia e-mail a tutti i clienti estratti componendo il messaggio ' +
            'in modo individuale per ognuno di essi (messaggio diverso per og' +
            'nuno)'
          Caption = 'E-mail individuale'
          Enabled = False
          Glyph.Data = {
            42020000424D4202000000000000420000002800000010000000100000000100
            1000030000000002000000000000000000000000000000000000007C0000E003
        ...
        object BEMail: TBitBtn
          ...
          Hint = 
            'Invia e-mail a tutti i clienti estratti componendo il messaggio ' +
            'in modo collettivo (unico messaggio uguale per tutti)'
          Caption = 'E-mail collettiva'
          Enabled = False
          Glyph.Data = {
            F6000000424DF600000000000000760000002800000010000000100000000100
            ...
            
            07FFFFFF707EE707FFFFFFFFFF7007FFFFFFFFFFFFFFFFFFFFFF}
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
          OnClick = BEMailClick
        end
        object rgpMailingList: TRadioGroup
          Left = 3
          Top = 3
          Width = 446
          Height = 41
  ...
  object PopupMenu3: TPopupMenu
    ...
    Left = 120
    Top = 277
    object Contatti1: TMenuItem
      Caption = 'Contatti'
      Visible = False
      OnClick = Contatti1Click
    end
    object Installazioni1: TMenuItem
      Caption = 'Installazioni'
      Visible = False
      OnClick = Installazioni1Click
    end
    object Commesse1: TMenuItem
      Caption = 'Commesse'
      Visible = False
      OnClick = Commesse1Click
    end
    object N2: TMenuItem
      Caption = '-'
      Visible = False
    ...
    object Salvasufile1: TMenuItem
      Caption = 'Salva su file'
      object InformatoExcel1: TMenuItem
        Caption = 'In formato Excel'
        Hint = 'In formato Excel'
        OnClick = SalvainExcelClick
      end
      object InformatoCSV1: TMenuItem
        Caption = 'In formato CSV'
        Hint = 'In formato CSV'
        OnClick = SalvainCSVClick
      end
      object InformatoTXT1: TMenuItem
        Caption = 'In formato TXT'
        Hint = 'In formato TXT'
        OnClick = SalvainTXT1Click
      end
    end
  end
