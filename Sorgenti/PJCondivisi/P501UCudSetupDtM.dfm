inherited P501FCudSetupDtM: TP501FCudSetupDtM
  ...
  object selP500: TOracleDataSet
    SQL.Strings = (
        ...
        'DECODE(COD_AZIENDA_BASE,'#39'BASE'#39',0,1), COD_AZIENDA_BASE')
    Optimize = False
    ...
    object selP500COD_AZIENDA_BASE: TStringField
      DisplayLabel = 'Azienda'
      FieldName = 'COD_AZIENDA_BASE'
      Size = 5
    end
    object selP500D_AZIENDA_BASE: TStringField
      FieldKind = fkLookup
      FieldName = 'D_AZIENDA_BASE'
      LookupDataSet = P501FCudSetupMW.selT440
      LookupKeyFields = 'CODICE'
      LookupResultField = 'DESCRIZIONE'
      KeyFields = 'COD_AZIENDA_BASE'
      Size = 200
      Lookup = True
    end
    ...
    object selP500E_MAIL_PEC: TStringField
      DisplayLabel = 'E-mail PEC'
      FieldName = 'E_MAIL_PEC'
      Size = 50
    end
    ...
    object selP500CODICE_AZIENDA_ONAOSI: TStringField
      DisplayLabel = 'Codice azienda ONAOSI'
      FieldName = 'CODICE_AZIENDA_ONAOSI'
      Size = 5
    end
    object selP500NOMIN_RESP_UO_ONAOSI: TStringField
      DisplayLabel = 'Nominativo resp. U.O. ONAOSI'
      FieldName = 'NOMIN_RESP_UO_ONAOSI'
      Size = 60
    end
    object selP500TELEFONO_RESP_UO_ONAOSI: TStringField
      DisplayLabel = 'Telefono resp. U.O. ONAOSI'
      FieldName = 'TELEFONO_RESP_UO_ONAOSI'
      Size = 12
    end
    object selP500E_MAIL_RESP_UO_ONAOSI: TStringField
      DisplayLabel = 'E-mail resp. U.O. ONAOSI'
      FieldName = 'E_MAIL_RESP_UO_ONAOSI'
      Size = 50
    end
    object selP500NOMIN_RESP_PROC_ONAOSI: TStringField
      DisplayLabel = 'Nominativo resp. proc. ONAOSI'
      FieldName = 'NOMIN_RESP_PROC_ONAOSI'
      Size = 60
    end
    object selP500TELEFONO_RESP_PROC_ONAOSI: TStringField
      DisplayLabel = 'Telefono resp. proc. ONAOSI'
      FieldName = 'TELEFONO_RESP_PROC_ONAOSI'
      Size = 12
    end
    object selP500E_MAIL_RESP_PROC_ONAOSI: TStringField
      DisplayLabel = 'E-mail resp. proc. ONAOSI'
      FieldName = 'E_MAIL_RESP_PROC_ONAOSI'
      Size = 50
    end
    ...
    object selP500NOME_FILEPDF_CED: TStringField
      DisplayLabel = 'Nome file massivo PDF'
      FieldName = 'NOME_FILEPDF_CED'
      Size = 1000
    end
  end
