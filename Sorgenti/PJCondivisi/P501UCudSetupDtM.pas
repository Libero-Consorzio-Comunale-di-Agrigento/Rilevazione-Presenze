...
type
  TP501FCudSetupDtM = class(TR004FGestStoricoDtM)
    ...
    selP500NOME_FILEPDF_CED: TStringField;
    selP500COD_AZIENDA_BASE: TStringField;
    selP500D_AZIENDA_BASE: TStringField;
    selP500E_MAIL_PEC: TStringField;
    selP500CODICE_AZIENDA_ONAOSI: TStringField;
    selP500NOMIN_RESP_UO_ONAOSI: TStringField;
    selP500TELEFONO_RESP_UO_ONAOSI: TStringField;
    selP500E_MAIL_RESP_UO_ONAOSI: TStringField;
    selP500NOMIN_RESP_PROC_ONAOSI: TStringField;
    selP500TELEFONO_RESP_PROC_ONAOSI: TStringField;
    selP500E_MAIL_RESP_PROC_ONAOSI: TStringField;
...
begin
  ...
  selP500.FieldByName('D_AZIENDA_BASE').LookupDataSet:=P501FCudSetupMW.selT440;
