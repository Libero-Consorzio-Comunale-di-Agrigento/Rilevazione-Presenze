inherited P501FCudSetup: TP501FCudSetup
  ...
  object pgcPrincipale: TPageControl [2]
    Left = 0
    Top = 68
    Width = 784
    Height = 394
    ActivePage = tshDatiOnaosi
    Align = alClient
    ...
    object tshDatiGenerali: TTabSheet
      ...
      object lblMatricolaInpsVF: TLabel
        Left = 273
        Top = 18
        Width = 71
        Height = 13
      ...
      object dedtMatricolaInpsVF: TDBEdit
        Left = 349
        Top = 14
        Width = 136
        Height = 21
    ...
    object tshDatiCUD: TTabSheet
      ...
      object lblPathFilePDFCU: TLabel
        Left = 9
        Top = 162
        Width = 321
        Height = 13
      ...
      object dedtPathFilePDFCU: TDBEdit
        Left = 9
        Top = 176
        Width = 518
        Height = 21
    ...
    object tshDatiDMA: TTabSheet
      ...
      object lblCodSottoComparto: TLabel
        Left = 9
        Top = 182
        Width = 103
        Height = 13
    ...
    object tshDatiEMens: TTabSheet
      ...
      object lblCodFiscMittente: TLabel
        Left = 9
        Top = 74
        Width = 106
        Height = 13
      ...
      object lblCodFiscaleFirmaDMA2: TLabel
        Left = 9
        Top = 182
        Width = 156
        Height = 13
      ...
      object lblCodFormaGiuridDMA2: TLabel
        Left = 9
        Top = 209
        Width = 149
        Height = 13
      ...
      object lblCodContrattoDMA2: TLabel
        Left = 9
        Top = 236
        Width = 123
        Height = 13
      ...
      object lblCodINPDAPDMA2: TLabel
        Left = 9
        Top = 155
        Width = 140
        Height = 13
      ...
      object dedtCodFiscaleSw: TDBEdit
        Left = 176
        Top = 125
        Width = 108
        Height = 21
      ...
      object dedtCodSedeInps: TDBEdit
        Left = 176
        Top = 44
        Width = 47
        Height = 21
      ...
      object dedtCodFiscMittente: TDBEdit
        Left = 176
        Top = 71
        Width = 138
        Height = 21
    ...
    object tshDatiOnaosi: TTabSheet
      Caption = 'ONAOSI'
      ImageIndex = 12
      object lblCodOnaosi: TLabel
        Left = 30
        Top = 20
        Width = 73
        Height = 13
      ...
      object grpRespUOOnaosi: TGroupBox
        Left = 17
        Top = 53
        Width = 512
        Height = 109
        ...
        ParentFont = False
        TabOrder = 1
        object lblNominRespUOOnaosi: TLabel
          Left = 13
          Top = 24
          Width = 53
          Height = 13
        ...
        object lblTelefonoRespUOOnaosi: TLabel
          Left = 13
          Top = 51
          Width = 42
          Height = 13
        ...
        object lblEmailRespUOOnaosi: TLabel
          Left = 13
          Top = 78
          Width = 28
          Height = 13
        ...
        object dedtNominRespUOOnaosi: TDBEdit
          Left = 95
          Top = 21
          Width = 400
          Height = 21
        ...
        object dedtTelefonoRespUOOnaosi: TDBEdit
          Left = 95
          Top = 48
          Width = 177
          Height = 21
        ...
        object dedtEmailRespUOOnaosi: TDBEdit
          Left = 95
          Top = 75
          Width = 400
          Height = 21
      ...
      object grpRespProcOnaosi: TGroupBox
        Left = 17
        Top = 179
        Width = 512
        Height = 109
        ...
        ParentFont = False
        TabOrder = 2
        object lblNominRespProcOnaosi: TLabel
          Left = 13
          Top = 24
          Width = 53
          Height = 13
        ...
        object lblTelefonoRespProcOnaosi: TLabel
          Left = 13
          Top = 51
          Width = 42
          Height = 13
        ...
        object lblEmailRespProcOnaosi: TLabel
          Left = 13
          Top = 78
          Width = 28
          Height = 13
        ...
        object dedtNominRespProcOnaosi: TDBEdit
          Left = 95
          Top = 21
          Width = 400
          Height = 21
        ...
        object dedtTelefonoRespProcOnaosi: TDBEdit
          Left = 95
          Top = 48
          Width = 177
          Height = 21
        ...
        object dedtEmailRespProcOnaosi: TDBEdit
          Left = 95
          Top = 75
          Width = 400
          Height = 21
    ...
    object tshCedolino: TTabSheet
      ...
      object lblNomeFilePDFCed: TLabel
        Left = 11
        Top = 257
        Width = 350
        Height = 13
      ...
      object dedtPathFilePDFCed: TDBEdit
        Left = 11
        Top = 229
        Width = 600
        Height = 21
      ...
      object btnPathFilePDFCed: TButton
        Left = 611
        Top = 229
        Width = 16
        Height = 21
        Caption = '...'
        TabOrder = 6
        OnClick = btnPathFilePDFCedClick
      end
      object dedtNomeFilePDFCed: TDBEdit
        Left = 11
        Top = 271
        Width = 600
        Height = 21
      ...
      object btnNomeFilePDFCed: TButton
        Left = 611
        Top = 271
        Width = 16
        Height = 21
        Caption = '...'
        TabOrder = 8
        OnClick = btnNomeFilePDFCedClick
      end
    end
  ...
  object GroupBox1: TGroupBox [3]
    ...
    object lblCodAziendaBase: TLabel
      Left = 159
      Top = 18
      Width = 38
      Height = 13
    ...
    object dlblDAziendaBase: TDBText
      Left = 295
      Top = 18
      Width = 86
      Height = 13
      AutoSize = True
      DataField = 'D_AZIENDA_BASE'
      DataSource = DButton
    end
    ...
    object dcmbCodAziendaBase: TDBLookupComboBox
      Left = 222
      Top = 14
      Width = 66
      Height = 21
      DataField = 'COD_AZIENDA_BASE'
      DataSource = DButton
      DropDownWidth = 500
      KeyField = 'CODICE'
