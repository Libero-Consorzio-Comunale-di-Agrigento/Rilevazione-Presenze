...
uses InvokeRegistry, SOAPHTTPClient, Types, XSBuiltIns, A000Uinterfaccia;
...
begin
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
    if Parametri.CampiRiferimento.C33_ProxyServer <> '' then
    begin
      RIO.HTTPWebNode.Proxy:=Parametri.CampiRiferimento.C33_ProxyServer;
      RIO.HTTPWebNode.UserName:=Parametri.CampiRiferimento.C33_ProxyUser;
      RIO.HTTPWebNode.Password:=Parametri.CampiRiferimento.C33_ProxyPassword;
    end;
  try
