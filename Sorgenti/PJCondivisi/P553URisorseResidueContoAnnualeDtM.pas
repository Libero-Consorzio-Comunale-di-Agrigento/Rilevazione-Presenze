...
uses
  P553URisorseResidueContoAnnualeMW,
...
begin
  ...
  InizializzaDataSet(selP553, [evBeforePostNoStorico,
                               ...
                               evAfterDelete,
                               evAfterPost]);
  P553MW:=TP553FRisorseResidueContoAnnualeMW.Create(nil);
  P553MW.SelT553_Funzioni:=selP553;
  P553MW.selT470.Open;
...
//+++
procedure TP553FRisorseResidueContoAnnualeDtM.DataModuleDestroy(Sender: TObject);
begin
  FreeAndNil(P553MW);
  inherited;
end;
