inherited S031FFamiliari: TS031FFamiliari
  ...
  object PageControl1: TPageControl [6]
    ...
    object tabDatiAnagrafici: TTabSheet
      ...
      object lblDataRilascioCartaId: TLabel
        Left = 505
        Top = 167
        Width = 58
        Height = 13
      ...
      object lblDataScadenzaCartaId: TLabel
        Left = 613
        Top = 167
        Width = 72
        Height = 13
      ...
      object lblNumPassaporto: TLabel
        Left = 372
        Top = 208
        Width = 92
        Height = 13
      ...
      object lblDataRilascioPassaporto: TLabel
        Left = 505
        Top = 208
        Width = 58
        Height = 13
      ...
      object lblDataScadenzaPassaporto: TLabel
        Left = 613
        Top = 208
        Width = 72
        Height = 13
      ...
      object dcmbNazionalita: TDBLookupComboBox
        Tag = 1
        Left = 372
        Top = 137
        Width = 270
        ...
        DataSource = DButton
        DropDownWidth = 200
        KeyField = 'COD_NAZIONE'
        ListField = 'COD_NAZIONE;DESCRIZIONE'
        ListFieldIndex = 1
        PopupMenu = PopupMenu1
        TabOrder = 19
        OnKeyDown = dcmbMatricolaKeyDown
      end
      object cmbMotivoEsclusione: TComboBox
        Left = 223
        Top = 181
        Width = 138
        Height = 21
      ...
      object dedtDataRilascioCartaId: TDBEdit
        Left = 505
        Top = 181
        Width = 80
        Height = 21
        DataField = 'CARTA_ID_DATA_RIL'
        DataSource = DButton
        TabOrder = 29
        OnChange = dedtDataPreAdozChange
      end
      object btnDataRilascioCartaId: TButton
        Left = 587
        Top = 181
        Width = 17
        Height = 21
        Caption = '...'
        TabOrder = 30
        OnClick = btnDataRilascioCartaIdClick
      end
      object dedtDataScadenzaCartaId: TDBEdit
        Left = 613
        Top = 181
        Width = 80
        Height = 21
        DataField = 'CARTA_ID_DATA_SCAD'
        DataSource = DButton
        TabOrder = 31
        OnChange = dedtDataPreAdozChange
      end
      object btnDataScadenzaCartaId: TButton
        Left = 695
        Top = 181
        Width = 17
        Height = 21
        Caption = '...'
        TabOrder = 32
        OnClick = btnDataScadenzaCartaIdClick
      end
      object dEdtNumPassaporto: TDBEdit
        Left = 372
        Top = 222
        Width = 125
        Height = 21
      ...
      object dEdtDataRilascioPassaporto: TDBEdit
        Left = 505
        Top = 222
        Width = 80
        Height = 21
        DataField = 'PASSAPORTO_DATA_RIL'
        DataSource = DButton
        TabOrder = 34
      end
      object dEdtDataScadenzaPassaporto: TDBEdit
        Left = 613
        Top = 222
        Width = 80
        Height = 21
        DataField = 'PASSAPORTO_DATA_SCAD'
        DataSource = DButton
        TabOrder = 35
      end
      object btnDataRilascioPassaporto: TButton
        Left = 587
        Top = 222
        Width = 17
        Height = 21
        Caption = '...'
        TabOrder = 36
        OnClick = btnDataRilascioPassaportoClick
      end
      object btnDataScadenzaPassaporto: TButton
        Left = 695
        Top = 222
        Width = 17
        Height = 21
        Caption = '...'
        TabOrder = 37
        OnClick = btnDataScadenzaPassaportoClick
      end
    end
    ...
    object tabDatiStipendiali: TTabSheet
      ...
      object dchkInserimentoCU: TDBCheckBox
        Left = 19
        Top = 168
        Width = 230
        Height = 18
