object A008FOperatoriDtm1: TA008FOperatoriDtm1
  ...
  object QI090: TOracleDataSet
    ...
    object QI090DOMINIO_LDAP_DN: TStringField
      FieldName = 'DOMINIO_LDAP_DN'
      Visible = False
      Size = 1000
    end
    object QI090DOMINIO_LDAP_SUFFISSO: TStringField
  ...
  object selI073: TOracleDataSet
    SQL.Strings = (
      ...
      ' ORDER BY AZIENDA,PROFILO,:COLONNA_ORDER,GRUPPO,DESCRIZIONE')
    ReadBuffer = 500
    Optimize = False
    Variables.Data = {
      04000000020000001A0000003A004100500050004C004900430041005A004900
      4F004E0045000500000000000000000000001C0000003A0043004F004C004F00
      4E004E0041005F004F00520044004500520001000000050000006E756C6C0000
      000000}
    QBEDefinition.QBEFieldDefs = {
    ...
    BeforeRefresh = selI073BeforeRefresh
    AfterRefresh = selI073AfterRefresh
    Left = 333
    Top = 108
  ...
  object selI072Dist: TOracleDataSet
    ...
    Optimize = False
    Filtered = True
    BeforeOpen = selI072DistBeforeOpen
    BeforeScroll = BeforeScroll
  ...
  object selI073Dist: TOracleDataSet
    ...
    Optimize = False
    Filtered = True
    BeforeOpen = selI073DistBeforeOpen
    BeforeScroll = BeforeScroll
  ...
  object selI074Dist: TOracleDataSet
    ...
    Optimize = False
    Filtered = True
    BeforeOpen = selI074DistBeforeOpen
    BeforeScroll = BeforeScroll
  ...
  object QI060: TOracleDataSet
    SQL.Strings = (
        ...
        '_UTENTE2, I060.PASSWORD, I060.DATA_PW, I060.EMAIL, I060.EMAIL_PE' +
        'RSONALE, I060.EMAIL_PEC, '
      
        '       I060.CELLULARE, I060.CELLULARE_PERSONALE, I061F_ELENCO_PR' +
        'OFILI(I060.AZIENDA,I060.NOME_UTENTE) NOMI_PROFILI, T030.COGNOME|' +
        '|'#39' '#39'||T030.NOME NOMINATIVO_QRY,'
      '       I060.ROWID'
    ...
    object QI060NOME_UTENTE2: TStringField
      DisplayLabel = 'Alias'
    ...
    object QI060EMAIL_PEC: TStringField
      DisplayLabel = 'e-mail PEC'
      FieldName = 'EMAIL_PEC'
      Size = 200
    end
    object QI060CELLULARE: TStringField
    ...
    object QI060CELLULARE_PERSONALE: TStringField
      FieldName = 'CELLULARE_PERSONALE'
    end
    object QI060EMAIL_PERSONALE: TStringField
  ...
  object selI060: TOracleDataSet
    SQL.Strings = (
      'select distinct I060.NOME_UTENTE'
        ...
        'from MONDOEDP.I060_LOGIN_DIPENDENTE I060, MONDOEDP.I061_PROFILI_' +
        'DIPENDENTE I061'
  ...
  object selI061: TOracleDataSet
    SQL.Strings = (
      ...
      ' where I061.AZIENDA = :AZIENDA'
      '   and I061.NOME_UTENTE = :NOME_UTENTE'
      '  order by I061.FINE_VALIDITA desc, NOME_PROFILO'
      '  ')
    ReadBuffer = 5
    Optimize = False
    Variables.Data = {
  ...
  object dsrI061: TDataSource
    DataSet = selI061
    OnStateChange = dsrI061StateChange
    Left = 478
    Top = 295
  end
  ...
  object selI061Dist: TOracleDataSet
    ...
    Variables.Data = {
      0400000001000000100000003A0041005A00490045004E004400410005000000
      0000000000000000}
    BeforeOpen = selI061DistBeforeOpen
    Left = 422
    Top = 244
  end
  ...
  object selI075Dist: TOracleDataSet
    ...
    Optimize = False
    BeforeOpen = selI075DistBeforeOpen
    BeforeScroll = BeforeScroll
  ...
  object selApplicativiOperatore: TOracleDataSet
    SQL.Strings = (
      'select '
      '  distinct APPLICAZIONE '
      'from '
      '  MONDOEDP.I073_FILTROFUNZIONI '
      'where'
      '  APPLICAZIONE in ('#39'PAGHE'#39','#39'RILPRE'#39','#39'STAGIU'#39') '
      '  and TAG = 100 '
      '  and INIBIZIONE = '#39'S'#39' '
      '  and AZIENDA = :AZIENDA '
      '  and PROFILO = :PROFILO')
    Optimize = False
    Variables.Data = {
  ...
  object selApplicativiNew: TOracleDataSet
    SQL.Strings = (
      'select '
      '  distinct APPLICAZIONE '
      'from '
