...
type
  TA115FIterAutorizzativiDM = class(TR004FGestStoricoDtM)
    ...
    selI093MSG_NOTIFICA: TStringField;
    dsrI093: TDataSource;
...
begin
  ...
  begin
    A115FIterAutorizzativi.dgrdselI095.Columns[8].Visible:=A115MW.ModuloIterAutorizzativi;
    A115FIterAutorizzativi.dgrdselI095.Columns[9].Visible:=A115MW.ModuloIterAutorizzativi;
    A115FIterAutorizzativi.dgrdselI096.Columns[11].Visible:=A115MW.ModuloIterAutorizzativi;
    A115FIterAutorizzativi.dgrdselI096.Columns[12].Visible:=A115MW.ModuloIterAutorizzativi;
  end;
