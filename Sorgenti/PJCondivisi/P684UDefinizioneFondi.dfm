inherited P684FDefinizioneFondi: TP684FDefinizioneFondi
  HelpContext = 3684000
  BorderIcons = [biSystemMenu, biMinimize, biMaximize]
  Caption = '<P684> Definizione fondi'
  ClientHeight = 592
  ClientWidth = 792
  ExplicitWidth = 808
  ExplicitHeight = 651
  ...
  object pnlRicerca: TPanel [2]
    ...
    Align = alTop
    TabOrder = 2
    object dtxtDescrizione: TDBText
      Left = 235
      Top = 13
      Width = 547
      Height = 27
      DataField = 'DESCRIZIONE'
      DataSource = P684FDefinizioneFondiDtM.dsrP684Ricerca
    ...
    object cmbRicerca: TDBLookupComboBox
      Left = 8
      Top = 19
      Width = 128
      Height = 21
      ...
      DropDownWidth = 780
      KeyField = 'COD_FONDO'
      ListField = 'COD_FONDO;DESCRIZIONE'
      ListSource = P684FDefinizioneFondiDtM.dsrP684Ricerca
      TabOrder = 0
      OnCloseUp = cmbRicercaCloseUp
      OnKeyDown = cmbRicercaKeyDown
      OnKeyUp = cmbRicercaKeyUp
    end
    object cmbDecorrenza: TDBLookupComboBox
      Left = 143
      Top = 19
      Width = 86
      Height = 21
      DropDownRows = 15
      KeyField = 'DECORRENZA'
      ListField = 'DECORRENZA'
      ListSource = P684FDefinizioneFondiDtM.dsrP684Dec
      TabOrder = 1
      OnCloseUp = cmbDecorrenzaCloseUp
      OnKeyDown = cmbDecorrenzaKeyDown
      OnKeyUp = cmbDecorrenzaKeyUp
    end
  end
  object PageControl1: TPageControl [3]
    ...
    object tabGenerale: TTabSheet
      ...
      object btnDataCostituz: TBitBtn
        Left = 443
        Top = 18
        Width = 15
        Height = 25
        Caption = '...'
        TabOrder = 12
        OnClick = btnDataCostituzClick
      end
      object dedtDataCostituz: TDBEdit
        Left = 373
        Top = 20
        Width = 70
        Height = 21
      ...
      object dcmbMacroCateg: TDBLookupComboBox
        Left = 4
        Top = 118
        Width = 114
        Height = 21
        ...
        DropDownRows = 15
        DropDownWidth = 780
        KeyField = 'COD_MACROCATEG'
        ListField = 'COD_MACROCATEG;DESCRIZIONE'
        PopupMenu = PopupMenu1
        TabOrder = 5
        OnCloseUp = dcmbMacroCategCloseUp
        OnKeyDown = dcmbMacroCategKeyDown
        OnKeyUp = dcmbMacroCategKeyUp
      end
      object dcmbRaggr: TDBLookupComboBox
        Left = 4
        Top = 160
        Width = 114
        Height = 21
        ...
        DropDownWidth = 780
        KeyField = 'COD_RAGGR'
        ListField = 'COD_RAGGR;DESCRIZIONE'
        PopupMenu = PopupMenu1
        TabOrder = 6
        OnCloseUp = dcmbRaggrCloseUp
        OnKeyDown = dcmbRaggrKeyDown
        OnKeyUp = dcmbRaggrKeyUp
      end
      object gpbMonitoraggio: TGroupBox
        Left = 3
        Top = 397
        Width = 775
        Height = 73
        ...
        ParentFont = False
        TabOrder = 9
        object lblDataMonitoraggio: TLabel
          Left = 12
          Top = 21
          Width = 116
          Height = 13
        ...
        object dedtDataMonitoraggio: TDBEdit
          Left = 12
          Top = 36
          Width = 70
          Height = 21
    ...
    object tabRisorseGen: TTabSheet
      Caption = 'Risorse generali'
      ImageIndex = 1
      object dgrdRisorseGen: TDBGrid
        Left = 0
        Top = 0
        Width = 784
        Height = 473
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'Importo'
            Title.Caption = 'Imp.previsto'
            Visible = True
          end>
      end
    end
    object tabRisorseDett: TTabSheet
      Caption = 'Risorse dettagliate'
      ImageIndex = 2
      object dgrdRisorseDett: TDBGrid
        Left = 0
        Top = 0
        Width = 784
        Height = 473
    ...
    object tabDestinGen: TTabSheet
      Caption = 'Destinazioni generali'
      ImageIndex = 3
      object dgrdDestinGen: TDBGrid
        Left = 0
        Top = 0
        Width = 784
        Height = 473
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'Importo'
            Title.Caption = 'Imp.speso'
            Visible = True
          end>
      end
    end
    object tabDestinDett: TTabSheet
      Caption = 'Destinazioni dettagliate'
      ImageIndex = 4
      object dgrdDestinDett: TDBGrid
        Left = 0
        Top = 0
        Width = 784
        Height = 473
  ...
  object PopupMenu1: TPopupMenu
    ...
    object Modificacodicevoce: TMenuItem
      Caption = 'Modifica codice voce'
      Visible = False
      OnClick = ModificacodicevoceClick
    end
    object Rinumeraordinestampa: TMenuItem
      Caption = 'Rinumera ordine stampa'
      Visible = False
      OnClick = RinumeraordinestampaClick
    end
    object N4: TMenuItem
      Caption = '-'
    end
