inherited P946FCalcoloFLUPERDtm: TP946FCalcoloFLUPERDtm
  ...
  object selP663b: TOracleDataSet
    ...
    Variables.Data = {
      ...
      000000000E0000003A004E0055004D00450052004F0001000000000000000000
      0000}
    CommitOnPost = False
    Left = 368
    Top = 18
  ...
  object selT433: TOracleDataSet
    SQL.Strings = (
      ...
      ' WHERE PROGRESSIVO = :Progressivo '
      '   AND :DataElaborazione BETWEEN DECORRENZA AND DECORRENZA_FINE'
  ...
  object selI037: TOracleDataSet
    ...
    Variables.Data = {
      0400000003000000220000003A00440041005400410045004C00410042004F00
      520041005A0049004F004E0045000C0000000000000000000000180000003A00
      4E004F004D0045005F0046004C005500530053004F0005000000000000000000
  ...
  object selI037b: TOracleDataSet
    SQL.Strings = (
      'SELECT *'
      '  FROM I037_RELAZIONI_TABELLE'
      ' WHERE NOME_FLUSSO = :NOME_FLUSSO'
