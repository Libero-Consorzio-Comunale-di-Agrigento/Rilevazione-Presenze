inherited S031FFamiliariDtM: TS031FFamiliariDtM
  ...
  object QSG101: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      
      00000000}
    ...
    object QSG101NAZIONE: TStringField
      DisplayLabel = 'Nazionalit'#224
      FieldName = 'NAZIONE'
      Size = 3
    end
    object QSG101MOTIVO_ESCLUSIONE: TStringField
      DisplayLabel = 'Motivo esclusione'
      FieldName = 'MOTIVO_ESCLUSIONE'
      Size = 1
    end
    object QSG101CARTA_ID_NUMERO: TStringField
      DisplayLabel = 'Numero carta identit'#224
      FieldName = 'CARTA_ID_NUMERO'
    end
    object QSG101CARTA_ID_DATA_RIL: TDateTimeField
    ...
    object QSG101CARTA_ID_DATA_SCAD: TDateTimeField
    ...
    object QSG101INSERIMENTO_CU: TStringField
      DisplayLabel = 'Inserimento su modello CU'
      FieldName = 'INSERIMENTO_CU'
      Size = 1
    end
    object QSG101PASSAPORTO_NUMERO: TStringField
      FieldName = 'PASSAPORTO_NUMERO'
    end
    object QSG101PASSAPORTO_DATA_RILDATE: TDateTimeField
      FieldName = 'PASSAPORTO_DATA_RIL'
      DisplayFormat = 'dd/mm/yyyy'
      EditMask = '!00/00/0000;1;_'
    end
    object QSG101PASSAPORTO_DATA_SCADDATE: TDateTimeField
      FieldName = 'PASSAPORTO_DATA_SCAD'
      DisplayFormat = 'dd/mm/yyyy'
      EditMask = '!00/00/0000;1;_'
    end
    object QSG101ID_ESTERNO: TFloatField
      FieldName = 'ID_ESTERNO'
    end
  end
