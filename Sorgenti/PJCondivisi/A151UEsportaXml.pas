...
begin
  ...
  begin
    ...
    A151FEsportaXml.Height:=180;
    pnlTassiAssenza.Visible:=False;
    Panel2.Visible:=False;
    pnlLegge104.Visible:=True;
    pnlLegge104.Align:=alClient;
    lblNomeFileOutput.Visible:=False;
    edtUsername.Text:=A151FAssenteismoDtM.A151MW.UserNameText;
    edtCodiceEnte.Text:=A151FAssenteismoDtM.A151MW.CodEnteText;
    edtURLWS.Text:=A151FAssenteismoDtM.A151MW.URLWSText;
  end;
