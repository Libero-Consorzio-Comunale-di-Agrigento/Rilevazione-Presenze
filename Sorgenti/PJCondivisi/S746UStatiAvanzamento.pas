...
uses
  ...
  ExtCtrls, C600USelAnagrafe, System.Actions;
...
type
  TS746FStatiAvanzamento = class(TR004FGestStorico)
    ...
    btnDataDa: TButton;
    btnDataA: TButton;
    grpPeriodoRegistraVisione: TGroupBox;
    lblDataDaRegistraVisione: TLabel;
    lblDataARegistraVisione: TLabel;
    dedtDataDaRegistraVisione: TDBEdit;
    dedtDataARegistraVisione: TDBEdit;
    btnDataDaRegistraVisione: TButton;
    btnDataARegistraVisione: TButton;
    ...
    procedure dedtDataDaRegistraVisioneDblClick(Sender: TObject);
...
begin
  if (Sender as TButton).Name = 'btnDataDa' then
    ...
    NomeCampo:='DATA_A'
  else if (Sender as TButton).Name = 'btnDataDaRegistraVisione' then
    NomeCampo:='DATA_DA_RICHIESTA_VISIONE'
  else if (Sender as TButton).Name = 'btnDataARegistraVisione' then
...
procedure TS746FStatiAvanzamento.dedtDataDaRegistraVisioneDblClick(Sender: TObject);
begin
  inherited;
  if btnDataDaRegistraVisione.Enabled then
    S746FStatiAvanzamentoDtM.S746FStatiAvanzamentoMW.ResetPeriodoRegistraPresaVisione;
end;
...
begin
  ...
  btnDataDaRegistraVisione.Enabled:=btnDataDa.Enabled;
  btnDataARegistraVisione.Enabled:=btnDataA.Enabled;
