...
uses
  ...
  DBCtrls, Grids, DBGrids, ActnList, ImgList, ToolWin, A000UCostanti, A000USessione,A000UInterfaccia, Variants, System.Actions;
...
begin
  ...
  begin
    Caption:='<A035> Regole scarico paghe';
    HelpContext:=35000;
    ...
    DBGrid1.Columns[0].PickList.Add('I CAPITOLO');
    DBGrid1.Columns[0].PickList.Add('L ARTICOLO');
  end
  else if VoceMenu = cParContab then
  begin
    Caption:='<A035> Parametrizzazione scarico contabilità';
    HelpContext:=35100;
