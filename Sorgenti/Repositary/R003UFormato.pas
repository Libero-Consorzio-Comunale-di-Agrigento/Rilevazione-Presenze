...
uses
  ...
  StdCtrls, Buttons, R003UGeneratoreStampe, Variants,
...
var S,Msg:String;
begin
  if not(R003FGeneratoreStampeDtM.R003FGeneratoreStampeMW.IsDatoPresCaus(Dato) or
         R003FGeneratoreStampeDtM.R003FGeneratoreStampeMW.IsDatoAssCaus(Dato)) then
  begin
