...
type
  ...
  private
    ...
    FToken: String;                      // token per autenticazione
    FTimestamp: String;                  // timestamp per autenticazione
  ...
  public
    constructor Create(AOwner: TComponent; PDatiConnessione: TDatiConnessione; PAutenticazione: Boolean; POperazione: String; PDebugLogSuFile: Boolean; PToken: String = ''; PTimestamp: String = ''); reintroduce; overload;
...
begin
  ...
  begin
    S:=TB021FUtils.GetLogFmt(Self.ClassName,PNomeProc,PLogInfo);
...
constructor TR014FRestDM.Create(AOwner: TComponent; PDatiConnessione: TDatiConnessione;
  PAutenticazione: Boolean; POperazione: String; PDebugLogSuFile: Boolean; PToken: String = ''; PTimestamp: String = '');
begin
...
begin
  ...
  if not TryStrToInt64(FTimestamp,LParTimestamp) then
  begin
  ...
  Result:=TB021FUtils.VerificaToken(FToken, LParTimestamp, LParTokenPassphrase, LParTokenTimeout);
