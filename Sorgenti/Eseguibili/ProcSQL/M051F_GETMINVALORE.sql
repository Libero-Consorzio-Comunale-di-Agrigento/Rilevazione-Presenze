create or replace function M051F_GETMINVALORE(P_PROGRESSIVO in integer, P_MESESCARICO in date, P_MESECOMPETENZA in date, P_DATADA in date, P_ORADA in varchar2, P_DATO in varchar2) return varchar2 as
