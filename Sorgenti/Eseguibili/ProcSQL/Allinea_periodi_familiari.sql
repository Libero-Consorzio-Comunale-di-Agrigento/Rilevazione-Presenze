...
BEGIN
  -- Allineo i dati anagrafici(non storici) dei familiari: Matricola, Cognome, Nome, Sesso, Comune di nascita, CAP di nascita,
  -- Codice fiscale, Data di matrimonio e Inserimento sulla CU all'ultimo periodo storico, a parità di data di nascita.
  UPDATE SG101_FAMILIARI SG101 SET MATRICOLA = (SELECT MATRICOLA FROM SG101_FAMILIARI SG101A
  ...
  UPDATE SG101_FAMILIARI SG101 SET COMNAS = (SELECT COMNAS FROM SG101_FAMILIARI SG101A
    ...
    AND SG101A.DATANAS = SG101.DATANAS AND SG101A.DECORRENZA_FINE = TO_DATE('31123999','DDMMYYYY'))
    WHERE SG101.PROGRESSIVO = PROGIRIS AND SG101.NUMORD = NORD AND SG101.DECORRENZA_FINE < TO_DATE('31123999','DDMMYYYY');
  UPDATE SG101_FAMILIARI SG101 SET CAPNAS = (SELECT CAPNAS FROM SG101_FAMILIARI SG101A
    WHERE SG101A.PROGRESSIVO = SG101.PROGRESSIVO AND SG101A.NUMORD = SG101.NUMORD
    AND SG101A.DATANAS = SG101.DATANAS AND SG101A.DECORRENZA_FINE = TO_DATE('31123999','DDMMYYYY'))
    WHERE SG101.PROGRESSIVO = PROGIRIS AND SG101.NUMORD = NORD AND SG101.DECORRENZA_FINE < TO_DATE('31123999','DDMMYYYY');
  UPDATE SG101_FAMILIARI SG101 SET CODFISCALE = (SELECT CODFISCALE FROM SG101_FAMILIARI SG101A
    ...
    AND SG101A.DATANAS = SG101.DATANAS AND SG101A.DECORRENZA_FINE = TO_DATE('31123999','DDMMYYYY'))
    WHERE SG101.PROGRESSIVO = PROGIRIS AND SG101.NUMORD = NORD AND SG101.DECORRENZA_FINE < TO_DATE('31123999','DDMMYYYY');
  UPDATE SG101_FAMILIARI SG101 SET DATAMAT = (SELECT DATAMAT FROM SG101_FAMILIARI SG101A
    WHERE SG101A.PROGRESSIVO = SG101.PROGRESSIVO AND SG101A.NUMORD = SG101.NUMORD
    AND SG101A.DATANAS = SG101.DATANAS AND SG101A.DECORRENZA_FINE = TO_DATE('31123999','DDMMYYYY'))
    WHERE SG101.PROGRESSIVO = PROGIRIS AND SG101.NUMORD = NORD AND SG101.DECORRENZA_FINE < TO_DATE('31123999','DDMMYYYY');
  UPDATE SG101_FAMILIARI SG101 SET INSERIMENTO_CU = (SELECT INSERIMENTO_CU FROM SG101_FAMILIARI SG101A
    WHERE SG101A.PROGRESSIVO = SG101.PROGRESSIVO AND SG101A.NUMORD = SG101.NUMORD
    AND SG101A.DATANAS = SG101.DATANAS AND SG101A.DECORRENZA_FINE = TO_DATE('31123999','DDMMYYYY'))
    WHERE SG101.PROGRESSIVO = PROGIRIS AND SG101.NUMORD = NORD AND SG101.DECORRENZA_FINE < TO_DATE('31123999','DDMMYYYY');
