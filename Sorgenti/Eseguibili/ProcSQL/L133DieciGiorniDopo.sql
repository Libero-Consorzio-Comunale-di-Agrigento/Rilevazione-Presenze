...
begin
  ...
  while continua loop
    continua:=false;
    for t1 in c1(d) loop
      select CODCAU3,CAUSALI_CUMULO_L133,GSIGNIFIC into c2,causperiodi,ggcalendario from T265_CAUASSENZE where CODICE = t1.causale;
      if c2 is not null then
        ...
        begin
          select CODICE,CAUSALI_CUMULO_L133,GSIGNIFIC into c2,causperiodi,ggcalendario from T265_CAUASSENZE where CODCAU3 = t1.causale;
        exception
