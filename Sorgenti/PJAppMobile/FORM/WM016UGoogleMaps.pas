...
type
  TWM016FGoogleMaps = class(TUnimForm)
...
function WM016FGoogleMaps: TWM016FGoogleMaps;
...
function WM016FGoogleMaps: TWM016FGoogleMaps;
begin
  Result := TWM016FGoogleMaps(WM000FMainModule.GetFormInstance(TWM016FGoogleMaps));
end;

procedure TWM016FGoogleMaps.UnimFormCreate(Sender: TObject);
begin
  Caption:='<span style="display: flex; align-items: center;"><img src="' + WM000FServerModule.FilesFolderURL + 'favicon/favicon-32x32.png"><p>&nbsp&nbspMappa Rilevatori</p></span>';
end;

procedure TWM016FGoogleMaps.UnimFormDestroy(Sender: TObject);
begin
  UniSession.AddJS('clear()');
end;

procedure TWM016FGoogleMaps.UnimFormReady(Sender: TObject);
var LJsCode: string;
begin
