inherited WM004FCartellinoFM: TWM004FCartellinoFM
  ...
  inherited MainPanel: TMedpUnimPanelBase
    ...
    object lblParametrizzazione: TMedpUnimLabel
      Left = 40
      Top = 88
      Width = 268
      Height = 45
    ...
    object cmbParamStampa: TMedpUnimSelect
      Left = 64
      Top = 125
      Width = 200
      Height = 45
    ...
    object pnlNumCartellini: TMedpUnimPanelNumElem
      Left = 16
      Top = 168
      Width = 300
      Height = 45
      ...
      LabelNumElementi.Caption = 'Nessun cartellino'
      ...
      Icona.DesignSize = (
        200
        45)
      CaptionZero = 'Nessun cartellino'
      CaptionSingolare = 'cartellino'
      CaptionPlurale = 'cartellini'
      DesignSize = (
        300
        45)
    end
    object pnlListaCartellini: TMedpUnimPanelListaDisclosure
      Left = 0
      Top = 224
      Width = 347
      Height = 386
