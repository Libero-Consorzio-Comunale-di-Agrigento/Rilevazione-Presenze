inherited WM018FMessaggisticaDM: TWM018FMessaggisticaDM
  OldCreateOrder = True
  Height = 383
  Width = 698
  ...
  object selT282Inviati: TOracleDataSet
    SQL.Strings = (
      ...
      '       nvl(T283.D_ALLEGATI,0) D_ALLEGATI,'
        ...
        '       decode(decode(decode(T282.STATO, '#39'I'#39', '#39'1'#39', T282.STATO), '#39 +
        'S'#39', '#39'2'#39', T282.STATO), '#39'C'#39', '#39'3'#39', T282.STATO) ORDINE'
      'from   T282_MESSAGGI T282,'
      ...
      'and    T285.ID(+) = T282.ID'
      'and    T283.ID(+) = T282.ID'
      'order by ORDINE asc, T282.ID desc')
    Optimize = False
    Variables.Data = {
  ...
  object selT283DimAllegati: TOracleQuery
    SQL.Strings = (
      'select nvl(sum(T283.DIMENSIONE),0) DIM_ALLEGATI'
      'from   T282_MESSAGGI T282,'
      '       T283_ALLEGATI T283'
      'where  T282.MITTENTE = :MITTENTE'
      'and    T283.ID = T282.ID'
    ...
    Optimize = False
    Variables.Data = {
      0400000002000000120000003A004D0049005400540045004E00540045000500
  ...
  object selT282Ricevuti: TOracleDataSet
    SQL.Strings = (
      ...
      ':FILTRO_VIS'
        ...
        'order by decode(T_DEST.DATA_LETTURA, null, 1, 2) asc, decode(dec' +
        'ode(T_DEST.DATA_LETTURA, null, 1, 2), 1, decode(T282.LETTURA_OBB' +
        'LIGATORIA, '#39'S'#39', 2, 1), T282.ID) desc, T282.ID desc')
    Optimize = False
    Variables.Data = {
