inherited WM016FCambioOrarioDM: TWM016FCambioOrarioDM
  OnCreate = DataModuleCreate
  Height = 162
  Width = 429
  object selaT020: TOracleDataSet
    SQL.Strings = (
      'SELECT DESCRIZIONE, ORARI_SCAMBIO'
  ...
  object selT085: TOracleDataSet
    ...
    object selT085D_ORARIO: TStringField
      FieldKind = fkCalculated
      FieldName = 'D_ORARIO'
      Size = 100
      Calculated = True
    end
    object selT085D_ORARIO_INVER: TStringField
      FieldKind = fkCalculated
      FieldName = 'D_ORARIO_INVER'
      Size = 100
      Calculated = True
    end
    object selT085MSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 2000
    end
    object selT085MSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 2000
    end
  end
