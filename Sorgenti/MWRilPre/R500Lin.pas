...
type
  ...
  t_ttimbraturenom = record
    ...
    Ritardo       :Integer;
    tminutin_e_ori:Integer;
    tminutin_u_ori:Integer;
  end;
  ...
  t_tparcaus = record
    ...
    l29_51paramet,l29_52paramet,l29_53paramet
    :String;
  end;
  ...
  t_tdescanom2 = record
    N         :Byte;
    F         :Byte; //flag per dettagli supplementari sull' anomalia: 0 se solo descrizione, 1 se indicata anche la causale
    D         :String;
  end;

  t_tdescanom1array = array [1..26] of t_tdescanom;
  t_tdescanom2array = array [1..68] of t_tdescanom2;
  t_tdescanom3array = array [1..12] of t_tdescanom;
...
//*   Descrizione anomalie del secondo livello
  tdescanom2:t_tdescanom2array =
    ((N:01;F:1;D:'causale non esistente; ignorata'),
     ...
     (N:11;F:1;D:'Straordinario non abilitato; non conteggiato'),
     ...
     (N:20;F:1;D:'Ore lavorate in fascia < minime'),
     (N:21;F:1;D:'Ore lavorate in fascia > massime; troncate'),
     (N:22;F:1;D:'giornata intera di assenza con timbrature'),
     (N:23;F:1;D:'Straord. del gg > minuti massimi; troncato'),
     (N:24;F:0;D:'Intersezione fra timbrature e giustificativi'),
     ...
     (N:60;F:1;D:'La causale deve essere del tipo "Diminuisce le ore lavorate"'),
     (N:61;F:1;D:'Ore normali limitate al debito gg'),
     (N:62;F:1;D:'Punti nominali ristretti al debito gg'),
     (N:63;F:1;D:'Timbratura interseca il cambio di ora legale/solare'),
     (N:64;F:1;D:'Giustificativo ristretto all''interno dei punti nominali'),
     (N:65;F:1;D:'Ore causalizzate inferiori al minimo: minuti abbuonati'),
     (N:66;F:1;D:'Copertura della carenza oraria con ore causalizzate'),
     (N:67;F:1;D:'Condizione SQL non rispettata'),
     (N:68;F:1;D:'Fascia oraria di prestazioni aggiuntive pianificata non completa')
     );
//_________________________________________________________________
//***   Descrizione anomalie del terzo livello
  tdescanom3:t_tdescanom3array =
    ((N:01;D:'entrata fuori orario'),
     ...
     (N:03;D:'terminale non abilitato'),
     ...
     (N:10;D:'%s da autorizzare'),
     (N:11;D:'Richieste di %s autorizzate ma non importate sul cartellino'),
     (N:12;D:'Errore di esecuzione della condizione SQL per la causale %s: %s')
    );
//_________________________________________________________________
...
//***   Raggruppamento fisso giustificativi ( Pausa Mensa )
  ...
  //Default dei profili orari
  PESO_SCOSTENTRATA_S = 30;
  PESO_TIMBNONAPPOGGIATE_N = 60000;
  PESO_TIMBNONAPPOGGIATE_S = 1000;
  PESO_TIMBESTERNE = 100;
  PESO_PRITIMSC_S = 1000;
  PESO_PRITIMSC_A = 1000;
  PESO_MINANTSCELTA = 1000;
  PESO_RITARDO_ENTRATA = 10000;
