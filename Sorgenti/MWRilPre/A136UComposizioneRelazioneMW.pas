...
uses
  ...
  A000UCostanti, A000UMessaggi, A000USessione, Oracle;
...
begin
  ...
  FreeAndNil(cdsCampiRelazioni);//.Free;
  FreeAndNil(cdsDatiDecFine);//.Free;
  FreeAndNil(cdsSpostaLivRel);//.Free;
  FreeAndNil(cdsAppoggio);//.Free;
  FreeAndNil(cdsStampa);//.Free;
end;
...
begin
  ...
  begin
    ...
    begin
      Screen.Cursor:=crDefault;
      raise Exception.Create(A000MSG_A136_NO_RELAZIONI_ELAB);
    end;
