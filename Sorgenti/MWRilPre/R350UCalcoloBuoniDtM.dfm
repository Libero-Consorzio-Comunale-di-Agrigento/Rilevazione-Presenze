object R350FCalcoloBuoniDtM: TR350FCalcoloBuoniDtM
  ...
  object Q692: TOracleDataSet
    SQL.Strings = (
      ...
      '  */'
      '  select distinct '
      '    T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,:DATA,'#39'I'#39') INIZIO,'
      '    T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,:DATA,'#39'F'#39') FINE'
      '  from dual'
      '  )'
  ...
  object selPeriodoServizio: TOracleDataSet
    SQL.Strings = (
      ...
      'SELECT TRUNC(INIZIO,'#39'mm'#39') INIZIO,FINE FROM'
      '('
      '  /*'
      ...
      '  T430.PROGRESSIVO = T030.PROGRESSIVO AND'
        ...
        '  (:DATAINIZIO BETWEEN INIZIO AND NVL(FINE,TO_DATE(31123999,'#39'DDM' +
        'MYYYY'#39')) OR'
      
        '   :DATAFINE BETWEEN INIZIO AND NVL(FINE,TO_DATE(31123999,'#39'DDMMY' +
        'YYY'#39')))'
      '  */ '
      '  select distinct '
      '    T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,:DATAFINE,'#39'I'#39') INIZIO,'
      '    T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,:DATAFINE,'#39'F'#39') FINE'
      '  from dual'
      ')'
      'WHERE INIZIO IS NOT NULL')
    Optimize = False
  ...
  object Q690: TOracleQuery
    SQL.Strings = (
      ...
      '    */'
      '    select distinct '
      '      T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,:DATA2,'#39'I'#39') INIZIO,'
      '      T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,:DATA2,'#39'F'#39') FINE'
      '    from dual;'
      ''
      '  INIZIO DATE;'
      '  FINE DATE;'
      ...
      '    IF T1.INIZIO IS NOT NULL THEN'
        ...
        '      INIZIO:=TRUNC(T1.INIZIO,'#39'mm'#39');--LAST_DAY(ADD_MONTHS(T1.INI' +
        'ZIO,-1)) + 1;'
      '      FINE:=T1.FINE;'
      '    END IF;'
      '  END LOOP;'
  ...
  object selRimborsiMissioni: TOracleDataSet
    SQL.Strings = (
      ...
      'M040_MISSIONI M040, M050_RIMBORSI M050, M020_TIPIRIMBORSI M020'
      'WHERE'
      ...
      'M050.CODICERIMBORSOSPESE = M020.CODICE AND'
      'M020.TIPO = '#39'PASTO'#39)
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A00500052004F00470052004500530053004900
      56004F000300000000000000000000000A0000003A0044004100540041000C00
  ...
  object insT690: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  if :buoni_auto = 0 and :buoni_recuperati = 0 and :ticket_auto ' +
        '= 0 and :ticket_recuperati = 0 then'
      
        '    delete from t690_acquistobuoni where progressivo = :progress' +
        'ivo and data = :data;'
      '  else'
    ...
    Optimize = False
    Variables.Data = {
      0400000008000000160000003A00420055004F004E0049005F00410055005400
  ...
  object insT682: TOracleQuery
    SQL.Strings = (
      'begin'
      
        '  delete from t682_buonigiornalieri where progressivo = :progres' +
        'sivo and data = :data;'
      ' '
      '  if :buonipasto + :ticket > 0 then'
      
        '    insert into t682_buonigiornalieri (progressivo,data,buonipas' +
        'to,ticket)'
  ...
  object selT682: TOracleDataSet
    SQL.Strings = (
      'select'
      '     nvl(sum(T682.BUONIPASTO),0) BUONIPASTO,'
      '     nvl(sum(T682.TICKET),0) TICKET'
      'from'
      '     T682_BUONIGIORNALIERI T682'
      'where'
      '     T682.PROGRESSIVO = :PROGRESSIVO'
      'and'
      '     T682.DATA between TRUNC(:DATA-1, '#39'DAY'#39')+1 and :DATA-1')
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A00500052004F00470052004500530053004900
      56004F000300000000000000000000000A0000003A0044004100540041000C00
