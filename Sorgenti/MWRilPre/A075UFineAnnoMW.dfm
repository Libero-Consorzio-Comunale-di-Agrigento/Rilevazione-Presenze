inherited A075FFineAnnoMW: TA075FFineAnnoMW
  ...
  object scrT692: TOracleQuery
    SQL.Strings = (
      ...
      '    T430.PROGRESSIVO = T030.PROGRESSIVO AND'
        ...
        '    TO_DATE('#39'3112'#39'||LPAD(:ANNO,4,'#39'0'#39'),'#39'DDMMYYYY'#39') BETWEEN INIZIO' +
        ' AND NVL(FINE,TO_DATE(31123999,'#39'DDMMYYYY'#39')) '
      '    */'
      '    select distinct '
      
        '      T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,TO_DATE('#39'3112'#39'||LPAD' +
        '(:ANNO,4,'#39'0'#39'),'#39'DDMMYYYY'#39'),'#39'I'#39') INIZIO,'
      
        '      T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,TO_DATE('#39'3112'#39'||LPAD' +
        '(:ANNO,4,'#39'0'#39'),'#39'DDMMYYYY'#39'),'#39'F'#39') FINE'
      '    from dual'
      '  )'
  ...
  object selT430RapportiUnificati: TOracleQuery
    SQL.Strings = (
      'select decode(count(*),0,'#39'N'#39','#39'S'#39') from'
      '('
      
        '  select T430F_GETDATO(PROGRESSIVO,'#39'RAPPORTI_UNIFICATI'#39',max(FINE' +
        ')) RAPPORTI_UNIFICATI_PREC'
      '  from T430_STORICO'
      '  where PROGRESSIVO = :PROGRESSIVO'
      
        '  and FINE between add_months(trunc(:DATA,'#39'yyyy'#39'),-12) and trunc' +
        '(:DATA,'#39'yyyy'#39') - 1'
      '  group by PROGRESSIVO'
      ') T1,'
      '('
      
        '  select T430F_GETDATO(PROGRESSIVO,'#39'RAPPORTI_UNIFICATI'#39',min(INIZ' +
        'IO)) RAPPORTI_UNIFICATI_SUCC'
      '  from T430_STORICO'
      '  where PROGRESSIVO = :PROGRESSIVO'
      
        '  and INIZIO between trunc(:DATA,'#39'yyyy'#39') and add_months(trunc(:D' +
        'ATA,'#39'yyyy'#39') - 1,12)'
      '  group by PROGRESSIVO'
      ') T2'
      'where T1.RAPPORTI_UNIFICATI_PREC = '#39'S'#39' '
      'and   T2.RAPPORTI_UNIFICATI_SUCC = '#39'S'#39)
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A00500052004F00470052004500530053004900
