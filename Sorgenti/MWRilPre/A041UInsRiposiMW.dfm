inherited A041FInsRiposiMW: TA041FInsRiposiMW
  ...
  object delT040: TOracleQuery
    SQL.Strings = (
      ...
      '  and (DATA  BETWEEN :DATA1 and :DATA2)'
        ...
        '  and CAUSALE IN (:CAUSALE1,:CAUSALE2,:CAUSALE3,:CAUSALE4,:CAUSA' +
        'LENEG) '
    ...
    Variables.Data = {
      ...
      45003400050000000000000000000000160000003A0043004100550053004100
      4C0045004E0045004700050000000000000000000000}
    Left = 244
    Top = 104
  end
  ...
  object QGiustificativi: TOracleDataSet
    SQL.Strings = (
      'select'
      '       /*+ INDEX(T040_GIUSTIFICATIVI T040_PK)*/  '
      '       T040.DATA,T040.CAUSALE,T040.TIPOGIUST,'
      '       nvl(T265.VALSETIMB,'#39'N'#39') VALSETIMB'
      ...
      'select '
        ...
        '       /*SIHINT10 INDEX(T050_RICHIESTEASSENZA T050_BMI_ELABORATO' +
        ')*/'
      '       V010.DATA, VT050.CAUSALE, VT050.TIPOGIUST, '
      '       nvl(T265.VALSETIMB,'#39'N'#39') VALSETIMB'
      
        'from   VT050_RICHIESTE_SENZAREVOCA VT050, T265_CAUASSENZE T265, ' +
        'V010_CALENDARI V010'
      'where  :RichiesteIterAutorizzativo = '#39'S'#39
      'and    VT050.PROGRESSIVO = :PROGRESSIVO'
    ...
    Variables.Data = {
      ...
      4F0005000000020000004E0000000000}
    Left = 156
    Top = 6
  end
  object Q265: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT CODICE, DESCRIZIONE, GSIGNIFIC, UMCUMULO, CQ_PROGRESSIVO,' +
        ' CQ_FESTIVI, CQ_GGNONLAV, UM_INSERIMENTO, INFLUCONT'
  ...
  object updT040: TOracleQuery
    SQL.Strings = (
      'update T040_GIUSTIFICATIVI'
      '   set CAUSALE = :CAUSALENEG'
      'where PROGRESSIVO = :PROGRESSIVO  '
      '  and DATA = :DATAI'
      '  and CAUSALE = :CAUSALE'
      '  and TIPOGIUST = '#39'I'#39)
    ...
    Variables.Data = {
      
      540041004900050000000000000000000000}
    Left = 244
    Top = 160
  end
end
