...
uses
  ...
  C180FunzioniGenerali,A000UMessaggi,ControlloVociPaghe,Oracle;
...
begin
  ...
  or ((FSelM010_Funzioni.State = dsEdit) and 
	  (FSelM010_Funzioni.FieldByName('MAXMESIRIMB').medpOldValue <> FSelM010_Funzioni.FieldByName('MAXMESIRIMB').Value)
  ) then
  begin
