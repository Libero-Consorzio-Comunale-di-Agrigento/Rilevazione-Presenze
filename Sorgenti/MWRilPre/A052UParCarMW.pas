...
type
  ...
  private
    ...
    FTagComponent:Integer;
    FFieldCausali:String;
    function CaricaImpostazioni: TStringList;
    procedure RemoveSezione(sezione: String);
    procedure SetTagComponent(Value:Integer);
  public
    ...
    property TagComponent:Integer read FTagComponent write SetTagComponent;
    property FieldCausali:String read FFieldCausali;
  end;
...
begin
  Result:=Tag in [C_CAU1..C_CAU2,C_CAU3..C_CAU6];
end;
...
procedure TA052FParCarMW.SetTagComponent(Value:Integer);
begin
  FTagComponent:=Value;
  case FTagComponent of
    C_CAU1..C_CAU2:FFieldCausali:='CAUPRES';
    C_CAU3..C_CAU4:FFieldCausali:='CAUPRES2';
    C_CAU5..C_CAU6:FFieldCausali:='CAUPRES3';
  else
    FFieldCausali:='CAUPRES_ESCLUSE';
  end;
end;
