  ...
  private
     ...
     const
       D_DatiStoricizzatiT230: array[0..40] of TA016DescrizioneElementoStorico = (
         ...
         (Nome:'GIUST_DAA_RECUP_FLEX';       Descrizione:'Il giustificativo dalle..alle è recuperabile in uscita'),
         (Nome:'ABBATTE_STRIND';             Descrizione:'Abbatte la maturazione di straordinario e indennità'),
         (Nome:'INDPRES';                    Descrizione:'Matura indennità di presenza'),
         (Nome:'INDPRES_FESTIVO';            Descrizione:'Matura indennità di presenza su gg festivo'),
         (Nome:'INDTURNO';                   Descrizione:'Matura indennità di turno'),
