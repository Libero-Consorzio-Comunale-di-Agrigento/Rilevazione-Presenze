  ...
  object QMesePrecedente: TOracleDataSet
    SQL.Strings = (
      ...
      'WHERE  PROGRESSIVO = :PROGRESSIVO '
        ...
        'AND    TO_DATE('#39'01'#39'||LPAD(MESE,2,'#39'0'#39')||LPAD(ANNO,4,'#39'0'#39'),'#39'DDMMYYY' +
        'Y'#39') = '
      
        '         (SELECT MAX(TO_DATE('#39'01'#39'||LPAD(MESE,2,'#39'0'#39')||LPAD(ANNO,4' +
        ','#39'0'#39'),'#39'DDMMYYYY'#39')) '
      '          FROM   T340_TURNIREPERIB '
      '          WHERE  PROGRESSIVO = :PROGRESSIVO '
      
        '          AND    TO_DATE('#39'01'#39'||LPAD(MESE,2,'#39'0'#39')||LPAD(ANNO,4,'#39'0'#39 +
        '),'#39'DDMMYYYY'#39') <= :DATA)')
    Optimize = False
    Variables.Data = {
