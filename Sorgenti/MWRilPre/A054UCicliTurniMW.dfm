inherited A054FCicliTurniMW: TA054FCicliTurniMW
  ...
  object Q020: TOracleDataSet
    SQL.Strings = (
      'SELECT CODICE,MAX(DESCRIZIONE) DESCRIZIONE '
      'FROM T020_ORARI '
      'GROUP BY CODICE'
      'ORDER BY CODICE')
    Optimize = False
  ...
  object updT611Up: TOracleQuery
    SQL.Strings = (
      'update T611_CICLIGIORNALIERI T611'
      '   set T611.GIORNO = T611.GIORNO + 1'
      ' where T611.CICLO = :CICLO'
      '   and T611.GIORNO >= :GIORNO')
    Optimize = False
    Variables.Data = {
      04000000020000000C0000003A004300490043004C004F000500000000000000
      000000000E0000003A00470049004F0052004E004F0003000000000000000000
      0000}
    Left = 24
    Top = 64
  end
