...
type
  ...
  private
    ...
    FCausaliLivello2,
    FCausaliLivello3,
    FConsideraRichiesteIter:Boolean;
  ...
  public
    ...
    property ConsideraRichiesteIter: Boolean read FConsideraRichiesteIter write FConsideraRichiesteIter;
...
begin
  ...
  {$IFDEF IRISWEB}
  QRLista.DefaultEncoding:=TEncoding.UTF8.Create;
  {$ENDIF}
...
begin
  ...
  begin
    ...
    with R502ProDtm1 do
    begin
      ConsideraRichiesteWeb:=Self.ConsideraRichiesteIter;
      with SelAnagrafe do
      ...
      if (Blocca <> 0) and (FAnomalieLivello1) then
        ...
        begin
          ...
          if AggiornaT101 then
            SalvaAnomalia(SelAnagrafe.FieldByName('Progressivo').AsInteger,Corrente,1,DescAnomaliaBloccante);
        end;
      ...
      begin
          ...
          begin
            ...
            begin
              ...
              *)
              QRLista.Add(Spazio + tanom2riscontrate[i].ta2testo);
              A2:=True;
              if AggiornaT101 then
                //SalvaAnomalia(SelAnagrafe.FieldByName('Progressivo').AsInteger,Corrente,2,S + tdescanom2[tanom2riscontrate[i].ta2puntdesc].D);
                SalvaAnomalia(SelAnagrafe.FieldByName('Progressivo').AsInteger,Corrente,2,tanom2riscontrate[i].ta2testo);
            end;
          end;
      end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            QRLista.Add(Spazio + tanom3riscontrate[i].ta3testo);
            ...
            begin
              Lista.Clear;
              Lista.Text:=tanom3riscontrate[i].ta3testo;//tanom3riscontrate[i].ta3desc;
            ...
            *)
            ...
            begin
              ...
              *)
              ...
              SalvaAnomalia(SelAnagrafe.FieldByName('Progressivo').AsInteger,Corrente,3,tanom3riscontrate[i].ta3testo);
            end;
          end;
        end;
      end;
...
procedure TA033FStampaAnomalieMW.SalvaAnomalia(Prog : Integer;Data:TDateTime;Livello : Integer;Anomalia : String);
begin
...
begin
  ...
  TStampa.FieldByName('Anomalia').AsString:=Trim(TStampa.FieldByName('Anomalia').AsString.Replace('﻿','',[rfReplaceAll]));
  TStampa.Post;
  SS.Free;
end;
