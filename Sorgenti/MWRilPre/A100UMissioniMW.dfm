inherited A100FMissioniMW: TA100FMissioniMW
  ...
  object Q050: TOracleDataSet
    SQL.Strings = (
      'SELECT M050.ROWID, M050.*,'
        ...
        '       M051F_GETMINVALORE(M050.PROGRESSIVO, M050.MESESCARICO, M0' +
        '50.MESECOMPETENZA, M050.DATADA, M050.ORADA,'#39'NOTE'#39') NOTE,'
      
        '       M051F_GETMINVALORE(M050.PROGRESSIVO, M050.MESESCARICO, M0' +
        '50.MESECOMPETENZA, M050.DATADA, M050.ORADA,'#39'STATO'#39') STATO'
  ...
  object USR_M043P_CARICA_GIUST: TOracleQuery
    SQL.Strings = (
      'declare'
      '  wCODE varchar2(500);'
      ...
      '  where  upper(object_name) = '#39'USR_M043P_CARICA_GIUST'#39';'
      
        '  -- se la procedure esiste, la esegue ignorando eventuali eccez' +
        'ioni sollevate'
      '  if :CONTA_PROC > 0 and :AGGIORNA = '#39'S'#39' then'
      '    begin'
      '      wCODE:='#39'BEGIN USR_M043P_CARICA_GIUST(:ID); END;'#39';'
      '      execute immediate wCODE using in out :ID;'
      '    exception'
      '      when others then'
      '        :AGGIORNA:='#39'E'#39';'
      '    end;'
      '    select max(m040.progressivo) into wProgGiustBloc'
      
        '      from t180_datibloccati t180, m040_missioni m040 where t180' +
        '.riepilogo = '#39'T040'#39' and m040.datada between t180.dal and last_da' +
        'y(t180.al)'
      
        '      and m040.id_missione = :ID and m040.progressivo = t180.pro' +
        'gressivo;'
  ...
  object updM140Annullamento: TOracleQuery
    SQL.Strings = (
      'update M140_RICHIESTE_MISSIONI'
      'set    ANNULLAMENTO = :ANNULLAMENTO'
      'where  ID = :ID')
    ReadBuffer = 2
    Optimize = False
    Variables.Data = {
  ...
  object selT850CodIter: TOracleQuery
    SQL.Strings = (
      'select COD_ITER'
