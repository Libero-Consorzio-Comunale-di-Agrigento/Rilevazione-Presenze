inherited A094FSkLimitiStraordMW: TA094FSkLimitiStraordMW
  ...
  object selT825: TOracleDataSet
    ...
    AfterPost = selT825RegistraLog
    BeforeDelete = selT825BeforeDelete
    AfterDelete = selT825RegistraLog
  ...
  object selT830: TOracleDataSet
    SQL.Strings = (
      'SELECT T830.*,T830.ROWID FROM T830_VARIAZ_STRAORD_PT_IND T830'
      'WHERE PROGRESSIVO = :PROGRESSIVO'
      ':ORDERBY')
    Optimize = False
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      490051005500490044004100420049004C004500010000000000160000005200
      450053004900440055004100420049004C004500010000000000}
    BeforeEdit = selT830BeforeEdit
    BeforePost = selT830BeforePost
    AfterPost = selT830RegistraLog
    BeforeDelete = selT830BeforeDelete
    AfterDelete = selT830RegistraLog
    OnCalcFields = selT830CalcFields
    OnNewRecord = selT830NewRecord
    Left = 432
    Top = 56
    object selT830PROGRESSIVO: TIntegerField
      FieldName = 'PROGRESSIVO'
      Visible = False
    end
    object selT830DATA: TDateTimeField
      DisplayLabel = 'Data'
      DisplayWidth = 10
      FieldName = 'DATA'
    ...
    object selT830ORE_SUPPL_ANNO: TStringField
      DisplayLabel = 'Ore supplementari disponibili'
      FieldKind = fkCalculated
      FieldName = 'ORE_SUPPL_ANNO'
      ReadOnly = True
      EditMask = '!990:00;1;_'
      Size = 6
      Calculated = True
    end
    object selT830ORE_STRAORD_ANNO: TStringField
      DisplayLabel = 'Ore straordinario disponibili'
      FieldKind = fkCalculated
      FieldName = 'ORE_STRAORD_ANNO'
      ReadOnly = True
      EditMask = '!990:00;1;_'
      Size = 6
      Calculated = True
    end
    object selT830VARIAZ_ORE_SUPPL: TStringField
      DisplayLabel = 'Ore supplementari'
      FieldName = 'VARIAZ_ORE_SUPPL'
      EditMask = '!990:00;1;_'
      Size = 6
    end
    object selT830VARIAZ_ORE_STRAORD: TStringField
      DisplayLabel = 'Ore straordinario'
      FieldName = 'VARIAZ_ORE_STRAORD'
      EditMask = '!990:00;1;_'
      Size = 6
    end
    object selT830NOTE: TStringField
      DisplayLabel = 'Note'
      DisplayWidth = 25
      FieldName = 'NOTE'
      Size = 2000
  ...
  object selT203: TOracleDataSet
    SQL.Strings = (
      'select COUNT(*) CONTA from T203_ORESUPPLEMENTARI_PT '
      '')
    Optimize = False
    Left = 384
    Top = 56
  end
  object GET_LIMITI_TEORICI_PT: TOracleQuery
    SQL.Strings = (
      'begin'
      
        '  PCK_GESTIONE_ECCEDENZE.GET_LIMITI_TEORICI_PT(:PROGRESSIVO, :DA' +
        'TA, :PERCPT, :MAXSUPPLANNO_PT, :MAXSTRANNO_PT);'
      'end;')
    Optimize = False
    Variables.Data = {
      ...
      
      5000540003000000040000000000000000000000}
    Left = 520
    Top = 56
  end
end
