...
type
  ...
  public
    ...
    procedure SettaGiornoProgressivo(Inizio:integer);
  end;
...
begin
  ...
  {Se inserisco un nuovo record giorno(n) sommo uno a tutti i record >= a giorno(n)}
  if Q611.State in [dsInsert] then
  begin
    updT611Up.SetVariable('CICLO',Q611.FieldByName('CICLO').AsString);
    updT611Up.SetVariable('GIORNO',Q611.FieldByName('GIORNO').AsInteger);
    updT611Up.Execute;
  end;
end;
...
procedure TA054FCicliTurniMW.SettaGiornoProgressivo(Inizio:integer);
...
begin
  ...
  try
    ...
    Q611.First;
    i:=Inizio;
    while not Q611.Eof do
    begin
      inc(i);
      Q611.Edit;
      Q611.FieldByName('Giorno').AsInteger:=i;
      Q611.Post;
      Q611.Next;
    end;
    Q611.First;
