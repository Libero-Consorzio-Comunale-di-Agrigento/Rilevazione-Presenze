inherited A055FTurnazioniMW: TA055FTurnazioniMW
  ...
  object updT641Up: TOracleQuery
    SQL.Strings = (
      'update T641_MOLTTURNAZIONE T641'
      '   set T641.ORDINE = T641.ORDINE + 1'
      ' where T641.TURNAZIONE = :TURNAZIONE'
      '   and T641.ORDINE >= :ORDINE')
    Optimize = False
    Variables.Data = {
      0400000002000000160000003A005400550052004E0041005A0049004F004E00
      45000500000000000000000000000E0000003A004F005200440049004E004500
