inherited A006FModelliOrarioMW: TA006FModelliOrarioMW
  ...
  object selT021STR: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT CODICE,DECORRENZA,TIPO_FASCIA,ENTRATA,USCITA,ROWID FROM T' +
        '021_FASCEORARI T '
      
        'WHERE CODICE = :CODICE AND DECORRENZA = :DECORRENZA AND TIPO_FAS' +
        'CIA IN ('#39'STR'#39','#39'FO'#39')'
  ...
  object selT021PN: TOracleDataSet
    SQL.Strings = (
      ...
      '           and T021.TIPO_FASCIA in ('#39'PN'#39')'
        ...
        '         order by nvl(T021.ID_TURNO,oreminuti(T021.ENTRATA)), T0' +
        '21.USCITA) T')
    ReadBuffer = 10
    Optimize = False
    Variables.Data = {
    ...
    object selT021PNID_TURNO: TIntegerField
      DisplayLabel = 'Num.'
      DisplayWidth = 2
      FieldName = 'ID_TURNO'
    end
    ...
    object selT021PNVALENZA_GGASS: TFloatField
      DisplayLabel = 'Valenza gg ass.'
      FieldName = 'VALENZA_GGASS'
      DisplayFormat = '0.#####'
      EditFormat = '0.#####'
      MaxValue = 9.999990000000000000
    ...
    object selT021PNINDTURNO: TStringField
      DisplayLabel = 'Ind. notturna/turno'
      FieldName = 'INDTURNO'
      Size = 1
    end
    object selT021PNINDFESTIVA: TStringField
  ...
  object selaT020: TOracleDataSet
    SQL.Strings = (
      ...
      'WHERE  DECORRENZA = (SELECT MAX(T020B.DECORRENZA)'
