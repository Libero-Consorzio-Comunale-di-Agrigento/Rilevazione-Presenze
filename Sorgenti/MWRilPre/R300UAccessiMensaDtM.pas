...
var Ora,Prec,NT:Integer;
    ...
    Anom,BPAnom:String; //Perugia_Regione
...
begin
  ...
  begin
    ...
    begin
      ...
      BPAnom:=R350DtM.CalcolaBuoni(Progressivo,Data,Buoni,Ticket,Anom);
...
begin
  FreeAndNil(LFiltroRilevatori);//.Free;
  FreeAndNil(Anomalie);//.Free;
