inherited A121FRecapitiSindacaliMW: TA121FRecapitiSindacaliMW
  ...
  object selT200: TOracleDataSet
    SQL.Strings = (
      'select T.ORDINE, T.CODICE, T.DESCRIZIONE, T.TIPO'
      
        '  from (select 0 ordine, '#39'*'#39' codice,'#39'generico'#39' descrizione,'#39'C'#39' t' +
        'ipo '
      '          from dual'
      '         union all'
      '        select 1 ordine,codice,descrizione,tipo '
      '          from T200_contratti) T'
      ':FILTRO '
  ...
  object selT245: TOracleDataSet
    ...
    OnCalcFields = selT245CalcFields
    Left = 288
    Top = 8
    ...
    object selT245FRUIZIONE_PERMESSI: TStringField
      DisplayLabel = 'Fruiz. perm.'
      FieldName = 'FRUIZIONE_PERMESSI'
      Required = True
      Size = 1
    end
    object selT245D_FRUIZIONE_PERMESSI: TStringField
      DisplayLabel = 'Fruizione permessi'
      FieldKind = fkCalculated
      FieldName = 'D_FRUIZIONE_PERMESSI'
      Size = 2
      Calculated = True
    end
    object selT245PARTECIPAZIONE_RICHIESTA: TStringField
      DisplayLabel = 'Rich. part.'
      FieldName = 'PARTECIPAZIONE_RICHIESTA'
      Required = True
      Size = 1
    end
    object selT245D_PARTECIPAZIONE_RICHIESTA: TStringField
      DisplayLabel = 'Richiede partecipazione'
      FieldKind = fkCalculated
      FieldName = 'D_PARTECIPAZIONE_RICHIESTA'
      Size = 2
      Calculated = True
    end
    object selT245RETRIBUITO: TStringField
      DisplayLabel = 'Retrib.'
      FieldName = 'RETRIBUITO'
      Required = True
      Size = 1
    end
    object selT245D_RETRIBUITO: TStringField
      DisplayLabel = 'Retribuito'
      FieldKind = fkCalculated
      FieldName = 'D_RETRIBUITO'
      Size = 2
      Calculated = True
    end
    object selT245STATUTARIO: TStringField
      DisplayLabel = 'Statut.'
      FieldName = 'STATUTARIO'
      Required = True
      Size = 1
    end
    object selT245D_STATUTARIO: TStringField
      DisplayLabel = 'Statutario'
      FieldKind = fkCalculated
      FieldName = 'D_STATUTARIO'
      Size = 2
      Calculated = True
    end
    object selT245ABBATTE_COMPETENZE_ORG: TStringField
      DisplayLabel = 'Abbat.'
      FieldKind = fkCalculated
    ...
    object selT245D_ABBATTE_COMPETENZE_ORG: TStringField
    ...
    object selT245CAUSALE: TStringField
      DisplayLabel = 'Causale'
      DisplayWidth = 7
      FieldName = 'CAUSALE'
      Size = 5
    end
    object selT245D_CAUSALE: TStringField
    ...
    object selT245SIGLA_GEDAP: TStringField
      DisplayLabel = 'GEDAP'
      DisplayWidth = 5
      FieldKind = fkCalculated
  ...
  object selT242: TOracleDataSet
    SQL.Strings = (
      ...
      '     from t248_permessisindacali T248, t430_storico t430, '
        ...
        '         (select codice, decode(fruizione_permessi,'#39'S'#39',decode(re' +
        'tribuito,'#39'S'#39',decode(statutario,'#39'N'#39','#39'S'#39','#39'N'#39'),'#39'N'#39'),'#39'N'#39') abbatte_co' +
        'mpetenze_org'
      '          from t245_organismisindacali) t245'
      '    where t248.progressivo = t430.progressivo'
        ...
        'e'
      '      and t245.codice = t248.cod_organismo'
      '      and t245.abbatte_competenze_org = '#39'S'#39
      ...
      '  and T248.cod_sindacato (+)= T242.CODICE '
        ...
        '  and decode(t242.area_sindacale,'#39'*'#39','#39'*'#39',t248.contratto(+)) = t2' +
        '42.area_sindacale'
    ...
    CachedUpdates = True
    BeforeInsert = selT242BeforeInsert
