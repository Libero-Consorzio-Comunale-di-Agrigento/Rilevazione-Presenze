inherited A029FSchedaRiepilMW: TA029FSchedaRiepilMW
  ...
  object selT071: TOracleDataSet
    ...
    BeforeEdit = selT071BeforeEdit
    BeforePost = selT071BeforePost
  ...
  object selT074: TOracleDataSet
    ...
    AfterOpen = selT074AfterOpen
    BeforeInsert = selT074BeforeInsert
    BeforeEdit = selT074BeforeEdit
    BeforePost = selT074BeforePost
    AfterPost = selT074AfterPost
    BeforeDelete = selT074BeforeDelete
    AfterScroll = selT074AfterScroll
    OnCalcFields = selT074CalcFields
    OnNewRecord = selT074NewRecord
    Left = 314
    Top = 8
  end
  ...
  object selT073Comp: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT PROGRESSIVO,DATA,CAUSALE,COMPENSABILE,GETTONE_RESIDUO,ROW' +
        'ID'
    ...
    OnApplyRecord = selT073CompApplyRecord
    CachedUpdates = True
    AfterPost = selT073CompAfterPost
    Left = 76
    Top = 104
    object selT073CompPROGRESSIVO: TFloatField
      FieldName = 'PROGRESSIVO'
    end
    object selT073CompDATA: TDateTimeField
      FieldName = 'DATA'
    end
  ...
  object selT074Liq: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000000000000000}
    ReadOnly = True
    OnApplyRecord = selT074LiqApplyRecord
    CachedUpdates = True
    BeforeInsert = selT074LiqBeforeInsert
    BeforeEdit = selT074LiqBeforeEdit
    AfterPost = selT074LiqAfterPost
    BeforeDelete = selT074LiqBeforeDelete
    Left = 12
    Top = 104
    object selT074LiqPROGRESSIVO: TFloatField
      FieldName = 'PROGRESSIVO'
      Visible = False
    end
    object selT074LiqDATA: TDateTimeField
      FieldName = 'DATA'
      Visible = False
    end
  ...
  object InsT073: TOracleQuery
    SQL.Strings = (
      ...
      '  (PROGRESSIVO,DATA,CAUSALE, COMPENSABILE, TIPO_RECORD)'
      'values'
      '  (:PROGRESSIVO, :DATA, :CAUSALE, '#39'00.00'#39', :TIPO_RECORD)')
    Optimize = False
    Variables.Data = {
      
      4F0052004400050000000000000000000000}
    Left = 182
    Top = 8
  end
  object UpdT073: TOracleQuery
    ...
    Optimize = False
    Variables.Data = {
      0400000005000000100000003A00430041005500530041004C00450005000000
      ...
      41004C004500050000000000000000000000180000003A005400490050004F00
      5F005200450043004F0052004400050000000000000000000000}
    Left = 227
    Top = 8
  end
  ...
  object selT072: TOracleDataSet
    ...
    ReadOnly = True
    OnApplyRecord = selT072ApplyRecord
    BeforeInsert = selT072BeforeInsert
  ...
  object selT075: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000000000000000}
    CachedUpdates = True
    BeforeInsert = selT075BeforeInsert
    BeforeEdit = selT075BeforeEdit
    BeforePost = selT075BeforePost
    AfterPost = selT075AfterPost
    AfterCancel = selT075AfterCancel
    BeforeDelete = selT075BeforeDelete
  ...
  object selT076: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000000000000000}
    ReadOnly = True
    BeforeInsert = selT076BeforeInsert
    BeforeEdit = selT076BeforeEdit
    BeforePost = selT076BeforePost
    BeforeDelete = selT076BeforeDelete
  ...
  object selT077: TOracleDataSet
    ...
    Variables.Data = {
      ...
      00000000000000000000}
    ReadOnly = True
    OnApplyRecord = selT077ApplyRecord
    CachedUpdates = True
    BeforeInsert = selT077BeforeInsert
    BeforeEdit = selT077BeforeEdit
    BeforePost = selT077BeforePost
    ...
    object selT077TIPO: TStringField
      FieldName = 'TIPO'
      ReadOnly = True
      Visible = False
      Size = 1
    ...
    object selT077VALORE_AUT: TStringField
      ...
      ReadOnly = True
      OnGetText = selT077VALORE_AUTGetText
      Size = 50
    end
    object selT077VALORE_MAN: TStringField
      ...
      OnGetText = selT077VALORE_AUTGetText
      OnSetText = selT077VALORE_MANSetText
      Size = 50
    end
  end
  ...
  object selEsisteT070: TOracleQuery
    SQL.Strings = (
      'select count(*)'
      'from   T070_SCHEDARIEPIL '
      'where  ROWID = :PAR_ROW_ID')
    ReadBuffer = 2
    Optimize = False
    Variables.Data = {
      0400000001000000160000003A005000410052005F0052004F0057005F004900
