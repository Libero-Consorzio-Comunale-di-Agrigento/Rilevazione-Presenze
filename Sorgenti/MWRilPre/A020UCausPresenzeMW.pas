...
begin
  if (not R180In(selT275.FieldByName('TipoConteggio').AsString,['D'])) then
    selT275.FieldByName('FORZA_CAUSECCEDENZA').AsString:='N';
...
begin
  //Controllo voci paghe
  // Gallizio 30/08/2018: (*) = aggiunto per gestire medpOldValue
  VoceOld:='';  // (*)
