...
var i,j,k,h:Byte;
begin
  if (Self.Owner <> nil) and (Pos('WA055',Self.Owner.Name) = 1) then
    if Q641.State in [dsInsert] then
    begin
      updT641Up.SetVariable('TURNAZIONE',Q641.FieldByName('TURNAZIONE').AsString);
      updT641Up.SetVariable('ORDINE',Q641.FieldByName('ORDINE').AsInteger);
      updT641Up.Execute;
    end;
