...
type
  ...
  public
    ...
    // AOSTA_REGIONE - commessa 2013/118 SVILUPPO#6 - riesame del 15.01.2014.fine
    function VariazioneDataI(pDataI: TDateTime):Boolean;
    function VariazioneDataF(pDataF: TDateTime):Boolean;
  end;
...
begin
  //PALERMO_POLICLINICO-159914 - Modificata la funzione in modo che restituisca la lista corretta anche se le date non sono cambiate
...
function TA060FTimbIrregolariMW.VariazioneDataF(pDataF: TDateTime): Boolean;
begin
 Result:= (pDataF <> selI101.GetVariable('Data2')) or
          (pDataF <> selI101Chiave.GetVariable('Data2')) or
          (pDataF <> selI101Scarico.GetVariable('Data2'));
end;

function TA060FTimbIrregolariMW.VariazioneDataI(pDataI: TDateTime):Boolean;
begin
 Result:= (pDataI <> selI101.GetVariable('Data1')) or
          (pDataI <> selI101Chiave.GetVariable('Data1')) or
          (pDataI <> selI101Scarico.GetVariable('Data1'));
end;
