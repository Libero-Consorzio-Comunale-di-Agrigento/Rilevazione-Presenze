inherited A162FIncentiviAssenzeMW: TA162FIncentiviAssenzeMW
  ...
  object selT765: TOracleDataSet
    SQL.Strings = (
      'SELECT '#39'*'#39' CODICE, '#39'Tutte le quote'#39' DESCRIZIONE'
      'FROM DUAL'
      'UNION'
      'SELECT CODICE, DESCRIZIONE'
      'FROM T765_TIPOQUOTE T765A'
      
        'WHERE DECORRENZA = (SELECT MAX(DECORRENZA) FROM T765_TIPOQUOTE T' +
        '765B WHERE T765A.CODICE = T765B.CODICE AND DECORRENZA <= :DECORR' +
        'ENZA_FINE)'
      'ORDER BY CODICE')
    Optimize = False
    Variables.Data = {
  ...
  object selT769Quote: TOracleDataSet
    SQL.Strings = (
      'SELECT COUNT(DISTINCT(CODTIPOQUOTA)) N_QUOTE'
      'FROM T769_INCENTIVIASSENZE'
      'WHERE CODTIPOQUOTA :OPERATORE '#39'*'#39
      '  AND DATO1 = :DATO1'
      '  AND DATO2 = :DATO2'
      '  AND DATO3 = :DATO3')
    Optimize = False
    Variables.Data = {
      }
    Left = 512
    Top = 72
  end
  object updT769: TOracleQuery
    SQL.Strings = (
      'UPDATE T769_INCENTIVIASSENZE'
      'SET CODTIPOQUOTA = :CODTIPOQUOTA'
      'WHERE CODTIPOQUOTA = '#39'*'#39
      '  AND DATO1 = :DATO1'
      '  AND DATO2 = :DATO2'
      '  AND DATO3 = :DATO3')
    Optimize = False
    Variables.Data = {
      04000000040000001A0000003A0043004F0044005400490050004F0051005500
