inherited A026FDatiLiberiMW: TA026FDatiLiberiMW
  ...
  object scrGetDataDefault: TOracleQuery
    SQL.Strings = (
      'declare'
      '  data_default_str varchar2(2000);'
      'begin'
      '  :RESULT:='#39#39';'
      '  data_default_str:='#39#39';'
      ''
      '  select vc.data_default into data_default_str'
      '    from cols vc'
      '   where vc.table_name = '#39'T430_STORICO'#39
      '     and vc.column_name = :COLUMN_NAME;'
      ''
      '  /*'
      '  data_default_str:=replace(data_default_str,chr(13),'#39#39');'
      '  data_default_str:=replace(data_default_str,chr(10),'#39#39');  '
      '  data_default_str:=trim(data_default_str);'
      ''
      '  if data_default_str = '#39'NULL'#39' then'
      '    :RESULT:='#39#39';'
      '  else'
      '    :RESULT:=data_default_str;'
      '  end if;'
      '  */'
      '  :RESULT:=data_default_str;'
      'end;')
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A0043004F004C0055004D004E005F004E004100
      4D0045000500000000000000000000000E0000003A0052004500530055004C00
      5400050000000000000000000000}
    Left = 48
    Top = 184
  end
  object selColsNULLABLE: TOracleQuery
    SQL.Strings = (
      'select vc.nullable'
      '  from cols vc'
      ' where vc.table_name = '#39'T430_STORICO'#39
    ...
    Variables.Data = {
      0400000001000000180000003A0043004F004C0055004D004E005F004E004100
      4D004500050000000000000000000000}
    Left = 144
    Top = 184
  end
  object insI501ValDefault: TOracleQuery
    SQL.Strings = (
      'insert into I501:DATO (CODICE,DESCRIZIONE)'
      'select :VALORE, :VALOREDESC '
      '  from dual '
      ' where not exists (select '#39'x'#39' '
      '                     from I501:DATO'
      '                    where CODICE = :VALORE)')
    Optimize = False
    Variables.Data = {
      04000000030000000A0000003A004400410054004F0001000000000000000000
      00000E0000003A00560041004C004F0052004500010000000000000000000000
      160000003A00560041004C004F00520045004400450053004300050000000000
      000000000000}
    Left = 344
    Top = 188
  end
  object insI501StoricoValDefault: TOracleQuery
    SQL.Strings = (
      
        'insert into I501:DATO (CODICE,DESCRIZIONE,DECORRENZA,DECORRENZA_' +
        'FINE)'
      
        'select :VALORE,:VALOREDESC,to_date('#39'01011900'#39','#39'ddmmyyyy'#39'),to_dat' +
