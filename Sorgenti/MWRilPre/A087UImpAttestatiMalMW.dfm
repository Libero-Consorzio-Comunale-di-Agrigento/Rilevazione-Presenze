inherited A087FImpAttestatiMalMW: TA087FImpAttestatiMalMW
  ...
  object InsT048: TOracleQuery
    SQL.Strings = (
      'begin'
      '  delete from T048_ATTESTATIINPS T048'
      '  where T048.ID_CERTIFICATO = :ID_CERTIFICATO'
      '  and T048.TIPO_ELEMENTO = :TIPO_ELEMENTO'
      '  and T048.ELABORATO = '#39'N'#39';'
      '   '
      ''
      
        '  insert into T048_ATTESTATIINPS (PROGRESSIVO, DATA_REGISTRAZION' +
        'E, OPERATORE, CAUSALE_MAL, TIPO_ELEMENTO, '
        ...
        'IPO_REGISTRAZIONE, '
      '             :ID_FILETXT, :NUM_PROTOCOLLO, :NOTE, :ID_FILEXML);'
      'end;')
    Optimize = False
    Variables.Data = {
      0400000037000000180000003A00500052004F00470052004500530053004900
      ...
      00000000000000000000160000003A00490044005F00460049004C0045005800
      4D004C00030000000000000000000000}
    Left = 203
    Top = 14
  end
  ...
  object selT269: TOracleDataSet
    ...
    object selT269CAUS_INVALIDITA: TStringField
    ...
    object selT269FLAG_IGNORA_NUOVO_PERIODO: TStringField
  ...
  object GetPostRicovero: TOracleQuery
    SQL.Strings = (
      ...
      '    wDataIndietro:=wData;'
        ...
        '    GETINIZIOASSENZA_GGNONLAV(:INPROGR, wDataIndietro, wCausaleN' +
        'ew, :CAUSALI_RICOVERO);'
      '    while :OUTCAUSALE is null and wData >= wDataIndietro loop'
      '      begin'
      '        select T040.CAUSALE into :OUTCAUSALE'
    ...
    Optimize = False
    Variables.Data = {
      0400000004000000100000003A0049004E00500052004F004700520003000000
      ...
      050000000000000000000000220000003A00430041005500530041004C004900
      5F005200490043004F005600450052004F00050000000000000000000000}
    Left = 40
    Top = 176
  end
  ...
  object ScriptIDPrecedente: TOracleQuery
    SQL.Strings = (
      ...
      ''
        ...
        '  --Alberto 23/07/2019: verifica se non sono presenti altri gius' +
        'tifictivi / timbrature nei gg in cui viene anticipato l'#39'inserime' +
        'nto'
      '  begin'
      
        '    if (T048PROGRESSIVO is not null) and (:DATAOUT < T048DATA_IN' +
        'IZIO_MAL) then'
      
        '      select CODICE||'#39','#39'||CODCAU1||'#39','#39'||CODCAU2 into T265CAUSALI' +
        ' '
      '      from T265_CAUASSENZE where CODICE = T048CAUSALE_MAL;'
      '      '
      '      ANT_DATA_INIZIO_MAL:=T048DATA_INIZIO_MAL;'
      
        '      GETINIZIOASSENZA_GGNONLAV(T048PROGRESSIVO, ANT_DATA_INIZIO' +
        '_MAL, T048CAUSALE_MAL, T265CAUSALI);'
      '      if ANT_DATA_INIZIO_MAL > :DATAOUT then'
      '        :DATAOUT:=ANT_DATA_INIZIO_MAL;'
      '      end if;  '
      '    end if;'
      '  exception'
  ...
  object selT048Info: TOracleDataSet
    ...
    ReadOnly = True
    OnCalcFields = selT048InfoCalcFields
    Left = 352
    Top = 14
    ...
    object selT048InfoDATA_FINEPOSTRIC: TDateTimeField
      DisplayLabel = 'Fine post-ricovero'
