...
type
  ...
  TA047FTimbMensaMW = class(TR005FDataModuleMW)
    ...
    procedure Q370AfterDelete(DataSet: TDataSet);
    procedure selT375AfterDelete(DataSet: TDataSet);
    procedure selT375AfterPost(DataSet: TDataSet);
    procedure selT375BeforeDelete(DataSet: TDataSet);
    procedure selT375BeforePost(DataSet: TDataSet);
  private
...
procedure TA047FTimbMensaMW.selT375AfterDelete(DataSet: TDataSet);
begin
  inherited;
  RegistraLog.RegistraOperazione;
end;

procedure TA047FTimbMensaMW.selT375AfterPost(DataSet: TDataSet);
begin
  inherited;
  RegistraLog.RegistraOperazione;
end;

procedure TA047FTimbMensaMW.selT375BeforeDelete(DataSet: TDataSet);
begin
  inherited;
  RegistraLog.SettaProprieta('C',R180Query2NomeTabella(DataSet),nomeOwner,DataSet,True);
end;

procedure TA047FTimbMensaMW.selT375BeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TA047FTimbMensaMW.Q370AfterDelete(DataSet: TDataSet);
begin
  inherited;
  RegistraLog.RegistraOperazione;
end;
