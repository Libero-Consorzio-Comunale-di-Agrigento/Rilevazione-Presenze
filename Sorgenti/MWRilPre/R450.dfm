object R450DtM1: TR450DtM1
  ...
  object selT430: TOracleDataSet
    SQL.Strings = (
      'select distinct'
        ...
        '  trunc(T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,INIZIO,'#39'I'#39'),'#39'mm'#39') ' +
        'INIZIO,'
      '  T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,INIZIO,'#39'F'#39') FINE'
      'from '
      
        '(select distinct INIZIO from T430_STORICO where PROGRESSIVO = :P' +
        'ROGRESSIVO '
      'and last_day(:DATA) >= INIZIO'
      ')'
      
        'order by nvl(INIZIO,pck_const.DATA_NUL) desc, nvl(FINE,pck_const' +
        '.DATA_INF) desc'
      ''
      '/* modifica per <169205>:'
      'select '
      ...
      '  T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,INIZIO,'#39'F'#39') FINE'
        ...
        'from T430_STORICO where PROGRESSIVO = :PROGRESSIVO and trunc(:DA' +
        'TA,'#39'mm'#39') <= nvl(FINE,:DATA) and last_day(:DATA) >= INIZIO'
      'order by nvl(INIZIO,pck_const.DATA_NUL) desc'
      '*/'
      ''
      '/*'
  ...
  object selT275: TOracleDataSet
    SQL.Strings = (
        ...
        'TA_ABBATTIMENTO, LIQUIDAZIONE_MESIPREC'
  ...
  object scrStrAnnuo: TOracleQuery
    SQL.Strings = (
      'begin'
        ...
        '  PCK_GESTIONE_ECCEDENZE.GET_LIMITI_ANNUALI(:PROGRESSIVO,:DATA,:' +
        'PERC_PT,:MAXSTRANNOCAUS,:MAXSTRANNO,:MAXRESANNO,:MAXSTRANNO_TEOR' +
        'ICO,:MAXRESANNO_TEORICO,:MAXSUPPLANNO_PT,:MAXSTRANNO_PT);'
      'end;')
    Optimize = False
    Variables.Data = {
      ...
      
      005F00500054000400000008000000000000000000000000000000}
    Left = 163
    Top = 257
  end
  ...
  object selBuoniPastoTotali: TOracleQuery
    SQL.Strings = (
      ...
      '      select distinct '
        ...
        '        T430F_RAPPORTI_UNIFICATI(:PROGRESSIVO,wINIZIO,'#39'I'#39') INIZI' +
        'O'
      '      from dual  '
      '      )'
      '    WHERE INIZIO IS NOT NULL);'
