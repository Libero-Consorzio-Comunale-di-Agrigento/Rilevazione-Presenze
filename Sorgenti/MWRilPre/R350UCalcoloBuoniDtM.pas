...
var (*Campo,*)Da,A:String;
  ...
  begin
    ...
    begin
      if Q670.FieldByName('PASTO_TICKET').AsString = 'T' then
        ...
        Buoni:=1;
      //Alberto 17/12/2012: maturazione x TORINO_COMUNE solo se le ore di presenza raggungono la metà del debito
  ...
  begin
    ...
    try
      ...
      begin
        EsisteTurnoNotturno:=False;
        //Verifico se è stato lavorato un turno notturno
        ...
        *)
        ...
        begin
          ...
          begin
            //Se Turno notturno ma c'è un altra entrata in notte verifico la causale se è esclusa dai conteggi posso considerare il turno valido
...
begin
  try
    ...
    begin
      ...
      //Se il saldo totale è negativo, non si matura il buono
      ...
      begin
        ...
        //Se il saldo è negativo, verifico se l'ho reuperato il mese successivo (DataRecupero)
    ...
    begin
      ...
      selT682.Open;
      //Controllo: query su T682 dal lunedì della settimana corrente a Data - 1
...
begin
  ...
  //Alberto 13/09/2018 - ReggioEmilia_Comune: se orario spezzato si amplia la fascia di mensa col ritardo del pomeriggio (se in flessibilità).
...
begin
  ...
  //I buoni eventualmente maturati in più devono rispettare la regola dei rientir supplementari
