inherited A004FGiustifAssPresMW: TA004FGiustifAssPresMW
  ...
  object selT050: TOracleDataSet
    ...
    Optimize = False
    Variables.Data = {
      0400000009000000200000003A004300370030003000530045004C0041004E00
      ...
      00001E0000003A00460049004C00540052004F005F0043004100550053004100
      4C0045000100000000000000000000002E0000003A00460049004C0054005200
      4F005F0043004F004E00440049005A005F0041004C004C004500470041005400
    ...
    object selT050NOTE_RESP: TStringField
      DisplayWidth = 30
      FieldName = 'NOTE_RESP'
      Visible = False
      Size = 2000
    end
    object selT050NOTE_GIUSTIFICATIVO: TStringField
      FieldName = 'NOTE_GIUSTIFICATIVO'
      Visible = False
      Size = 10
    end
  ...
  object selT048: TOracleDataSet
    SQL.Strings = (
      'select'
      '  T048.DATA_INIZIO_MAL,'
      '  T048.DATA_FINE_MAL,'
      '  T048.COGNOME_REP,'
      '  nvl(T048.VIA_REP,T048.VIA_DOM) INDIRIZZO,'
      '  nvl(T048.CAP_REP,T048.CAP_DOM) CAP,'
      '  T480.CITTA,'
      '  nvl(T048.PROV_REP,T048.PROV_DOM) PROV,'
      '  nvl(T048.CODCATASTALE_REP,T048.CODCATASTALE_DOM) CODCATASTALE'
      'from T048_ATTESTATIINPS T048, T480_COMUNI T480'
      
        'where nvl(T048.CODCATASTALE_REP,T048.CODCATASTALE_DOM) = T480.CO' +
        'DCATASTALE(+)'
      'and T048.ID_CERTIFICATO in '
      
        '  (select ID_CERTIFICATO from T040_GIUSTIFICATIVI where PROGRESS' +
        'IVO = :PROGRESSIVO and DATA = :DATA)')
    ReadBuffer = 5
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A00500052004F00470052004500530053004900
    ...
    Left = 568
    Top = 107
    object selT048DATA_INIZIO_MAL: TDateTimeField
      DisplayLabel = 'Dal'
      DisplayWidth = 10
      FieldName = 'DATA_INIZIO_MAL'
    end
    object selT048DATA_FINE_MAL: TDateTimeField
      DisplayLabel = 'Al'
      DisplayWidth = 10
      FieldName = 'DATA_FINE_MAL'
    end
    object selT048COGNOME_REP: TStringField
      DisplayLabel = 'Nominativo'
      DisplayWidth = 15
      FieldName = 'COGNOME_REP'
      Size = 30
    end
    object selT048INDIRIZZO: TStringField
      DisplayLabel = 'Indirizzo'
      DisplayWidth = 20
      FieldName = 'INDIRIZZO'
      Size = 80
    end
    object selT048CAP: TStringField
      FieldName = 'CAP'
      Size = 5
    end
    object selT048CITTA: TStringField
      DisplayLabel = 'Citt'#224
      DisplayWidth = 18
      FieldName = 'CITTA'
      Size = 60
    end
    object selT048PROV: TStringField
      DisplayLabel = 'Prov'
      FieldName = 'PROV'
      Size = 2
    end
    object selT048CODCATASTALE: TStringField
