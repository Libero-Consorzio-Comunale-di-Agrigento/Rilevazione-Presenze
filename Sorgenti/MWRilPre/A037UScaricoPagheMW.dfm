inherited A037FScaricoPagheMW: TA037FScaricoPagheMW
  ...
  object selT710: TOracleDataSet
    SQL.Strings = (
      'select * from ('
        ...
        'select T710.ANNO,T710.CAPITOLO,T710.ARTICOLO,T710.COEL,T710.STAN' +
        'ZIAMENTO,T710.DISPONIBILITA + nvl(T710B.VARIAZIONE,0) DISPONIBIL' +
        'ITA, T710.UTILIZZO '
      
        'from T710_BUDGETESTERNO_ANNUO T710, T710_BUDGETESTERNO_ANNUO T71' +
        '0B'
      ...
      'and T710.COEL = T710B.COEL(+)'
        ...
        'and trunc(sysdate) between T710B.DECORRENZA_VARIAZIONE(+) and nv' +
        'l(T710B.SCADENZA_VARIAZIONE(+),to_date('#39'31123999'#39','#39'ddmmyyyy'#39')))'
  ...
  object selM050: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT M050.ID_MISSIONE,M050.MESESCARICO DATA,M050.CODICERIMBORS' +
        'OSPESE,M050.IMPORTORIMBORSOSPESE,M050.IMPORTOINDENNITASUPPLEMENT' +
        'ARE,'
      
        '       M020.CODICEVOCEPAGHE,M020.SCARICOPAGHE,M020.CODICEVOCEPAG' +
        'HEINDENNITASUPPL,M020.SCARICOPAGHEINDENNITASUPPL,M020.CATEG_RIMB' +
        'ORSO,'
  ...
  object selM052: TOracleDataSet
    SQL.Strings = (
        ...
        'SI,M021.CODVOCEPAGHE,M021.CATEG_RIMBORSO,'
      '       M052.ID_MISSIONE,M052.CODICEINDENNITAKM,'
  ...
  object Ins195: TOracleQuery
    SQL.Strings = (
      'INSERT INTO T195_VOCIVARIABILI'
        ...
        'IONE,COD_INTERNO,DATA_CASSA,CAPITOLO,ARTICOLO)'
      'VALUES'
      
        '  (:PROGRESSIVO,:DATARIF,:VOCEPAGHE,:VALORE,:IMPORTO,:UM,:DAL,:A' +
        'L,:OPERAZIONE,:COD_INTERNO,:DATA_CASSA,:CAPITOLO,:ARTICOLO)')
    Optimize = False
    Variables.Data = {
      ...
      00000000000000000000120000003A00430041005000490054004F004C004F00
      050000000000000000000000120000003A00410052005400490043004F004C00
  ...
  object selT195: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT DATARIF,DAL,VOCEPAGHE,VALORE,IMPORTO,UM,COD_INTERNO,CAPIT' +
        'OLO,ARTICOLO'
  ...
  object selUSR_GetRidEveMal1: TOracleDataSet
    SQL.Strings = (
        ...
        'select least(substr(usr_getridevemal(:progressivo,:data,'#39'GIORNAL' +
        'IERO'#39'),'
      
        '       instr(usr_getridevemal(:progressivo,:data,'#39'GIORNALIERO'#39'),' +
        #39'NUMEVRID='#39')+length('#39'NUMEVRID='#39'),'
      
        '       (instr(usr_getridevemal(:progressivo,:data,'#39'GIORNALIERO'#39')' +
        ','#39';'#39',instr(usr_getridevemal(:progressivo,:data,'#39'GIORNALIERO'#39'),'#39'N' +
        'UMEVRID='#39')+length('#39'NUMEVRID='#39'))) -'
      
        '       (instr(usr_getridevemal(:progressivo,:data,'#39'GIORNALIERO'#39')' +
        ','#39'NUMEVRID='#39')+length('#39'NUMEVRID='#39'))),5) NUMEVENTO_RID'
      'from dual'
      '')
    Optimize = False
    Variables.Data = {
  ...
  object selM050CapArt: TOracleDataSet
    SQL.Strings = (
      'select '
      
        '  M050.IMPORTORIMBORSOSPESE*(M031.PERCENTUALE/100) IMPORTORIMBOR' +
        'SOSPESE,'
      
        '  M050.IMPORTOINDENNITASUPPLEMENTARE *(M031.PERCENTUALE/100) IND' +
        'ENNITASUPPLEMENTARE,'
      '  M031.PERCENTUALE,'
      '  M031.CAPITOLO_BILANCIO CAPITOLO,M031.IMPEGNO ARTICOLO'
      'from '
      '  M140_RICHIESTE_MISSIONI M140, '
      '  M050_RIMBORSI M050, '
      '  M020_TIPIRIMBORSI M020, '
      '  M031_CAPITOLI_RIMBORSO M031 '
      'where M050.ID_MISSIONE = :ID_MISSIONE'
      'and M050.CODICERIMBORSOSPESE = :CODICE'
      'and M050.CODICERIMBORSOSPESE = M020.CODICE'
      'and M050.ID_MISSIONE = M140.ID'
      'and M020.CATEG_RIMBORSO = M031.CATEG_RIMBORSO'
      'and M140.CAPITOLO_TRASFERTA = M031.CAPITOLO_TRASFERTA'
      'and M140.DATAA between M031.DECORRENZA and M031.DECORRENZA_FINE')
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A00490044005F004D0049005300530049004F00
      4E0045000300000000000000000000000E0000003A0043004F00440049004300
      4500050000000000000000000000}
    Left = 571
    Top = 10
  end
  object selM052CapArt: TOracleDataSet
    SQL.Strings = (
      'select '
      '  M052.IMPORTOINDENNITA*(M031.PERCENTUALE/100) IMPORTOINDENNITA,'
      '  M052.KMPERCORSI*(M031.PERCENTUALE/100) KMPERCORSI,'
      '  M031.PERCENTUALE,'
      '  M031.CAPITOLO_BILANCIO CAPITOLO,M031.IMPEGNO ARTICOLO'
      'from '
      '  M140_RICHIESTE_MISSIONI M140, '
      '  M052_INDENNITAKM M052, '
      '  M021_TIPIINDENNITAKM M021, '
      '  M031_CAPITOLI_RIMBORSO M031 '
      'where M052.ID_MISSIONE = :ID_MISSIONE'
      'and M052.CODICEINDENNITAKM = :CODICE'
      'and M052.CODICEINDENNITAKM = M021.CODICE'
      'and M140.DATAA between M021.DECORRENZA and M021.DECORRENZA_FINE'
      'and M052.ID_MISSIONE = M140.ID'
      'and M021.CATEG_RIMBORSO = M031.CATEG_RIMBORSO'
      'and M140.CAPITOLO_TRASFERTA = M031.CAPITOLO_TRASFERTA'
      'and M140.DATAA between M031.DECORRENZA and M031.DECORRENZA_FINE')
    Optimize = False
    Variables.Data = {
  ...
  object selT077: TOracleDataSet
    SQL.Strings = (
        ...
        'select T077.DATA, T077.DATO, decode(I011.TIPO,'#39'O'#39','#39'H'#39',I011.TIPO)' +
        ' UMISURA, I011.VOCEPAGHE, nvl(T077.VALORE_MAN,T077.VALORE_AUT) V' +
        'ALORE'
      'from T077_DATISCHEDA T077, I011_DIZIONARIO_DATISCHEDA I011'
      'where T077.PROGRESSIVO = :PROGRESSIVO'
      'and T077.DATA between :DATA1 and :DATA2'
      'and T077.DATO = I011.DATO'
      'and T077.DATA between I011.DECORRENZA and I011.DECORRENZA_FINE'
      'and I011.TIPO in ('#39'N'#39','#39'O'#39')'
      'and I011.VOCEPAGHE is not null '
      'order by T077.DATA, I011.VOCEPAGHE, T077.DATO')
    Optimize = False
    Variables.Data = {
      0400000004000000180000003A00500052004F00470052004500530053004900
      56004F000300000000000000000000000C0000003A0044004100540041003100
