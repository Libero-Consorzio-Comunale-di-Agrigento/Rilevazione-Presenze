...
begin
  ...
  begin
    ...
    Execute;
    //Svuoto il codice beneficiario perché non deve essere duplicato e forzo DECORRENZA_FINE=31/12/3999
    SQL.Clear;
    SQL.Add('UPDATE  ' + NomeTabella);
    SQL.Add('SET COD_BENEFICIARIO = NULL, DECORRENZA_FINE=TO_DATE(''31123999'',''DDMMYYYY'') WHERE ID_VOCE = ' + sIdVoce);
    Execute;
