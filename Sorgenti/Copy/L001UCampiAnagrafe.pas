...
type
  TL001FCampiAnagrafe = class(TForm)
    ...
    procedure I010BeforePost(DataSet: TDataSet);
    procedure I010AfterScroll(DataSet: TDataSet);
  private
...
begin
  ...
  A188MW.selColsDefs.Session:=SessioneOracle;
  A188MW.I010:=I010;
end;
...
begin
  ...
  try
    ...
    I010.BeforePost:=I010BeforePost;
  end;
end;
...
procedure TL001FCampiAnagrafe.I010BeforePost(DataSet: TDataSet);
begin
...
begin
  ...
  begin
    RegistraLog.SettaProprieta('M','I010_CAMPIANAGRAFICI',Copy(Name,1,4),I010,True);
    RegistraLog.RegistraOperazione;
    RegistraLog.Session.Commit;
  end;
end;

procedure TL001FCampiAnagrafe.I010AfterScroll(DataSet: TDataSet);
begin
