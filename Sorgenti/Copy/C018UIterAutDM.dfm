inherited C018FIterAutDM: TC018FIterAutDM
  ...
  object delIterRichiesta: TOracleQuery
    SQL.Strings = (
      ...
      '                  where ID_T850 = :ID);'
      '  else'
      '    delete from :TABELLA where :COLONNA_ID = :ID;'
      '  end if;'
      ''
    ...
    Optimize = False
    Variables.Data = {
      04000000040000000A0000003A00490054004500520005000000000000000000
      0000060000003A0049004400030000000000000000000000100000003A005400
      4100420045004C004C004100010000000000000000000000160000003A004300
      4F004C004F004E004E0041005F0049004400010000000000000000000000}
    Left = 144
    Top = 64
  end
  ...
  object updT850TipoRichiesta: TOracleQuery
    SQL.Strings = (
      'begin'
      '  select min(TIPO_RICHIESTA) into :OLD_TIPO_RICHIESTA'
      '  from T850_ITER_RICHIESTE'
      '  where ITER = :ITER '
      '  and ID = :ID;'
      ''
    ...
    Variables.Data = {
      ...
      000000000000260000003A004F004C0044005F005400490050004F005F005200
  ...
  object selMailPerAutorizzatore: TOracleQuery
    SQL.Strings = (
      ...
      'and T850.ITER = :ITER'
      'and T850.ID = :ID'
      'and T_ITER.:COLONNA_ID = :ID'
      'and T850R.ITER(+) = :ITER'
      'and T850R.ID(+) = T850.ID_REVOCATO')
    ReadBuffer = 2
    Optimize = False
    Variables.Data = {
      0400000008000000100000003A004F00470047004500540054004F0001000000
      ...
      0000160000003A0043004F004C004F004E004E0041005F004900440001000000
      0000000000000000}
    Left = 48
    Top = 360
  end
  object selMailPerRichiedente: TOracleQuery
    ...
    Optimize = False
    Variables.Data = {
      0400000008000000100000003A0054004100420045004C004C00410001000000
      ...
      3A004C004900560045004C004C004F0005000000000000000000000016000000
      3A0043004F004C004F004E004E0041005F004900440001000000000000000000
      0000}
    Left = 48
    Top = 408
  end
  object selT851: TOracleDataSet
    SQL.Strings = (
      ...
      'where T850.ITER = :ITER'
      'and T850.ID = :ID'
      'and T_ITER.:COLONNA_ID = T850.ID'
      
        'and :PROGRESSIVO = T030.PROGRESSIVO(+) --T_ITER.PROGRESSIVO = T0' +
        '30.PROGRESSIVO(+)'
      'union all'
      'select '
      '  I096.LIVELLO,'
    ...
    Optimize = False
    Variables.Data = {
      
      13000000545F495445522E50524F475245535349564F0000000000}
  ...
  object delDBDato: TOracleQuery
    ...
    Optimize = False
    Variables.Data = {
      04000000040000001A0000003A0054004100420045004C004C0041005F004900
      ...
      0300000000000000000000000E0000003A00460049004C00540052004F000100
  ...
  object scrUSR_PCK_ITER_SPECIALISTI: TOracleQuery
    SQL.Strings = (
      'begin'
      '  USR_PCK_ITER_SPECIALISTI.T050P_ASSEGNA_RICHIESTE_NA;'
      '  USR_PCK_ITER_SPECIALISTI.T105P_ASSEGNA_RICHIESTE_NA;'
      'end;')
    Optimize = False
    Left = 772
    Top = 288
  ...
  object updT100Flag: TOracleQuery
    SQL.Strings = (
      'update T100_TIMBRATURE T'
      '   set T.FLAG = '#39'O'#39','
      '       T.ID_RICHIESTA = null'
      ' where T.ID_RICHIESTA = :ID'
      '   and T.FLAG in ('#39'C'#39','#39'M'#39')')
    Optimize = False
    Variables.Data = {0400000001000000060000003A0049004400030000000000000000000000}
    Left = 834
    Top = 352
