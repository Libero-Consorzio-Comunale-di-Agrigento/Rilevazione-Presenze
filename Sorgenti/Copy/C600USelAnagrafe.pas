...
uses
  ...
  A000UCostanti, A000UInterfaccia, C001URicerca, C004UParamForm, C005UDatiAnagrafici, C180FunzioniGenerali,
  C600USelezioneAnagrafe, C600USelezioneAnagrafeDtM, C700USelezioneAnagrafe,
  QueryStorico, System.UITypes;
...
type
  ...
  public
    ...
    OldC600SelAnagrafeBridge:TSelAnagrafeBridge;
    ...
    C600SelAnagrafeBridge:TSelAnagrafeBridge;
    ...
    procedure SalvaC600SelAnagrafe;
    procedure SalvaC600SelAnagrafeBridge;
    procedure RipristinaC600SelAnagrafe;
...
begin
  C600DataLavoro:=Parametri.DataLavoro;
  ...
  if R180In(C600SelAnagrafeBridge.SQLCreato.ToUpper,['','T030.PROGRESSIVO = 0']) then
    C600SelAnagrafeBridge:=C700SelAnagrafeBridge;
...
procedure TC600frmSelAnagrafe.SalvaC600SelAnagrafe;
begin
...
procedure TC600frmSelAnagrafe.RipristinaC600SelAnagrafe;
begin
...
begin
  ...
  try
    EsisteT030Full:=Pos('T030.*',UpperCase(C600FSelezioneAnagrafe.C600DatiSelezionati)) > 0;
    //lstS.CommaText:=StringReplace(UpperCase(C600FSelezioneAnagrafe.C600DatiSelezionati),'T030.','',[rfReplaceAll]);
    lstS.AddStrings(StringReplace(UpperCase(C600FSelezioneAnagrafe.C600DatiSelezionati),'T030.','',[rfReplaceAll]).Split([',']));
    //lstV.CommaText:=UpperCase(C600DatiVisualizzati);
    lstV.AddStrings(UpperCase(C600DatiVisualizzati).Split([',']));
