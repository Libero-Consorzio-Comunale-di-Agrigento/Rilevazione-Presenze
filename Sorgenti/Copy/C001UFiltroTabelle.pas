...
type
  TC001FFiltroTabelle = class(TForm)
    ...
    ppMnuGriglia: TPopupMenu;
    Chiudieposizionati1: TMenuItem;
    ...
    procedure Chiudieposizionati1Click(Sender: TObject);
...
var I:Integer;
begin
  if (not(StampaAnagrafico)) and (not(StampaAnagraficoMisto)) then
  begin
...
procedure TC001FFiltroTabelle.Chiudieposizionati1Click(Sender: TObject);
begin
  PosizionatiSuRecord:=True;
  Self.Close;
end;

procedure TC001FFiltroTabelle.CopiainExcel1Click(Sender: TObject);
begin
