...
begin
  ...
  try
    ...
    begin
      ...
      begin
        lst.Add('AND');
        lst.Add(TAG_FILTRO_ANAG_INIZIO);
        for i:=0 to Count - 1 do
          lst.Add(Strings[i]);
        lst.Add(TAG_FILTRO_ANAG_FINE);
      end
      else
      begin
        lst.Add(TAG_FILTRO_ANAG_INIZIO);
...
begin
  ...
  begin
    ...
    if C700FSelezioneAnagrafe._frmSelAnagrafe <> nil then
      TfrmSelAnagrafe(C700FSelezioneAnagrafe._frmSelAnagrafe).SelezionePeriodicaVal:=TfrmSelAnagrafe(C700FSelezioneAnagrafe._frmSelAnagrafe).SelezionePeriodicaVal;
    (*
...
procedure TC700FSelezioneAnagrafeDtM.selT003NomeBeforeOpen(DataSet: TDataSet);
begin
  R180SetReadBuffer(selT003Nome);
end;
