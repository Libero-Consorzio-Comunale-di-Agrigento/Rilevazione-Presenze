...
type
  TFunzioniDisponibili = record
    ...
    T:Word;   //Tag del TMenuItem e eventualmente dello SpeedButton
...
(*Tag liberi:
(RILPRE)140,186,187,188,
(RILPRE)216,217,218,219,220,221,222,223,224,225,226,227,228,229,230,231,232,233,234,
...
(RILPRE)279,280,281,282,283,284,285,286,287,288,289,290,291,292,293,294,295,296,297,298,
(STAGIU)360,361,362,363,364,365,366,367,368,369,370,371,372,373,
(STAGIU)374,375,376,377,378,379,380,381,382,383,384,385,386,387,388,389,390,391,392,393,394,395,396,397,
(IRISWEB)468,469,470,471,472,473,474,475,476,477,478,479,480,481,482,483,484,485,486,487,
(IRISWEB)488,489,490,491,492,493,494,495,496,497,498
(PAGHE)652-->
*)
...
const
  ...
  FunzioniDisponibili:array [1..NFComuni + NFRilpre + NFPaghe + NFStagiu] of TFunzioniDisponibili = (
    ...
    (A:'IRIS';  S:'B022';SW:'WB022';N:'Utility gestione documentale';           G:'Amministrazione sistema';       DI:False;T:200;F:'OpenB022UtilityGestDocumentale';       M:''),
    ...
    (A:'IRIS';  S:'';    SW:'WA180';N:'Operatori';                              G:'Amministrazione sistema';       DI:False;T:83; F:'OpenA180Operatori';                    M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA181';N:'Aziende';                                G:'Amministrazione sistema';       DI:False;T:84; F:'OpenA181Aziende';                      M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA182';N:'Permessi';                               G:'Amministrazione sistema';       DI:False;T:85; F:'OpenA182Permessi';                     M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA183';N:'Filtro anagrafe';                        G:'Amministrazione sistema';       DI:False;T:86; F:'OpenA183FiltroAnagrafe';               M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA184';N:'Filtro funzioni';                        G:'Amministrazione sistema';       DI:False;T:87; F:'OpenA184FiltroFunzioni';               M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA185';N:'Filtro dizionario';                      G:'Amministrazione sistema';       DI:False;T:88; F:'OpenA185FiltroDizionario';             M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA179';N:'Profilo iter autorizzativi';             G:'Amministrazione sistema';       DI:False;T:80; F:'OpenA179ProfiloIterAutorizzativi';     M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA188';N:'Iter autorizzativi';                     G:'Amministrazione sistema';       DI:False;T:82; F:'OpenA188IterAutorizzativi';            M:''; WEB:'S'),
    (A:'IRIS';  S:'';    SW:'WA187';N:'Accessi';                                G:'Amministrazione sistema';       DI:False;T:90; F:'OpenA187Accessi';                      M:''; WEB:'S'),
    ...
    (A:'IRIS';  S:'';    SW:'WA150';N:'Codici Accorpamento causali assenza';    G:'Ambiente';                      DI:False;T:91;                                           M:''; WEB:'S'),
    ...
    (A:'IRIS';  S:'P430';SW:'WP430';N:'Anagrafica stipendi';                    G:'Personale';                     DI:True ;T:503;F:'OpenP430FAnagrafico';                  M:''),
    (A:'IRIS';  S:'A202';SW:'WA202';N:'Riepilogo rapporti di lavoro';           G:'Personale';                     DI:True ;T:161;F:'OpenA202RapportiLavoro';               M:''),
    (A:'IRIS';  S:'A202';SW:'WA202';N:'Validazione autocertificazione dati giuridici';G:'Personale';               DI:True ;T:182;F:'OpenA202ValidazioneDatiGiuridici';     M:'AUTOCERTIFICAZIONI'),
    ...
    (A:'IRIS';  S:'A101';SW:'WA101';N:'Raggruppamenti interrogazioni di servizio';G:'Ambiente';                    DI:False;T:52; F:'OpenA101RaggrInterrogazioni';          M:''),
    ...
    (A:'IRIS';  S:'';    SW:'WA201';N:'Cambio azienda';                         G:'Amministrazione sistema';       DI:False;T:158; F:'OpenA201CambioAzienda';               M:''),
    ...
    (A:'FUNWEB';S:'W045';SW:'';     N:'Cambio azienda';                         G:'Funzioni WEB';                  DI:False;T:453; F:'OpenW045CambioAzienda';               M:'IRIS_WEB'),
    ...
    (A:'FUNWEB';S:'W041';SW:'';     N:'Interrogazioni di servizio';             G:'Funzioni WEB';                  DI:False;T:447; F:'OpenW041QueryServizio';               M:'IRIS_WEB'),
    (A:'FUNWEB';S:'W038';SW:'';     N:'Timbratrice virtuale';                   G:'Funzioni WEB';                  DI:False;T:451; F:'OpenW038BollatriceVirtuale';          M:'IRIS_WEB'; MIW:'BOLLATRICE_VIRTUALE'),
    (A:'FUNWEB';S:'WM015';SW:'';    N:'Timbratrice virtuale mobile';            G:'Funzioni WEB';                  DI:False;T:459; F:'OpenWM015BollatriceVirtuale';         M:'IRIS_WEB'; MIW:'BOLLATRICE_VIRTUALE'),
    (A:'FUNWEB';S:'W035';SW:'';     N:'Messaggistica';                          G:'Funzioni WEB';                  DI:False;T:445; F:'OpenW035Messaggistica';               M:'IRIS_WEB'; MIW:'MESSAGGISTICA'),
    (A:'FUNWEB';S:'W034';SW:'';     N:'Pubblicazione documenti';                G:'Funzioni WEB';                  DI:False;T:444; F:'OpenW034PubblicazioneDocumenti';      M:'IRIS_WEB'; MIW:'ARCHIVIAZIONE_SOSTITUTIVA,GESTIONE_DOCUMENTALE'),
    (A:'FUNWEB';S:'W040';SW:'';     N:'Upload documenti';                       G:'Funzioni WEB';                  DI:False;T:449; F:'OpenW040UploadDocumenti';             M:'IRIS_WEB'; MIW:'GESTIONE_DOCUMENTALE'),
    (A:'FUNWEB';S:'W039';SW:'';     N:'Gestione documentale';                   G:'Funzioni WEB';                  DI:False;T:448; F:'OpenW039GestioneDocumentale';         M:'IRIS_WEB'; MIW:'GESTIONE_DOCUMENTALE'),
    (A:'FUNWEB';S:'W042';SW:'';     N:'Dati del coniuge';                       G:'Funzioni WEB';                  DI:False;T:450; F:'OpenW042DatiConiuge';                 M:'IRIS_WEB'; MIW:'FAMILIARI_WEB'),
    (A:'FUNWEB';S:'W047';SW:'';     N:'Iscrizione ordine professionale';        G:'Funzioni WEB';                  DI:False;T:467; F:'OpenW047OrdiniProfessionali';         M:'IRIS_WEB'; MIW:'AUTOCERTIFICAZIONI'),
    (A:'FUNWEB';S:'W049';SW:'';     N:'Autocertificazione dati giuridici';      G:'Funzioni WEB';                  DI:False;T:465; F:'OpenW049AutocertificazioneDatiGiuridici'; M:'IRIS_WEB'; MIW:'AUTOCERTIFICAZIONI'),
    (A:'FUNWEB';S:'W048';SW:'';     N:'Compilazione scheda informativa';        G:'Funzioni WEB';                  DI:False;T:455; F:'OpenW048RichiestaCertificazioni';     M:'IRIS_WEB'; MIW:'AUTOCERTIFICAZIONI'),
    (A:'FUNWEB';S:'W048';SW:'';     N:'Validazione scheda informativa';         G:'Funzioni WEB';                  DI:False;T:456; F:'OpenW048AutorizzCertificazioni';      M:'IRIS_WEB'; MIW:'AUTOCERTIFICAZIONI'),
    (A:'FUNWEB';S:'W050';SW:'';     N:'Richiesta documentale';                  G:'Funzioni WEB';                  DI:False;T:457; F:'OpenW050RichiestaDocumentale';        M:'IRIS_WEB'; MIW:'GESTIONE_DOCUMENTALE'),
    (A:'FUNWEB';S:'W050';SW:'';     N:'Autorizzazione documentale';             G:'Funzioni WEB';                  DI:False;T:458; F:'OpenW050RichiestaDocumentale';        M:'IRIS_WEB'; MIW:'GESTIONE_DOCUMENTALE'),
    ...
    (A:'RILPRE';S:'S030';SW:'WS030';N:'Gestione provvedimenti';                 G:'Personale';                     DI:False;T:304;F:'OpenS030Provvedimento';                M:''),
    ...
    (A:'RILPRE';S:'A173';SW:'WA173';N:'Importazione ore liquidate e di assestamento'; G:'Elaborazioni';            DI:False;T:208;F:'OpenA173FImportAssestamento';          M:''),
    (A:'RILPRE';S:'A081';SW:'WA081';N:'Elenco timbrature causalizzate';         G:'Elaborazioni';                  DI:False;T:141;F:'OpenA081TimbCaus';                     M:''),
    (A:'RILPRE';S:'A159';SW:'WA159';N:'Archiviazione cartellini';               G:'Elaborazioni';                  DI:False;T:75; F:'OpenA159ArchiviazioneCartellini';      M:'ARCHIVIAZIONE_SOSTITUTIVA'),
    ...
    (A:'RILPRE';S:'S028';SW:'WS028';N:'Motivazioni provvedimento';              G:'Ambiente';                      DI:False;T:301;F:'OpenS028Motivazioni';                  M:''),
    ...
    (A:'RILPRE';S:'A203';SW:'WA203';N:'Dati atipici';                           G:'Ambiente';                      DI:False;T:181;F:'OpenA203DatiMensiliPersonalizzati';    M:''),
    ...
    (A:'RILPRE';S:'A098';SW:'WA098';N:'Calendario Ora Legale Solare';           G:'Ambiente';                      DI:False;T:50; F:'OpenA098CalendarioOraLegSol';          M:''),
    ...
    (A:'RILPRE';S:'A175';SW:'WA175';N:'Regole orologi';                         G:'Interfacce/Timbrature';         DI:False;T:89; F:'OpenA175RegoleOrologi';                M:''),
    ...
    (A:'RILPRE';S:'A156';SW:'WA156';N:'Notifiche personalizzate';               G:'Interfacce/IrisWeb';            DI:False;T:78; F:'OpenA156NotificheIrisWEB';             M:''),
    (A:'RILPRE';S:'A178';SW:'WA178';N:'Pianificazione personale convenzionato'; G:'Interfacce/IrisWeb';            DI:True; T:153;F:'OpenA178PianifPersConv';               M:''),
    (A:'RILPRE';S:'A204';SW:'WA204';N:'Modelli di scheda informativa';          G:'Interfacce/IrisWeb';            DI:False;T:183;F:'OpenA204ModelliCertificazione';        M:'AUTOCERTIFICAZIONI'),
    (A:'RILPRE';S:'A210';SW:'WA210';N:'Regole archiviazione documenti';         G:'Interfacce';                    DI:False;T:79; F:'OpenA210FRegoleArchiviazioneDoc';      M:'ARCHIVIAZIONE_SOSTITUTIVA'),
    (A:'RILPRE';S:'A208';SW:'WA208';N:'Acquisizione informazioni esterne';      G:'Interfacce';                    DI:False;T:215;F:'OpenA208FAcquisizioneInfoEsterne';     M:''),
    (A:'RILPRE';S:'A220';SW:'WA220';N:'Trasmissione ad archiviazione sostitutiva';G:'Interfacce';                  DI:False;T:499;F:'OpenA220FArchiviazioneLArchive';       M:'ARCHIVIAZIONE_SOSTITUTIVA'),
    (A:'RILPRE';S:'A119';SW:'WA119';N:'Partecipazione scioperi';                G:'Assenteismo/Scioperi';          DI:False;T:21; F:'OpenA119Scioperi';                     M:'ASSENTEISMO'),
    (A:'RILPRE';S:'A177';SW:'WA177';N:'Ferie solidali';                         G:'Assenteismo/Scioperi';          DI:True; T:81; F:'OpenA177FerieSolidali';                M:'FERIE_SOLIDALI'),
    //Funzioni WEB
    ...
    (A:'RILPRE';S:'W006';SW:'';     N:'Elenco reperibili';                      G:'Funzioni WEB';                  DI:False;T:404; F:'OpenW006ListaReperibili';             M:'IRIS_WEB'; MIW:'CRUSCOTTO_REPERIBILITA'),
    ...
    (A:'RILPRE';S:'W028';SW:'';     N:'Chiamate in reperibilità';               G:'Funzioni WEB';                  DI:False;T:435; F:'OpenW028ChiamateReperibili';          M:'IRIS_WEB'; MIW:'CRUSCOTTO_REPERIBILITA'),
    ...
    (A:'RILPRE';S:'W037';SW:'';     N:'Autorizzazione adesione scioperi';       G:'Funzioni WEB';                  DI:False;T:429; F:'OpenW037RichiestaScioperi';           M:'IRIS_WEB'; MIW:'ASSENTEISMO'),
    (A:'RILPRE';S:'W043';SW:'';     N:'Modifica personale reperibile';          G:'Funzioni WEB';                  DI:False;T:452; F:'OpenW043ModPersonaleReperibile';      M:'IRIS_WEB'; MIW:'CRUSCOTTO_REPERIBILITA'),
    (A:'RILPRE';S:'W044';SW:'';     N:'Acquisto ticket / buoni pasto';          G:'Funzioni WEB';                  DI:False;T:466; F:'OpenW044AcquistoTicket';              M:'IRIS_WEB'; MIW:'BUONI_PASTO'),
    (A:'RILPRE';S:'W046';SW:'';     N:'Compensazione saldo negativo';           G:'Funzioni WEB';                  DI:False;T:454; F:'OpenW046CompensazioneSaldoNegativo';  M:'IRIS_WEB'),
    (A:'RILPRE';S:'W051';SW:'';     N:'Autorizzazione modifica budget';         G:'Funzioni WEB';                  DI:False;T:460; F:'OpenW051GestioneBudget';              M:'IRIS_WEB'; MIW:'BUDGET_STRAORDINARIO'),
    (A:'RILPRE';S:'W051';SW:'';     N:'Richiesta modifica budget';              G:'Funzioni WEB';                  DI:False;T:461; F:'OpenW051RichiesteBudget';             M:'IRIS_WEB'; MIW:'BUDGET_STRAORDINARIO'),
    (A:'RILPRE';S:'W052';SW:'';     N:'Inserimento disponibilità turni';        G:'Funzioni WEB';                  DI:False;T:462; F:'OpenW052RichiestaDispTurni';          M:'IRIS_WEB'; MIW:'PIANIFICAZIONE_ORARI'),
    (A:'RILPRE';S:'W052';SW:'';     N:'Autorizzazione disponibilità turni';     G:'Funzioni WEB';                  DI:False;T:463; F:'OpenW052RichiestaDispTurni';          M:'IRIS_WEB'; MIW:'PIANIFICAZIONE_ORARI'),
    (A:'RILPRE';S:'W053';SW:'';     N:'Registrazione dati atipici';             G:'Funzioni WEB';                  DI:False;T:464; F:'OpenW053DatiAtipici';                 M:'IRIS_WEB'),
    ...
    (A:'RILPRE';S:'A040';SW:'WA040';N:'Pianificazione turni reperibilità';      G:'Reperibilità/Guardia';          DI:False;T:16; F:'OpenA040PianifRep';                    M:'PIANIFICAZIONE_REPERIBILITA'),
    (A:'RILPRE';S:'A040';SW:'WA040';N:'Pianificazione turni guardia';           G:'Reperibilità/Guardia';          DI:False;T:63; F:'OpenA040PianifGuardia';                M:'PIANIFICAZIONE_REPERIBILITA'),
    ...
    (A:'RILPRE';S:'A207';SW:'WA207';N:'Profili stampe reperibili';              G:'Reperibilità/Guardia';          DI:False;T:185;F:'OpenA207ProfiliStampeRep';             M:'PIANIFICAZIONE_REPERIBILITA'),
    ...
    (A:'RILPRE';S:'A205';SW:'WA205';N:'Squadre';                                G:'Pianificazione turni';          DI:False;T:128;F:'OpenA205Squadre';                      M:'PIANIFICAZIONE_ORARI'),
    (A:'RILPRE';S:'A206';SW:'WA206';N:'Condizioni';                             G:'Pianificazione turni';          DI:False;T:184;F:'OpenA206FCondizioniTurni';             M:'PIANIFICAZIONE_ORARI'),
    ...
    (A:'RILPRE';S:'A059';SW:'WA059';N:'Controllo pianificazione';               G:'Pianificazione turni';          DI:False;T:25; F:'OpenA059ContSquadre';                  M:'OBSOLETO_PIANIFICAZIONE_ORARI'),//Nascosto per ristrutturazione pianificazione turni. Se nessuno lo reclama, eliminare
    ...
    (A:'RILPRE';S:'A138';SW:'WA138';N:'Aree turni';                             G:'Pianificazione turni';          DI:False;T:193;F:'OpenA138AreeTurni';                    M:'PIANIFICAZIONE_ORARI'),
    ...
    (A:'RILPRE';S:'A095';SW:'WA095';N:'Liquidazione automatica straordinario';  G:'Budget straordinario';          DI:False;T:44; F:'OpenA095StRiasStr';                    M:''),
    ...
    (A:'RILPRE';S:'A154';SW:'WA154';N:'Gestione documentale';                   G:'Gestione documentale';          DI:False;T:76 ;F:'OpenA154GestioneDocumentale';          M:'GESTIONE_DOCUMENTALE'),
    (A:'RILPRE';S:'A155';SW:'WA155';N:'Ricerca documentale';                    G:'Gestione documentale';          DI:False;T:77 ;F:'OpenA155RicercaDocumentale';           M:'GESTIONE_DOCUMENTALE'),
    (A:'RILPRE';S:'A118';SW:'WA118';N:'Pubblicazione documenti';                G:'Gestione documentale';          DI:False;T:210;F:'OpenA118PubblicazioneDocumenti';       M:'ARCHIVIAZIONE_SOSTITUTIVA,GESTIONE_DOCUMENTALE'),
    (A:'RILPRE';S:'A200';SW:'WA200';N:'Importazione massiva documenti';         G:'Gestione documentale';          DI:False;T:154;F:'OpenA200ImportazioneMassivaDocumenti'; M:'GESTIONE_DOCUMENTALE'),
    (A:'RILPRE';S:'S130';SW:'WS130';N:'Gestione Ordini professionali';          G:'Gestione documentale';          DI:False;T:356;F:'OpenS130OrdiniProfessionali';          M:'AUTOCERTIFICAZIONI'),
    //Buoni pasto/ticket
    ...
    (A:'RILPRE';S:'A166';SW:'WA166';N:'Quote individuali';                      G:'Incentivi';                     DI:True; T:62; F:'OpenA166QuoteIndividuali';             M:'INCENTIVI'),
    (A:'RILPRE';S:'S735';SW:'WS735';N:'Scaglioni part-time incentivi';          G:'Incentivi';                     DI:False;T:205;F:'OpenS735FPunteggiFasceIncentiviI';     M:'INCENTIVI'),
    (A:'RILPRE';S:'S735';SW:'WS735';N:'Scaglioni gg. effettivi incentivi';      G:'Incentivi';                     DI:False;T:211;F:'OpenS735FPunteggiFasceIncentiviG';     M:'INCENTIVI'),
    ...
    (A:'RILPRE';S:'';    SW:'WA199';N:'Controllo rimborsi';                     G:'Missioni/trasferte';            DI:False;T:74; F:'';                                     M:'MISSIONI_TRASFERTE'),
    (A:'RILPRE';S:'A149';SW:'WA149';N:'Categorie rimborsi';                     G:'Missioni/trasferte';            DI:False;T:118;F:'OpenA149CategRimborsi';                M:'MISSIONI_TRASFERTE'),
    (A:'RILPRE';S:'A157';SW:'WA157';N:'Capitoli trasferte';                     G:'Missioni/trasferte';            DI:False;T:135;F:'OpenA157CapitoliTrasferta';            M:'MISSIONI_TRASFERTE'),
    (A:'RILPRE';S:'A158';SW:'WA158';N:'Capitoli rimborso';                      G:'Missioni/trasferte';            DI:False;T:147;F:'OpenA158CapitoliRimborso';             M:'MISSIONI_TRASFERTE'),
    ...
    (A:'RILPRE';S:'P651';SW:'WP651';N:'Relazioni tabelle FLUPER';               G:'Flussi statistici';             DI:False;T:299;F:'OpenP651RelazioniTabelleFL';           M:'FLUSSI_STATISTICI'),
    ...
    //Conto annuale
    (A:'RILPRE';S:'P555';SW:'WP555';N:'Conto annuale';                          G:'Conto annuale';                 DI:True;T:582;F:'OpenP555FContoAnnuale';                 M:'CONTO_ANNUALE'),
    ...
    (A:'RILPRE';S:'P651';SW:'WP651';N:'Relazioni tabelle conto annuale';        G:'Conto annuale';                 DI:False;T:647;F:'OpenP651RelazioniTabelleCA';           M:'CONTO_ANNUALE'),
    //Timbrature scartate
    ...
    (A:'RILPRE';S:'A171';SW:'WA171';N:'XML Visite fiscali';                     G:'Visite fiscali';                DI:False;T:148;F:'OpenA171XMLVisiteFiscali';             M:'VISITE_FISCALI_XML'),
    ...
    (A:'RILPRE';S:'S735';SW:'WS735';N:'Scaglioni valutazioni per incentivi';    G:'Valutazioni';                   DI:False;T:353;F:'OpenS735FPunteggiFasceIncentiviV';     M:'VALUTAZIONI'),
    ...
    (A:'PAGHE';S:'P253';SW:'WP253'; N:'Importazione modelli 730 da file';        G:'Elaborazioni';                 DI:False;T:564;F:'OpenP253FImporta730'),
    (A:'PAGHE';S:'P254';SW:'WP254'; N:'Voci programmate';                        G:'Personale';                    DI:True;T:506;F:'OpenP254FVociProgrammate'),
    ...
    (A:'PAGHE';S:'P261';SW:'WP261'; N:'Impostazione % rimb. Luglio modelli 730'; G:'Elaborazioni';                 DI:False;T:624;F:'OpenP261ImpostazionePercRimbLuglio'),
    (A:'PAGHE';S:'P262';SW:'WP262'; N:'Modello 730';                             G:'Personale';                    DI:True; T:539;F:'OpenP262FDatiMod730'),
    (A:'PAGHE';S:'P263';SW:'WP263'; N:'Esportazione modelli 730 da restituire';  G:'Elaborazioni';                 DI:False;T:646;F:'OpenP263Esporta730'),
    ...
    (A:'PAGHE';S:'P273';SW:'WP273'; N:'Stampa storico retribuzione contrattuale';G:'Elaborazioni';                 DI:False;T:578;F:'OpenP273FStampaStoricoRetribContr'),
    (A:'PAGHE';S:'P441';SW:'WP441'; N:'Cedolini';                                G:'Personale';                    DI:True; T:523;F:'OpenP441FDatiCedolino'),
    ...
    (A:'PAGHE';S:'P466';SW:'WP466'; N:'Premio di operosità maturato';            G:'Elaborazioni';                 DI:False;T:651;F:'OpenP466FPremioOperositaMaturato'),
    ...
    (A:'PAGHE';S:'P505';SW:'WP505'; N:'Modello CU';                              G:'Personale';                    DI:True;T:551;F:'OpenP505FDatiCUD'),
    (A:'PAGHE';S:'P506';SW:'WP506'; N:'Creazione file pagamenti per banca';      G:'Elaborazioni';                 DI:False;T:565;F:'OpenP506FFileCedolini'),
    (A:'PAGHE';S:'P507';SW:'WP507'; N:'Conguagli retroattivi';                   G:'Elaborazioni';                 DI:False;T:567;F:'OpenP507FConguaglioRetroattivoCONG'),
    (A:'PAGHE';S:'P507';SW:'WP507'; N:'Controllo tetto accessorie';              G:'Elaborazioni';                 DI:False;T:619;F:'OpenP507FConguaglioRetroattivoCTRL'),
    ...
    (A:'PAGHE';S:'P513';SW:'WP513'; N:'Creazione file verifica inadempienze';    G:'Elaborazioni';                 DI:False;T:648;F:'OpenP513FFileInadempienze'),
    (A:'PAGHE';S:'P520';SW:'WP520'; N:'Archiviazione log';                       G:'Elaborazioni';                 DI:False;T:649;F:'OpenP520FArchiviazioneLog'; M:'ARCHIVIAZIONE_SOSTITUTIVA'),
    (A:'PAGHE';S:'P554';SW:'WP554'; N:'Elaborazione conto annuale';              G:'Elaborazioni';                 DI:False;T:583;F:'OpenP554FElaborazioneContoAnnuale'),
    (A:'PAGHE';S:'P555';SW:'WP555'; N:'Conto annuale';                           G:'Personale';                    DI:True;T:582;F:'OpenP555FContoAnnuale'),
    ...
    (A:'PAGHE';S:'P655';SW:'WP655'; N:'Fornitura INPDAP - DMA';                  G:'Personale';                    DI:False;T:561;F:'OpenP655FDatiINPDAPMM'),
    ...
    (A:'PAGHE';S:'P658';SW:'WP658'; N:'Elaborazione fornitura F24 EP';           G:'Elaborazioni';                 DI:False;T:593;F:'OpenP658FElaborazioneF24EP'),
    (A:'PAGHE';S:'P659';SW:'WP659'; N:'Elaborazione fornitura F24 ordinario';    G:'Elaborazioni';                 DI:False;T:631;F:'OpenP659ElaborazioneF24Ord'),
    (A:'PAGHE';S:'P671';SW:'WP671'; N:'Elaborazione flusso INPS';                G:'Elaborazioni';                 DI:False;T:570;F:'OpenP671FElaborazioneINPS'),
    (A:'PAGHE';S:'P672';SW:'WP672'; N:'Forniture mensili INPS';                  G:'Personale';                    DI:True; T:573;F:'OpenP672FXmlDatiIndividuali'),
    ...
    (A:'PAGHE';S:'P842';SW:'WP842'; N:'Voci variabili';                          G:'Personale';                    DI:True; T:504;F:'OpenP842FVociVariabiliDipendente'),
    ...
    (A:'PAGHE';S:'A210';SW:'WA210'; N:'Regole archiviazione documenti';          G:'Interfacce';                   DI:False;T:79; F:'OpenA210FRegoleArchiviazioneDoc'; M:'ARCHIVIAZIONE_SOSTITUTIVA'),
    (A:'PAGHE';S:'A220';SW:'WA220'; N:'Trasmissione ad archiviazione sostitutiva';G:'Interfacce';                  DI:False;T:650;F:'OpenA220FArchiviazioneLArchive';  M:'ARCHIVIAZIONE_SOSTITUTIVA'),
    //Ambiente
    ...
    (A:'PAGHE';S:'';    SW:'WP201'; N:'Assoggettamenti';                         G:'Ambiente';                     DI:False;T:638;M:'';WEB:'S'),
    (A:'PAGHE';S:'';    SW:'WP216'; N:'Accorpamenti';                            G:'Ambiente';                     DI:False;T:639;M:'';WEB:'S'),
    (A:'PAGHE';S:'';    SW:'WP205'; N:'Quote';                                   G:'Ambiente';                     DI:False;T:640;M:'';WEB:'S'),
    (A:'PAGHE';S:'';    SW:'WP206'; N:'Assenze INPDAP';                          G:'Ambiente';                     DI:False;T:641;M:'';WEB:'S'),
    (A:'PAGHE';S:'';    SW:'WP232'; N:'Massimali/Scaglioni';                     G:'Ambiente';                     DI:False;T:642;M:'';WEB:'S'),
    ...
    (A:'PAGHE';S:'P512';SW:'WP512'; N:'Enti previdenziali';                      G:'Ambiente';                     DI:False;T:594;F:'OpenP512FEntiPrevidenziali'),
    ...
    (A:'PAGHE';S:'P651';SW:'WP651'; N:'Relazioni tabelle FLUPER';                G:'Ambiente';                     DI:False;T:299;F:'OpenP651RelazioniTabelleFL'),
    (A:'PAGHE';S:'P651';SW:'WP651'; N:'Relazioni tabelle conto annuale';         G:'Ambiente';                     DI:False;T:647;F:'OpenP651RelazioniTabelleCA'),
    ...
    (A:'PAGHE';S:'P015';SW:'WP015'; N:'Enti di appartenenza';                    G:'Ambiente';                     DI:False;T:637;F:'OpenP015FEntiAppartenenza'),
    //Modulo contabilità
    ...
    (A:'PAGHE';S:'P592';SW:'WP592'; N:'Contabilità';                             G:'Personale';                    DI:True; T:588;F:'OpenP592FDatiContab';                  M:'CONTABILITA'),
    ...
    (A:'PAGHE';S:'P286';SW:'WP286'; N:'Elaborazione UNJSPF (OLD)';               G:'Elaborazioni';                 DI:False;T:615;F:'OpenP286ElaborazioneUnjspf';           M:'PENSIONI'),
    (A:'PAGHE';S:'P287';SW:'WP287'; N:'UNJSPF (OLD)';                            G:'Elaborazioni';                 DI:False;T:616;F:'OpenP287PensioneUnjspf';               M:'PENSIONI'),
    (A:'PAGHE';S:'P288';SW:'WP288'; N:'Elaborazione UNJSPF';                     G:'Elaborazioni';                 DI:False;T:633;F:'OpenP288ElaborazioneUnjspfFIN';        M:'PENSIONI'),
    (A:'PAGHE';S:'P289';SW:'WP289'; N:'UNJSPF';                                  G:'Elaborazioni';                 DI:False;T:634;F:'OpenP289PensioneUnjspfFIN';            M:'PENSIONI'),
    (A:'PAGHE';S:'P290';SW:'WP290'; N:'Leave without pay';                       G:'Elaborazioni';                 DI:False;T:635;F:'OpenP290FLeaveWithoutPay';             M:'PENSIONI'),
    (A:'PAGHE';S:'P291';SW:'WP291'; N:'Miscellaneous transactions';              G:'Elaborazioni';                 DI:False;T:636;F:'OpenP291FMiscellaneousTransactions';   M:'PENSIONI'),
    (A:'PAGHE';S:'P310';SW:'WP310'; N:'Elaborazione modelli TFR 1';              G:'Elaborazioni';                 DI:False;T:643;F:'OpenP310FElaborazioneTFR1';            M:'PENSIONI'),
    (A:'PAGHE';S:'P312';SW:'WP312'; N:'Modelli TFR 1';                           G:'Elaborazioni';                 DI:True;T:644;F:'OpenP312ModelliTFR1';                  M:'PENSIONI'),
    (A:'PAGHE';S:'P314';SW:'WP314'; N:'Stampa modelli TFR 1';                    G:'Elaborazioni';                 DI:False;T:645;F:'OpenP314StampaModelliTFR1';            M:'PENSIONI'),
    //Budget
    ...
    (A:'PAGHE';S:'W027';SW:'';      N:'Familiari a carico - A.N.F.';             G:'Funzioni WEB';                 DI:False;T:434; F:'OpenW027DetrazioniIRPEF';             M:'IRIS_WEB'),

    //STATO GIURIDICO

    (A:'STAGIU';S:'A030';SW:'WA030';N:'Residui anno precedente';                 G:'Personale';                    DI:True ;T:11; F:'OpenA030Residui';                      M:''),
    (A:'STAGIU';S:'A010';SW:'WA010';N:'Competenze assenze individuali';          G:'Personale';                    DI:True ;T:4;  F:'OpenA010ProfAsseInd';                  M:''),
    (A:'STAGIU';S:'A013';SW:'WA013';N:'Calendario individuale';                  G:'Personale';                    DI:True ;T:1;  F:'OpenA013CalendIndiv';                  M:''),
    (A:'STAGIU';S:'A004';SW:'WA004';N:'Inserimento giustificativi collettivi';   G:'Elaborazioni';                 DI:False;T:47; F:'OpenA004GiustifGruppo';                M:''),
    (A:'STAGIU';S:'A090';SW:'WA090';N:'Scheda annuale assenze';                  G:'Elaborazioni';                 DI:False;T:41; F:'OpenA090AssenzeAnno';                  M:''),
    (A:'STAGIU';S:'A075';SW:'WA075';N:'Passaggio di anno';                       G:'Elaborazioni';                 DI:False;T:37; F:'OpenA075FineAnno';                     M:''),
    (A:'STAGIU';S:'A077';SW:'WA077';N:'Generatore di stampe';                    G:'Elaborazioni';                 DI:False;T:139;F:'OpenA077GeneratoreStampe';             M:''),
    (A:'STAGIU';S:'A085';SW:'WA085';N:'Part-time';                               G:'Ambiente';                     DI:False;T:144;F:'OpenA085PartTime';                     M:''),
    (A:'STAGIU';S:'A012';SW:'WA012';N:'Calendari';                               G:'Ambiente';                     DI:False;T:101;F:'OpenA012Calendari';                    M:''),
    (A:'STAGIU';S:'A009';SW:'WA009';N:'Profili assenze annuali';                 G:'Ambiente';                     DI:False;T:104;F:'OpenA009ProfiliAsse';                  M:''),
    (A:'STAGIU';S:'A020';SW:'WA020';N:'Causali di presenza';                     G:'Ambiente';                     DI:False;T:107;F:'OpenA020CausPresenze';                 M:''),
    (A:'STAGIU';S:'A018';SW:'WA018';N:'Raggruppamenti di presenza';              G:'Ambiente';                     DI:False;T:108;F:'OpenA018RaggrPres';                    M:''),
    //Certificazione
    (A:'STAGIU';S:'S026';SW:'WS026';N:'Definizione variabili';                   G:'Ambiente/Certificazione';      DI:False;T:302;F:'OpenS026Variabili';                    M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S100';SW:'';     N:'Edizione modelli .rtf';                   G:'Ambiente/Certificazione';      DI:False;T:307;F:'OpenS100EditCert';                     M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S027';SW:'WS027';N:'Tipologie documenti';                     G:'Ambiente';                     DI:False;T:317;F:'OpenS027Documenti';                    M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S028';SW:'WS028';N:'Motivazioni provvedimento';               G:'Ambiente';                     DI:False;T:301;F:'OpenS028Motivazioni';                  M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S108';SW:'WS108';N:'Tipologie esperienze';                    G:'Ambiente/Curriculum';          DI:False;T:319;F:'OpenS108TipoEsperienze';               M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S109';SW:'WS109';N:'Dettaglio esperienze';                    G:'Ambiente/Curriculum';          DI:False;T:320;F:'OpenS109DettaglioEsperienze';          M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S101';SW:'WS101';N:'Stampa modelli .rtf';                     G:'Elaborazioni';                 DI:False;T:308;F:'OpenS101StampaCert';                   M:'CERTIFICAZIONE'),
    (A:'STAGIU';S:'S030';SW:'WS030';N:'Gestione provvedimenti';                  G:'Personale';                    DI:False;T:304;F:'OpenS030Provvedimento';                M:'CERTIFICAZIONE'),
    ...
    //Crediti formativi
    (A:'STAGIU';S:'S652';SW:'';     N:'Tabelle base - corsi';                    G:'Crediti formativi';            DI:False;T:311;F:'OpenS652TabelleBaseCorsiF';            M:'CREDITI_FORMATIVI'),
    (A:'STAGIU';S:'S650';SW:'';     N:'Corsi di formazione';                     G:'Crediti formativi';            DI:False;T:309;F:'OpenS650GestioneCorsiF';               M:'CREDITI_FORMATIVI'),
    (A:'STAGIU';S:'S651';SW:'';     N:'Pianificazione corsi';                    G:'Crediti formativi';            DI:False;T:310;F:'OpenS651PianificazioneCorsiF';         M:'CREDITI_FORMATIVI'),
    ...
    //Corsi di sicurezza
    (A:'STAGIU';S:'S652';SW:'';     N:'Tabelle base - corsi';                    G:'Corsi di sicurezza';           DI:False;T:359;F:'OpenS652TabelleBaseCorsiS';            M:'CORSI_SICUREZZA'),
    (A:'STAGIU';S:'S650';SW:'';     N:'Corsi di sicurezza';                      G:'Corsi di sicurezza';           DI:False;T:357;F:'OpenS650GestioneCorsiS';               M:'CORSI_SICUREZZA'),
    (A:'STAGIU';S:'S651';SW:'';     N:'Pianificazione corsi';                    G:'Corsi di sicurezza';           DI:False;T:358;F:'OpenS651PianificazioneCorsiS';         M:'CORSI_SICUREZZA'),
    ...
    (A:'STAGIU';S:'P655';SW:'WP655';N:'Fornitura FLUPER';                        G:'Flussi statistici';            DI:False;T:572;F:'OpenP655FDatiFLUPER';                  M:'CREDITI_FORMATIVI'),
    (A:'STAGIU';S:'P656';SW:'WP656';N:'Elaborazione fornitura FLUPER';           G:'Flussi statistici';            DI:False;T:574;F:'OpenP656FElaborazioneFLUPER';          M:'CREDITI_FORMATIVI'),
    (A:'STAGIU';S:'P651';SW:'WP651';N:'Relazioni tabelle FLUPER';                G:'Flussi statistici';            DI:False;T:299;F:'OpenP651RelazioniTabelleFL';           M:'CREDITI_FORMATIVI'),
    (A:'STAGIU';S:'P652';SW:'WP652';N:'Regole fornitura FLUPER';                 G:'Flussi statistici';            DI:False;T:571;F:'OpenP652FFLUPERRegole';                M:'CREDITI_FORMATIVI'),
    //Pianta Organica
    (A:'STAGIU';S:'S200';SW:'WS200';N:'Estremi struttura/atti';                  G:'Pianta organica';              DI:False;T:322;F:'OpenS200EstremiStruttura';             M:'PIANTA_ORGANICA'),
    (A:'STAGIU';S:'S201';SW:'WS201';N:'Distribuzione organico';                  G:'Pianta organica';              DI:False;T:312;F:'OpenS201DistribuzioneOrganico';        M:'PIANTA_ORGANICA'),
    (A:'STAGIU';S:'S202';SW:'WS202';N:'Visualizzazione pianta organica';         G:'Pianta organica';              DI:False;T:323;F:'OpenS202VisualizzazionePianta';        M:'PIANTA_ORGANICA'),
    (A:'STAGIU';S:'S203';SW:'WS203';N:'Stampa situazione organico';              G:'Pianta organica';              DI:False;T:313;F:'OpenS203StampaPiantaOrganica';         M:'PIANTA_ORGANICA'),
    //Gestione rischi
    (A:'STAGIU';S:'S400';SW:'WS400';N:'Tipologie rischi e visite';               G:'Rischi e prescrizioni';        DI:False;T:326;F:'OpenS400TipologieRischi';              M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S401';SW:'WS401';N:'Motivazioni cessazione rischi';           G:'Rischi e prescrizioni';        DI:False;T:327;F:'OpenS401CessazioniRischi';             M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S405';SW:'WS405';N:'Tipologie attività';                      G:'Rischi e prescrizioni';        DI:False;T:348;F:'OpenS405TipoAttivita';                 M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S406';SW:'WS406';N:'Tipologie esposizioni';                   G:'Rischi e prescrizioni';        DI:False;T:349;F:'OpenS406TipoEsposizione';              M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S403';SW:'WS403';N:'Tipologie prescrizioni';                  G:'Rischi e prescrizioni';        DI:False;T:330;F:'OpenS403TipologiePrescrizioni';        M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S402';SW:'WS402';N:'Gestione rischi e prescrizioni';          G:'Rischi e prescrizioni';        DI:False;T:328;F:'OpenS402GestioneRischi';               M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S404';SW:'WS404';N:'Stampa periodi rischio';                  G:'Rischi e prescrizioni';        DI:False;T:331;F:'OpenS404StampaRischi';                 M:'RISCHI_PRESCRIZIONI'),
    (A:'STAGIU';S:'S450';SW:'';     N:'Posti letto';                             G:'Rischi e prescrizioni';        DI:False;T:329;F:'OpenS450PostiLetto';                   M:'RISCHI_PRESCRIZIONI'),
    //Gestione documentale(STAGIU)
    (A:'STAGIU';S:'A154';SW:'WA154';N:'Gestione documentale';                    G:'Gestione documentale';         DI:False;T:76; F:'OpenA154GestioneDocumentale';          M:''),
    (A:'STAGIU';S:'A155';SW:'WA155';N:'Ricerca documentale';                     G:'Gestione documentale';         DI:False;T:77; F:'OpenA155RicercaDocumentale';           M:''),
    (A:'STAGIU';S:'A200';SW:'WA200';N:'Importazione massiva documenti';          G:'Gestione documentale';         DI:False;T:154;F:'OpenA200ImportazioneMassivaDocumenti'; M:''),
    (A:'STAGIU';S:'S130';SW:'WS130';N:'Gestione Ordini professionali';           G:'Gestione documentale';         DI:False;T:356;F:'OpenS130OrdiniProfessionali';          M:'AUTOCERTIFICAZIONI'),
    //Conto annuale
    (A:'STAGIU';S:'P555';SW:'WP555';N:'Conto annuale';                           G:'Conto annuale';                DI:True;T:582;F:'OpenP555FContoAnnuale';                 M:'CONTO_ANNUALE'),
    (A:'STAGIU';S:'P554';SW:'WP554';N:'Elaborazione conto annuale';              G:'Conto annuale';                DI:False;T:583;F:'OpenP554FElaborazioneContoAnnuale';    M:'CONTO_ANNUALE'),
    (A:'STAGIU';S:'P552';SW:'WP552';N:'Regole conto annuale';                    G:'Conto annuale';                DI:False;T:580;F:'OpenP552RegoleContoAnnuale';           M:'CONTO_ANNUALE'),
    (A:'STAGIU';S:'P553';SW:'WP553';N:'Risorse residue conto annuale';           G:'Conto annuale';                DI:False;T:584;F:'OpenP553FRisorseResidueContoAnnuale';  M:'CONTO_ANNUALE'),
    (A:'STAGIU';S:'A151';SW:'WA151';N:'Assenteismo e Forza Lavoro';              G:'Conto annuale';                DI:False;T:197;F:'OpenA151AssenteismoForzaLav';          M:'ASSENTEISMO'),
    (A:'STAGIU';S:'P651';SW:'WP651';N:'Relazioni tabelle conto annuale';         G:'Conto annuale';                DI:False;T:647;F:'OpenP651RelazioniTabelleCA';           M:'CONTO_ANNUALE'),
    //Gestione incarichi
    (A:'STAGIU';S:'S300';SW:'WS300';N:'Categorie incarichi';                     G:'Ambiente/Incarichi';           DI:False;T:333;F:'OpenS300CategorieIncarichi';           M:'INCARICHI'),
    (A:'STAGIU';S:'S301';SW:'WS301';N:'Tipi incarichi';                          G:'Ambiente/Incarichi';           DI:False;T:334;F:'OpenS301TipiIncarichi';                M:'INCARICHI'),
    (A:'STAGIU';S:'S302';SW:'WS302';N:'Incarichi aziendali';                     G:'Ambiente/Incarichi';           DI:False;T:335;F:'OpenS302IncarichiAziendali';           M:'INCARICHI'),
    (A:'STAGIU';S:'S309';SW:'WS309';N:'Tipologie verifiche';                     G:'Ambiente/Incarichi';           DI:False;T:351;F:'OpenS309TipiVerifiche';                M:'INCARICHI'),
    (A:'STAGIU';S:'S310';SW:'WS310';N:'Allineamento incarichi';                  G:'Ambiente/Incarichi';           DI:False;T:346;F:'OpenS310AllineamentoIncarichi';        M:'INCARICHI'),
    (A:'STAGIU';S:'S305';SW:'WS305';N:'Commissioni';                             G:'Ambiente/Incarichi';           DI:False;T:336;F:'OpenS305Commissioni';                  M:'INCARICHI'),
    (A:'STAGIU';S:'S306';SW:'WS306';N:'Componenti delle commissioni';            G:'Ambiente/Incarichi';           DI:False;T:337;F:'OpenS306ComponentiCommissioni';        M:'INCARICHI'),
    (A:'STAGIU';S:'S303';SW:'WS303';N:'Gestione incarichi';                      G:'Personale/Incarichi';          DI:True; T:338;F:'OpenS303IncarichiIndividuali';         M:'INCARICHI'),
    (A:'STAGIU';S:'S307';SW:'WS307';N:'Verifiche incarichi';                     G:'Personale/Incarichi';          DI:False;T:318;F:'OpenS307VerificheIncarichi';           M:'INCARICHI'),
    (A:'STAGIU';S:'S304';SW:'WS304';N:'Riepilogo incarichi';                     G:'Personale/Incarichi';          DI:False;T:339;F:'OpenS304RiepilogoIncarichi';           M:'INCARICHI'),
    (A:'STAGIU';S:'S308';SW:'WS308';N:'Verifiche indennità';                     G:'Personale/Incarichi';          DI:True; T:352;F:'OpenS308IndennitaInc';                 M:'INCARICHI'),
    //Funzioni WEB
    ...
    (A:'STAGIU';S:'W036';SW:'';     N:'Curriculum - Trasparenza';                G:'Funzioni WEB';                 DI:False;T:446; F:'OpenW036TraspDirigenza';              M:'IRIS_WEB';),
    //Valutazioni
    (A:'STAGIU';S:'S740';SW:'WS740';N:'Regole valutazioni';                      G:'Valutazioni';                  DI:False;T:350;F:'OpenS740FRegoleValutazioni';           M:'VALUTAZIONI'),
    (A:'STAGIU';S:'S746';SW:'WS746';N:'Stati avanzamento valutazioni';           G:'Valutazioni';                  DI:False;T:354;F:'OpenS746FStatiAvanzamento';            M:'VALUTAZIONI'),
    (A:'STAGIU';S:'S700';SW:'WS700';N:'Aree ed elementi di valutazione';         G:'Valutazioni';                  DI:False;T:342;F:'OpenS700FAreeValutazioni';             M:'VALUTAZIONI'),
    (A:'STAGIU';S:'S720';SW:'WS720';N:'Profili valutazioni';                     G:'Valutazioni';                  DI:False;T:345;F:'OpenS720FProfiliAree';                 M:'VALUTAZIONI'),
    ...
    (A:'STAGIU';S:'S730';SW:'WS730';N:'Punteggi valutazioni';                    G:'Valutazioni';                  DI:False;T:340;F:'OpenS730FPunteggiValutazioni';         M:'VALUTAZIONI'),
    (A:'STAGIU';S:'S735';SW:'WS735';N:'Scaglioni valutazioni per incentivi';     G:'Valutazioni';                  DI:False;T:353;F:'OpenS735FPunteggiFasceIncentiviV';     M:'VALUTAZIONI'),
    (A:'STAGIU';S:'S750';SW:'WS750';N:'Parametrizzazione protocollazione';       G:'Valutazioni';                  DI:False;T:355;F:'OpenS750FParProtocollo';               M:'VALUTAZIONI'),
    (A:'STAGIU';S:'S715';SW:'WS715';N:'Elaborazione schede di valutazione';      G:'Valutazioni';                  DI:False;T:347;F:'OpenS715FStampaValutazioni';           M:'VALUTAZIONI'),
    //Firma digitale
    ...
    //Pensioni UNJSPF TORINO_ITC
    (A:'STAGIU';S:'P288';SW:'';     N:'Elaborazione UNJSPF';                     G:'Elaborazioni';                 DI:False;T:398;F:'OpenP288ElaborazioneUnjspfHR';         M:'PENSIONI'),
    (A:'STAGIU';S:'P289';SW:'';     N:'UNJSPF';                                  G:'Elaborazioni';                 DI:False;T:399;F:'OpenP289PensioneUnjspfHR';             M:'PENSIONI')
    );

function L021GruppiDisponibili(pApplicazione: String): TStringList;
...
function L021ElementoByTag(const PTag: Integer): TFunzioniDisponibili;
...
uses C180FunzioniGenerali, StrUtils;
...
begin
  ...
  for i:=Low(FunzioniDisponibili) to High(FunzioniDisponibili) do
    if R180In(FunzioniDisponibili[i].A,['IRIS','FUNWEB', pApplicazione]) then
      Result.Add(FunzioniDisponibili[i].G);
end;
...
function L021VerificaMaschera(Maschera: String; i:Integer):Boolean;
begin
  Result:=(i <= High(FunzioniDisponibili)) and ((FunzioniDisponibili[i].S.ToUpper = Maschera.ToUpper) or (FunzioniDisponibili[i].SW.ToUpper = Maschera.ToUpper));
end;
...
function L021ElementoByTag(const PTag: Integer): TFunzioniDisponibili;
var
  LElem: TFunzioniDisponibili;
  LFound: Boolean;
begin
  LFound:=False;
  for LElem in FunzioniDisponibili do
  begin
    if LElem.T = PTag then
    begin
      LFound:=True;
      Result:=LElem;
      Break;
  ...
  // errore se tag non trovato
  if not LFound then
    raise Exception.CreateFmt('La funzione ricercata non è disponibile! Il tag %d è inesistente',[PTag]);
end;
