object C017FEMailDtM: TC017FEMailDtM
  ...
  object scrEMailResponsabile: TOracleQuery
    SQL.Strings = (
      ...
      '           t030_anagrafico t030, t430_storico t430'
      ...
      '    and    i073.applicazione = '#39'RILPRE'#39' '
        ...
        '    and    i073.tag = nvl(:tag,100)     -- 100 '#232' un tag sicurame' +
        'nte esistente'
      
        '    and    decode(i073.inibizione,'#39'R'#39','#39'S'#39',i073.inibizione) = dec' +
        'ode(:tag,null,decode(i073.inibizione,'#39'R'#39','#39'S'#39',i073.inibizione),'#39'S' +
        #39') --se tag nullo va sempre bene altrimenti inibizione deve esse' +
        're R o S'
      ...
      '    and    i075.accesso <> '#39'N'#39
      '    and    i060.matricola = t030.matricola'
      '    and    t030.progressivo = t430.progressivo'
      
        '    and    trunc(sysdate) between t430.datadecorrenza and t430.d' +
        'atafine'
      
        '    and    trunc(sysdate) between t430.inizio and nvl(t430.fine,' +
        'sysdate + 1);'
      ''
      ...
      '  p_email      varchar2(4000); -- elenco indirizzi email'
        ...
        '  p_email_deleganti     varchar2(4000); -- elenco indirizzi emai' +
        'l che sono deleganti alla data corrente'
      
        '  p_filtroagg_deleganti varchar2(4000); -- stringa per update da' +
        'ta invio mail che sono deleganti alla data corrente'
      '  x            varchar2(1);'
      '  conto        integer;'
      ...
      '  p_email:=null;'
      '  p_filtroagg:=null;'
      '  p_email_deleganti:=null;'
      '  p_filtroagg_deleganti:=null;'
      ...
      '        '
      '        --verifico se esiste una delega'
      '        conto:=0;'
      '        select count(*) into conto'
      '        from mondoedp.i061_profili_dipendente'
      '        where azienda = :azienda '
      
        '        and trunc(sysdate) between inizio_validita and fine_vali' +
        'dita'
      '        and delega_inserita_da = t1.nome_utente;'
      '        '
      '        if conto > 0 then'
      
        '          if instr('#39';'#39'||p_email_deleganti||'#39';'#39', '#39';'#39'||t1.email||'#39 +
        ';'#39') = 0 then'
      
        '            p_email_deleganti:=p_email_deleganti || '#39';'#39' || t1.em' +
        'ail;'
      '          end if;'
      
        '          p_filtroagg_deleganti:=p_filtroagg_deleganti || '#39';<U>'#39 +
        ' || t1.nome_utente || '#39'<P>'#39' || t1.nome_profilo;'
      '        else'
      
        '          if instr('#39';'#39'||p_email||'#39';'#39', '#39';'#39'||t1.email||'#39';'#39') = 0 th' +
        'en'
      ...
      '  end if;'
      '  if p_email_deleganti is not null then'
      
        '    p_email_deleganti:=substr(p_email_deleganti,2,length(p_email' +
        '_deleganti));'
      '  end if;'
      '  if p_filtroagg_deleganti is not null then'
      
        '    p_filtroagg_deleganti:=substr(p_filtroagg_deleganti,2,length' +
        '(p_filtroagg_deleganti));'
      '  end if;'
      ''
      '  :email:=p_email;'
      '  :filtro_agg:=p_filtroagg;'
      '  :email_deleganti:=p_email_deleganti;'
      '  :filtro_agg_deleganti:=p_filtroagg_deleganti;'
      'end;')
    Optimize = False
    Variables.Data = {
      040000000C000000100000003A0041005A00490045004E004400410005000000
      ...
      
      0000}
    Left = 147
    Top = 12
  end
