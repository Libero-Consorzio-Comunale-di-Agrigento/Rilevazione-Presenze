...
type TDett = record
     ...
     //TDatiDett = array[1..45] of TDett;
     //TDatiRiep = array[1..175] of TRiep;
...
const
    ...
    C_PRU1=59; //Ore in prolungamento in uscita non causalizzate (Monza_HSG)
    C_PRU2=60; //Ore in prolungamento in uscita non causalizzate con totale (Monza_HSG)
    ...
    C_ECCRICH1=77; //Ecc.gg richiedibile da iter IrisWEB
    C_ECCRICH2=78; //Ecc.gg richiedibile da iter IrisWEB con totale
    C_CAU3=79; //Ore causalizzate 2
    C_CAU4=80; //Ore causalizzate 2 con totale
    C_CAU5=81; //Ore causalizzate 3
    C_CAU6=82; //Ore causalizzate 3 con totale
    C_BP1=83; //Maturazione Buono pasto
    C_BP2=84; //Maturazione Buono pasto con totale
    C_CC1=85; //Copertura Carenza
    C_CC2=86; //Copertura Carenza con totale
    C_PRNE1=87; //Ore in prolungamento in E non causalizzate
    C_PRNE2=88; //Ore in prolungamento in E non causalizzate con totale
    C_PRNU1=89; //Ore in prolungamento in U non causalizzate
    C_PRNU2=90; //Ore in prolungamento in U non causalizzate con totale
    C_DGO1=91; //Debito da orario
    C_DGO2=92; //Debito orario con totale
    C_DGM1=93; //Debito medio
    C_DGM2=94; //Debito medio con totale
    C_SD1=95;  //Scostamento del debito
    C_SD2=96;  //Scostamento del debito con totale
    C_NOTE=97; //Note
    C_ECCAUTF1=98; //eccedenza da autorizzare divise in fasce
    C_ECCAUTF2=99; //eccedenza da autorizzare divise in fasce con totale?
    C_CAUF1=100; //Ore causalizzate 1 in fasce
    C_CAUF2=101; //Ore causalizzate 1 in fasce con totale?
    C_CAUF3=102; //Ore causalizzate 2 in fasce
    C_CAUF4=103; //Ore causalizzate 2 in fasce con totale?
    C_CAUF5=104; //Ore causalizzate 3 in fasce
    C_CAUF6=105; //Ore causalizzate 3 in fasce con totale?
    C_RICHIESTE=106; //Richieste pendenti

    C_TOTALI_NO=[C_HL1,C_HH1,C_EC1,C_SC1,C_SN1,C_DG1,C_SP1,C_CM1,C_CMNG1,C_LF1,C_PRI1,C_PRN1,C_PRNE1,C_PRNU1,C_PRU1,C_PRT1,C_ESC1,C_PM1,C_FENNG1,C_PINT1,C_PCONV1,C_CAU1,C_CAU3,C_CAU5,C_IT1,C_INDP1,C_INDF1,C_INDN1,C_NUMN1,C_ECCRICH1,C_ECCAUTF1,C_BP1,C_CC1,C_DGO1,C_DGM1,C_SD1,C_CAUF1,C_CAUF3,C_CAUF5];
    C_TOTALI_SI=[C_HL2,C_HH2,C_EC2,C_SC2,C_SN2,C_DG2,C_SP2,C_CM2,C_CMNG2,C_LF2,C_PRI2,C_PRN2,C_PRNE2,C_PRNU2,C_PRU2,C_PRT2,C_ESC2,C_PM2,C_FENNG2,C_PINT2,C_PCONV2,C_CAU2,C_CAU4,C_CAU6,C_IT2,C_INDP2,C_INDF2,C_INDN2,C_NUMN2,C_ECCRICH2,C_ECCAUTF2,C_BP2,C_CC2,C_DGO2,C_DGM2,C_SD2,C_CAUF2,C_CAUF4,C_CAUF6];

    C_PROPRIETA=[C_GG1..C_SC2,C_TR1,C_TR2,C_SN1..C_LF2,C_PRI1..C_PRT2,C_PRNE1,C_PRNE2,C_PRNU1,C_PRNU2,C_PRU1..C_PRU2,C_CMNG1..C_CMNG2,C_ESC1..C_ESC2,C_PM1..C_PM2,C_FENNG1..C_PCONV2,C_CAU1..C_CAU2,C_IT1..C_IT2,C_INDP1,C_INDP2,C_INDF1,C_INDF2,C_INDN1,C_INDN2,C_NUMN1..C_CC2, C_DGO1..C_SD2];
    ...
    LENGTH_DATIDETT = 57;
    DatiDett:array[1..LENGTH_DATIDETT] of TDett =
     ((N:C_GG1;      W:05;F:False;WW:False;A:taLeftJustify; D:'Giorno'),
      ...
      (N:C_CAU3;     W:06;F:False;WW:False;A:taRightJustify;D:'Ore causalizzate 2'),
      (N:C_CAU5;     W:06;F:False;WW:False;A:taRightJustify;D:'Ore causalizzate 3'),
      (N:C_CAUF1;    W:30;F:True; WW:False;A:taLeftJustify; D:'Ore caus. 1 in fasce'),
      (N:C_CAUF3;    W:30;F:True; WW:False;A:taLeftJustify; D:'Ore caus. 2 in fasce'),
      (N:C_CAUF5;    W:30;F:True; WW:False;A:taLeftJustify; D:'Ore caus. 3 in fasce'),
      (N:C_DG1;      W:06;F:False;WW:False;A:taRightJustify;D:'Debito'),
      (N:C_DGO1;     W:06;F:False;WW:False;A:taRightJustify;D:'Debito da orario'),
      (N:C_DGM1;     W:06;F:False;WW:False;A:taRightJustify;D:'Debito medio'),
      (N:C_SD1;      W:06;F:False;WW:False;A:taRightJustify;D:'Scostamento del debito'),
      (N:C_ORA;      W:05;F:False;WW:False;A:taLeftJustify; D:'Orario'),
      (N:C_TR1;      W:05;F:False;WW:False;A:taLeftJustify; D:'Turno'),
      (N:C_TM1;      W:06;F:False;WW:True; A:taLeftJustify; D:'Timbrature di mensa'),
      ...
      (N:C_TRA;      W:05;F:False;WW:False;A:taLeftJustify; D:'Turni prestaz.aggiuntive'),
      ...
      (N:C_PRNE1;    W:05;F:False;WW:False;A:taRightJustify;D:'Prol.E non caus.'),
      (N:C_PRNU1;    W:05;F:False;WW:False;A:taRightJustify;D:'Prol.U non caus.'),
      ...
      (N:C_ECCRICH1; W:05;F:False;WW:False;A:taRightJustify;D:'Ecc.gg.richiedibile'),
      (N:C_ECCAUTF1; W:24;F:True; WW:False;A:taLeftJustify; D:'Ecc.da autorizz.in fasce'),
      ...
      (N:C_CC1;      W:05;F:False;WW:False;A:taRightJustify;D:'Copertura carenza'),
      (N:C_INDP1;    W:05;F:False;WW:False;A:taRightJustify;D:'Ind.presenza maturata'),
      (N:C_INDF1;    W:05;F:False;WW:False;A:taRightJustify;D:'Ind.festiva maturata'),
      (N:C_INDN1;    W:05;F:False;WW:False;A:taRightJustify;D:'Ind.notturna maturata'),
      (N:C_NUMN1;    W:05;F:False;WW:False;A:taRightJustify;D:'Num.notti'),
      ...
      (N:C_BP1;      W:06;F:False;WW:False;A:taRightJustify;D:'Maturazione buono pasto'),
      (N:C_NOTE;     W:10;F:False;WW:True;A:taLeftJustify; D:'Note'),
      (N:C_RICHIESTE;W:10;F:False;WW:True;A:taLeftJustify;D:'Richieste pendenti')
      );

    LENGTH_DATIRIEP = 177;
    (*1..132 + 900.. - Liberi: *)
    DatiRiep:array[1..LENGTH_DATIRIEP] of TRiep =
     ((N:001;W:25;D:'Debito mensile'),
      ...
      (N:122;W:20;D:'Tot.liquidabile mensile'),
      (N:005;W:46;D:'Liquidabile dell''anno'),
      (N:123;W:20;D:'Tot.liquidabile dell''anno'),
      (N:007;W:46;D:'Liquidato nell''anno'),
      (N:124;W:20;D:'Tot.liquidato nell''anno'),
      (N:008;W:46;D:'Residuo liquidabile'),
      (N:125;W:20;D:'Tot.residuo liquidabile'),
      (N:009;W:46;D:'Liquidato nel mese'),
      (N:126;W:20;D:'Tot.liquidato nel mese'),
      (N:031;W:46;D:'Banca ore del mese'),
      (N:127;W:20;D:'Tot.banca ore del mese'),
      (N:033;W:32;D:'Banca ore liquidata nel mese'),
      (N:070;W:32;D:'Banca ore recuperata nel mese'),
      (N:131;W:32;D:'Banca ore rec.intern.nel mese'),
      ...
      (N:918;W:06;D:'Fruito richiesto'),
      (N:919;W:06;D:'Fruito autorizzato'),
...
begin
  case X of
    ...
    C_DGO1..C_DGO2:   X:=C_DGO1;  //Dedito da orario
    C_DGM1..C_DGM2:   X:=C_DGM1;  //Dedito medio
    C_SD1..C_SD2:     X:=C_SD1;   //Scostamento del debito
    ...
    C_PRNE1..C_PRNE2: X:=C_PRNE1; //Prolungamento E non causalizzato
    C_PRNU1..C_PRNU2: X:=C_PRNU1; //Prolungamento U non causalizzato
    ...
    C_CAU3..C_CAU4:   X:=C_CAU3;  //Ore causalizzate 2
    C_CAU5..C_CAU6:   X:=C_CAU5;  //Ore causalizzate 3
    C_ECCRICH1..C_ECCRICH2: X:=C_ECCRICH1;  //Ecc.gg. richiedibile da web
    ...
    C_BP1..C_BP2:     X:=C_BP1;   //Maturazione buono pasto
    C_CC1..C_CC2:     X:=C_CC1;   //Copertura carenza
  end;
  Result:=0;
