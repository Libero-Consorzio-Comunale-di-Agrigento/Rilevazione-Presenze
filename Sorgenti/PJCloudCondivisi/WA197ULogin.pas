...
uses
  ...
  IWHTMLControls, meIWLink, WA197ULayoutSchedaAnagr, IWApplication;

type
  TWA197FLogin = class(TWR101FLogin)
  protected
...
procedure TWA197FLogin.LanciaMainForm;
begin
  inherited;
  with TWA197FLayoutSchedaAnagr.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
