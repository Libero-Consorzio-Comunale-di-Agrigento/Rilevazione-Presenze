...
type
  TWS750FLogin = class(TWR101FLogin)
  private
...
uses WS750UParProtocollo;

{$R *.dfm}

procedure TWS750FLogin.LanciaMainForm;
begin
  with TWS750FParProtocollo.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
