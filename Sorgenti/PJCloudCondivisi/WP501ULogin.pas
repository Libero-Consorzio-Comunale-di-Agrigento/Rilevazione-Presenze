...
type
  TWP501FLogin = class(TWR101FLogin)
  private
...
procedure TWP501FLogin.LanciaMainForm;
begin
  inherited;
  with TWP501FCudSetup.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWP501FLogin.SetAsMainForm;
