...
uses
  ...
  meIWLink, IWApplication, WP651URelazioniTabelle;

type
  TWP651FLogin = class(TWR101FLogin)
  private
...
procedure TWP651FLogin.LanciaMainForm;
begin
  with TWP651FRelazioniTabelle.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWP651FLogin.SetAsMainForm;
