...
type
  TWA200FLogin = class(TWR101FLogin)
  private
...
procedure TWA200FLogin.LanciaMainForm;
begin
  TWA200FImportazioneMassivaDocumenti.Create(GGetWebApplicationThreadVar).OpenPage;
end;

initialization
   TWA200FLogin.SetAsMainForm;
