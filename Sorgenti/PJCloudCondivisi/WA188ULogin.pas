...
type
  TWA188FLogin = class(TWR101FLogin)
  private
...
uses WA188UCampiAnagrafe;

{$R *.dfm}

procedure TWA188FLogin.LanciaMainForm;
begin
  with TWA188FCampiAnagrafe.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWA188FLogin.SetAsMainForm;
