...
type
  TWS130FLogin = class(TWR101FLogin)
  private
...
uses WS130UOrdiniProfessionali;

{$R *.dfm}

procedure TWS130FLogin.LanciaMainForm;
begin
  with TWS130FOrdiniProfessionali.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
