...
type
  TWP130FLogin = class(TWR101FLogin)
  private
...
uses WP130UPagamenti;

procedure TWP130FLogin.LanciaMainForm;
begin
  with TWP130FPagamenti.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWP130FLogin.SetAsMainForm;
