...
type
  TWS735FLogin = class(TWR101FLogin)
  private
...
uses WS735UPunteggiFasceIncentivi, IWApplication;

{$R *.dfm}

procedure TWS735FLogin.LanciaMainForm;
begin
  with TWS735FPunteggiFasceIncentivi.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
