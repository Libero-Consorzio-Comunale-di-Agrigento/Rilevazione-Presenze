...
type
  TWP682FLogin = class(TWR101FLogin)
  private
...
uses WP682URaggruppamentiFondi;

procedure TWP682FLogin.LanciaMainForm;
begin
  with TWP682FRaggruppamentiFondi.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWP682FLogin.SetAsMainForm;
