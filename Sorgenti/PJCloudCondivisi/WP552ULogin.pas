...
uses
  ...
  meIWLink, WP552URegoleContoAnnuale, IWApplication;

type
  TWP552FLogin = class(TWR101FLogin)
  protected
...
procedure TWP552FLogin.LanciaMainForm;
begin
  with TWP552FRegoleContoAnnuale.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
