...
type
  TWP553FLogin = class(TWR101FLogin)
  protected
...
procedure TWP553FLogin.LanciaMainForm;
begin
  inherited;
  with TWP553FRisorseResidueContoAnnuale.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
