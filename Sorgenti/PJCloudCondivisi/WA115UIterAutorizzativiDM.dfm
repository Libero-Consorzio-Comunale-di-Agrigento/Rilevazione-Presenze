inherited WA115FIterAutorizzativiDM: TWA115FIterAutorizzativiDM
  Height = 521
  Width = 893
  inherited selTabella: TOracleDataSet
    SQL.Strings = (
      'SELECT I093.*, '
        ...
        'length(concatena_testo('#39'select '#39#39'X'#39#39' from mondoedp.i094_chkdati_' +
        'iter_aut where azienda = '#39#39#39'||I093.AZIENDA||'#39#39#39' and ITER = '#39#39#39'||' +
    ...
    object selTabellaD_iter: TStringField
      DisplayLabel = 'Iter'
    ...
    object selTabellaMSG_NOTIFICA: TStringField
      DisplayLabel = 'Messaggio notifica IrisWEB'
      DisplayWidth = 30
      FieldName = 'MSG_NOTIFICA'
      Size = 2000
    end
  end
