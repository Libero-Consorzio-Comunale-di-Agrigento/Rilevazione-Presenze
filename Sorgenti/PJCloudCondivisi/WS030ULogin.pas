...
type
  TWS030FLogin = class(TWR101FLogin)
  private
...
uses WS030UProvvedimenti;

{$R *.dfm}

procedure TWS030FLogin.LanciaMainForm;
begin
  with TWS030FProvvedimenti.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
  TWS030FLogin.SetAsMainForm;
