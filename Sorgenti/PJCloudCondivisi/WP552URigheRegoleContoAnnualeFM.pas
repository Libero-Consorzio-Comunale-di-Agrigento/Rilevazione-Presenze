unit WP552URigheRegoleContoAnnualeFM;
...
uses
  ...
  WP552UDettaglioRegoleContoAnnFM, P552URegoleContoAnnualeMW, Data.DB, A000UInterfaccia,
  WR100UBase, C180FunzioniGenerali;

type
  TWP552FRigheRegoleContoAnnualeFM = class(TWR203FGestDetailFM)
...
procedure TWP552FRigheRegoleContoAnnualeFM.IWFrameRegionCreate(Sender: TObject);
begin
  inherited;
...
procedure TWP552FRigheRegoleContoAnnualeFM.actAnnullaExecute(Sender: TObject);
begin
  inherited;
  TWR100FBase(Self.Owner).MessaggioStatus(INFORMA,'');
end;

procedure TWP552FRigheRegoleContoAnnualeFM.actConfermaExecute(Sender: TObject);
begin
  inherited;
  TWR100FBase(Self.Owner).MessaggioStatus(INFORMA,'');
end;

procedure TWP552FRigheRegoleContoAnnualeFM.actModificaExecute(Sender: TObject);
var
...
begin
  ...
  WP552FDettaglioRegoleContoAnnFM.Visualizza('Dettaglio righe',TIPO_ELAB_RIGA);
end;

procedure TWP552FRigheRegoleContoAnnualeFM.actNuovoExecute(Sender: TObject);
var
  WP552FDettaglioRegoleContoAnnFM: TWP552FDettaglioRegoleContoAnnFM;
begin
  inherited;
