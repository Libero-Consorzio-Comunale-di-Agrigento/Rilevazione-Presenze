...
type
  TWA210FLogin = class(TWR101FLogin)
  private
...
procedure TWA210FLogin.LanciaMainForm;
begin
  with TWA210FRegoleArchiviazioneDoc.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
