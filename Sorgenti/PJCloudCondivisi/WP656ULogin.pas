...
uses
  ...
  meIWLink, WP656UElaborazioneFluper, IWApplication;

type
  TWP656FLogin = class(TWR101FLogin)
  protected
...
procedure TWP656FLogin.LanciaMainForm;
begin
  with TWP656FElaborazioneFluper.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
