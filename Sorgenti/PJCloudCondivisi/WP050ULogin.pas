...
type
  TWP050FLogin = class(TWR101FLogin)
  private
...
procedure TWP050FLogin.LanciaMainForm;
begin
  with TWP050FArrotondamenti.Create(GGetWebApplicationThreadVar) do
  begin
    OpenPage;
  end;
end;
