...
type
  TWS031FLogin = class(TWR101FLogin)
  private
...
uses WS031UFamiliari;

{$R *.dfm}

procedure TWS031FLogin.LanciaMainForm;
begin
  with TWS031FFamiliari.Create(GGetWebApplicationThreadVar) do
    OpenPage;
end;

initialization
   TWS031FLogin.SetAsMainForm;
