inherited W037FRichiestaScioperi: TW037FRichiestaScioperi
  ...
  object rgnDettaglio: TmeIWRegion [9]
    Left = 16
    Top = 256
    Width = 505
    Height = 201
  ...
  object pmnDipendenti: TPopupMenu
    Left = 312
    Top = 360
    object mnuEsportaExcelDipendenti: TMenuItem
      Caption = 'Esporta in Excel'
      Hint = 'file_xls'
      OnClick = mnuEsportaExcelDipendentiClick
    end
    object mnuEsportaCSVDipendenti: TMenuItem
      Caption = 'Esporta in CSV'
      Hint = 'file_csv'
      OnClick = mnuEsportaCSVDipendentiClick
    end
  end
end
