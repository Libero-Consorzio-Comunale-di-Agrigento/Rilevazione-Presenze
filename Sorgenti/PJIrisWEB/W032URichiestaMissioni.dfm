inherited W032FRichiestaMissioni: TW032FRichiestaMissioni
  ...
  object tabMissioni: TmedpIWTabControl [9]
    Left = 19
    Top = 192
    Width = 212
    Height = 20
  ...
  object lnkDocumento: TmeIWLink [10]
    Left = 456
    Top = 192
    Width = 139
    Height = 17
  ...
  object rgAnticipi: TmeIWRegion [11]
    ...
    object lblTotSpettante: TmeIWLabel
      Left = 496
      Top = 96
      Width = 95
      Height = 16
      ...
      Font.Style = []
      HasTabOrder = False
      FriendlyName = 'lblTotSpettante'
      Caption = 'lblTotSpettante'
      Enabled = True
    end
  end
  ...
  object rgDettaglioGG: TmeIWRegion [13]
    Left = 16
    Top = 924
    Width = 658
    Height = 109
  ...
  object rgRimborsi: TmeIWRegion [14]
    Left = 16
    Top = 776
    Width = 658
    Height = 133
    ...
    object lblCapitoloTrasferta: TmeIWLabel
      Left = 26
      Top = 38
      Width = 114
      Height = 16
      ...
      Font.Style = []
      HasTabOrder = False
      FriendlyName = 'lblCapitoloTrasferta'
      Caption = 'Capitolo trasferta:'
      Enabled = True
    end
    object descCapitoloTrasferta: TmeIWLabel
      Left = 280
      Top = 38
      Width = 81
      Height = 16
      ...
      Font.Style = []
      HasTabOrder = False
      FriendlyName = 'descCapitoloTrasferta'
      Caption = '(descrizione)'
      Enabled = True
    end
    object cmbCapitoloTrasferta: TMedpIWMultiColumnComboBox
      Left = 146
      Top = 38
      Width = 121
      Height = 21
      ...
      Font.Size = 10
      Font.Style = []
      FriendlyName = 'cmbCapitoloTrasferta'
      SubmitOnAsyncEvent = True
      TabOrder = 14
      OnAsyncChange = cmbCapitoloTrasfertaAsyncChange
      PopUpHeight = 15
      PopUpWidth = 0
      Text = ''
      ColCount = 2
