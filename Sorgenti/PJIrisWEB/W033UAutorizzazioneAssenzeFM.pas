...
begin
  ...
  TR010FPaginaWeb(Self.Parent).VisualizzajQMessaggio(jQAutorizzazioneAssenze,820,-1,Self.Height + 25,A000TraduzioneStringhe('Autorizzazione assenze:') + ' ' + Dipendente,'#' + Name,False,True);
end;
  ...
  begin
    ...
    begin
      if ACell.Text = 'D' then
        ACell.Text:=A000TraduzioneStringhe('Definitiva')
      else if ACell.Text = 'P' then
        ACell.Text:=A000TraduzioneStringhe('Preventiva')
      else if ACell.Text = 'R' then
        ACell.Text:=A000TraduzioneStringhe('Revoca')
      else if ACell.Text = 'C' then
        ACell.Text:=A000TraduzioneStringhe('Cancellazione');
    end;
  end;
end;
