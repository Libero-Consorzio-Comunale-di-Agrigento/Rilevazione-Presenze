...
begin
  ...
  begin
    ...
    W035Form:=(Owner as TW035FMessaggistica);
    W035Form.LeggiMessaggio;
    // aggiorna stato ricezione se necessario
    W035Form.CtrlImpostaStatoRicezione(nil);
  end
  else
  begin
    // pulisce interfaccia
    W035Form:=(Owner as TW035FMessaggistica);
    W035Form.ClearMessaggio;
  end;
end;
