object W005FCartellinoDtm: TW005FCartellinoDtm
  ...
  object selT040: TOracleDataSet
    SQL.Strings = (
      'SELECT DATA, CAUSALE, TIPOGIUST, DAORE, AORE, NOTE, SCHEDA'
  ...
  object selT050: TOracleDataSet
    SQL.Strings = (
      'SELECT CAUSALE, TIPOGIUST, DAL, AL, NUMEROORE, AORE'
  ...
  object selT275: TOracleDataSet
    SQL.Strings = (
      'select T275.CODICE, T275.DESCRIZIONE, T275.INSERIMENTO_TIMB'
  ...
  object selT305: TOracleDataSet
    SQL.Strings = (
      'select T305.CODICE, T305.DESCRIZIONE'
      '  from T305_CAUGIUSTIF T305'
      'order by T305.CODICE')
    Optimize = False
    OnFilterRecord = selT305FilterRecord
    Left = 72
    Top = 64
  end
end
