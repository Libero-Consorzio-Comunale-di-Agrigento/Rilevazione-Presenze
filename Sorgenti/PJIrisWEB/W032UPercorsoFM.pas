...
begin
  ...
  begin
    // se non è definita la sede aziendale disabilita il radiobutton "Sede"
    C190AbilitaComponente(rgpFlagPercorso,SedeDefinita,FlagPercorsoStrToIndex(M140FLAG_PERCORSO_SEDE));

    // se il dipendente non ha impostato né domicilio né residenza, disabilita il radiobutton "Domicilio"
...
begin
  // impedisce apertura frame se il periodo della missione non è indicato o non è corretto
  ...
  begin
    try
      ...
      // PRE: la data di fine missione è valorizzata e valida
...
begin
  ...
  begin
    // AOSTA_REGIONE - commessa 2014/242 SVILUPPO#2 - riesame del 20.04.2015.ini
    // valuta il flag destinazione solo se il codice comune della località è indicato
    // (ora anche su località personalizzate)
    ...
    //Si riconosce la tappa nulla, e alla fine si verifica se la destinazione espressa sulla richiesta è inferiore o meno a quella riconosciuta qui.
...
begin
  // mantiene la consecutività del campo ORD
  W032DM.selM141.First;
  while not W032DM.selM141.Eof do
  begin
    W032DM.selM141.Edit;
