object W035FMessaggisticaDM: TW035FMessaggisticaDM
  ...
  object selOperatori: TOracleDataSet
    SQL.Strings = (
      '('
      '-- user win con profilo abilitato, non presenti su I060'
      'select I070.UTENTE'
      ...
      'union'
        ...
        '-- user web senza matricola con almeno un profilo abilitato alla' +
        ' funzione :TAG'
      'select I060.NOME_UTENTE '
      'from   MONDOEDP.I060_LOGIN_DIPENDENTE I060,'
  ...
  object delT283Tutti: TOracleQuery
    SQL.Strings = (
      'delete from T283_ALLEGATI'
      'where  ID = :ID'
      '')
