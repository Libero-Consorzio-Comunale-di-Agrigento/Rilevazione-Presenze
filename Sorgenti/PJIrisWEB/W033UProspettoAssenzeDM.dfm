object W033FProspettoAssenzeDM: TW033FProspettoAssenzeDM
  ...
  object selT050: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT VT050.PROGRESSIVO, VT050.CAUSALE, VT050.TIPOGIUST, DECODE' +
        '(VT050.TIPOGIUST,'#39'I'#39',1,'#39'M'#39',2,'#39'N'#39',3,'#39'D'#39',4) SORT_TIPOGIUST, V010.D' +
        'ATA, VT050.TIPO_RICHIESTA, VT050.STATO, VT050.NUMEROORE DAORE, V' +
        'T050.AORE, VT050.ID, VT050.NOTE_GIUSTIFICATIVO'
  ...
  object selT100: TOracleDataSet
    SQL.Strings = (
      ...
      '    (SELECT PROGRESSIVO,DATA,COUNT(DATA) N_TIMB'
  ...
  object selT040: TOracleDataSet
    SQL.Strings = (
        ...
        '4.MI'#39') DAORE, TO_CHAR(AORE,'#39'HH24.MI'#39') AORE, ID_RICHIESTA, NOTE'
  ...
  object selaT050: TOracleDataSet
    SQL.Strings = (
      ...
      '        T050.ROWID,'
        ...
        '0.DAL,T050.AL,T050.NUMEROORE,T050.DATANAS,T050.AORE,T050.ELABORA' +
        'TO,T050.NUMEROORE_PREV,T050.AORE_PREV,'
