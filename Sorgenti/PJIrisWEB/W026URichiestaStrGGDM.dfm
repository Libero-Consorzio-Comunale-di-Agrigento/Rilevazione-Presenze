object W026FRichiestaStrGGDM: TW026FRichiestaStrGGDM
  ...
  object cdsT325Vis: TClientDataSet
    ...
    object cdsT325VisMSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 2000
    end
    object cdsT325VisMSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 2000
    end
  end
  object cdsT325VisEU: TClientDataSet
    ...
    object cdsT325VisEUMSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 2000
    end
    object cdsT325VisEUMSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 2000
    end
  end
  ...
  object selTotCaus: TOracleQuery
    SQL.Strings = (
      
        'select sum(decode(DALLE,NULL,0,oreminuti(ALLE) + decode(sign(ore' +
        'minuti(ALLE) - oreminuti(DALLE)),1,0,1440) - oreminuti(DALLE))) ' +
        'TOTALE'
      'from '
      '('
      ...
      '  ('
        ...
        '    select T326.CAUS1 CAUS, T325.DATA, SPEZ_DALLE1 DALLE ,SPEZ_A' +
        'LLE1 ALLE'
      '    from   T325_RICHIESTESTR_GG T325,'
      '           T326_RICHIESTESTR_SPEZ T326,'
      '           T850_ITER_RICHIESTE T850'
      ...
      '    and    T325.DATA between :INIZIO and :FINE'
      '    and    T326.ID_T850 = T850.ID'
      '    and    nvl(T850.STATO,'#39'X'#39') = '#39'X'#39
      '    and    T325.PROGRESSIVO = :PROGRESSIVO'
      '    and    T326.CAUS1 in (:CAUSALI)'
      '    union all'
      '    select T326.CAUS2, T325.DATA, SPEZ_DALLE2,SPEZ_ALLE2'
      '    from   T325_RICHIESTESTR_GG T325,'
      '           T326_RICHIESTESTR_SPEZ T326,'
      '           T850_ITER_RICHIESTE T850'
      '    where  T325.ID = T326.ID'
      ...
      '    and    nvl(T850.STATO,'#39'X'#39') = '#39'X'#39
      '    and    T325.PROGRESSIVO = :PROGRESSIVO'
      '    and    T326.CAUS2 in (:CAUSALI)'
      '    union all'
      '    select T326.CAUS2, T325.DATA, SPEZ_DALLE3,SPEZ_ALLE3'
      '    from   T325_RICHIESTESTR_GG T325,'
      '           T326_RICHIESTESTR_SPEZ T326,'
      '           T850_ITER_RICHIESTE T850'
      '    where  T325.ID = T326.ID'
      ...
      '    and    nvl(T850.STATO,'#39'X'#39') = '#39'X'#39
      '    and    T325.PROGRESSIVO = :PROGRESSIVO'
      '    and    T326.CAUS3 in (:CAUSALI)'
      '  ) T'
      '  union all'
      
        '  --richieste gi'#224' autorizzate, ma che non esistono ancora sulla ' +
      ...
      '    and    T325.DATA between :INIZIO and :FINE'
      '    and    T326.ID_T850 = T850.ID'
      '    and    nvl(T850.STATO,'#39'X'#39') = '#39'S'#39
      '    and    T325.PROGRESSIVO = :PROGRESSIVO'
      '    and    T326.CAUS1 in (:CAUSALI)'
      '    union all'
      '    select T326.CAUS2, T325.DATA, SPEZ_DALLE2,SPEZ_ALLE2'
      ...
      '  ) TS'
        ...
        '  where not exists (select '#39'x'#39' from T073_SCHEDACAUSPRES where PR' +
        'OGRESSIVO = :PROGRESSIVO and DATA = trunc(TS.DATA,'#39'mm'#39') and CAUS' +
        'ALE = TS.CAUS)'
      ')')
    ReadBuffer = 2
    Optimize = False
    Variables.Data = {
      }
    Left = 345
    Top = 131
  end
  object selT430AbPresenza1: TOracleDataSet
    SQL.Strings = (
      
        'select intersez_liste(T430.ABPRESENZA1,T275.CODRAGGR) CAUSALE_AB' +
        'ILITATA'
      'from T430_STORICO T430, T275_CAUPRESENZE T275'
  ...
  object insT320: TOracleQuery
    SQL.Strings = (
      ...
      '  wData date;'
      '  wAlle varchar2(5);'
      '  wCavalloMezzanotte boolean;'
      'begin'
      '  if :TIPOAUTORIZZAZIONE = '#39'P'#39' or :CAUSALE = '#39'nulla'#39' then'
      '    insert into t320_pianlibprofessione'
      '      (progressivo, data, dalle, alle, causale, id_richiesta)'
      '    values'
      
        '      (:PROGRESSIVO, :DATA, :DALLE, :ALLE, :CAUSALE, :ID_RICHIES' +
        'TA);'
      '  else'
      '    wCavalloMezzanotte:=oreminuti(:DALLE) >= oreminuti(:ALLE);'
      '    wAlle:=:ALLE;'
      '    if wCavalloMezzanotte then'
      '      wAlle:='#39'00.00'#39';'
      '    end if;'
      '    insert into T040_GIUSTIFICATIVI'
      
        '      (progressivo, data, daore, aore, causale, id_richiesta, pr' +
        'ogrcausale, tipogiust)'
      '    values'
      
        '      (:PROGRESSIVO, :DATA, to_date('#39'30121899'#39'||:DALLE,'#39'ddmmyyyy' +
        'hh24.mi'#39'), to_date('#39'30121899'#39'||wAlle,'#39'ddmmyyyyhh24.mi'#39'), :CAUSAL' +
        'E, :ID_RICHIESTA, 0, '#39'D'#39');'
      '    if wCavalloMezzanotte then'
      '      insert into T040_GIUSTIFICATIVI'
      
        '        (progressivo, data, daore, aore, causale, id_richiesta, ' +
        'progrcausale, tipogiust)'
      '      values'
      
        '        (:PROGRESSIVO, :DATA + 1, to_date('#39'3012189900.00'#39','#39'ddmmy' +
        'yyyhh24.mi'#39'), to_date('#39'30121899'#39'||:ALLE,'#39'ddmmyyyyhh24.mi'#39'), :CAU' +
        'SALE, :ID_RICHIESTA, 0, '#39'D'#39');'
      '    end if;'
      '  end if;    '
      'end;')
    Optimize = False
    Variables.Data = {
      ...
      00000000000000000000260000003A005400490050004F004100550054004F00
      520049005A005A0041005A0049004F004E004500050000000000000000000000}
    Left = 455
    Top = 140
  end
  object delT320: TOracleQuery
    SQL.Strings = (
      ...
      '    where PROGRESSIVO = :PROGRESSIVO'
      '    and   DATA between :DATA and :DATA + 1'
    ...
    Variables.Data = {
      ...
      
      000000000000}
    Left = 519
    Top = 140
  end
