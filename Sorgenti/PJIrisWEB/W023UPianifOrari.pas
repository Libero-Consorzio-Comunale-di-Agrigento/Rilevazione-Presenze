...
uses
  R010UPaginaWeb, R012UWebAnagrafico, IWApplication,
...
begin
  ...
  begin
    ...
    try
      RegistraLog.SettaProprieta('C','T080_PIANIFORARI',medpCodiceForm,nil,True);
...
begin
  ...
  begin
    ...
    try
      RegistraLog.SettaProprieta('I','T080_PIANIFORARI',medpCodiceForm,WR000DM.selT080,True);
      Post;
      RegistraLog.RegistraOperazione;
      SessioneOracle.Commit;
    except
...
begin
  ...
  begin
    ...
    if Parametri.CampiRiferimento.C3_DatoPianificabile <> '' then
      FieldByName('DATOLIBERO').AsString:=RecordPianif.DatoLibero;
    try
      RegistraLog.SettaProprieta('M','T080_PIANIFORARI',medpCodiceForm,WR000DM.selT080,True);
      Post;
      RegistraLog.RegistraOperazione;
      SessioneOracle.Commit;
    except
