object W010FRichiestaAssenzeDM: TW010FRichiestaAssenzeDM
  ...
  object selT050: TOracleDataSet
    ...
    object selT050D_TIPO_CAUSALE: TStringField
      FieldKind = fkCalculated
      FieldName = 'D_TIPO_CAUSALE'
      Size = 1
      Calculated = True
    end
    ...
    object selT050MOTIVAZIONE: TStringField
      FieldName = 'MOTIVAZIONE'
      Size = 5
    end
    object selT050D_MOTIVAZIONE: TStringField
      DisplayWidth = 40
      FieldKind = fkLookup
    ...
    object selT050MSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 2000
    end
    object selT050MSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 2000
    end
  ...
  object selT265_T275: TOracleDataSet
    SQL.Strings = (
      'select '#39'A'#39' TIPO_CAUSALE, T265.CODICE, T265.DESCRIZIONE'
      'from   T265_CAUASSENZE T265'
      'union all'
      'select '#39'P'#39', T275.CODICE, T275.DESCRIZIONE'
