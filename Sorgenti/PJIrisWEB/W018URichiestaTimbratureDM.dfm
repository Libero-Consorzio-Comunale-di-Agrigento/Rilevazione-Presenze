object W018FRichiestaTimbratureDM: TW018FRichiestaTimbratureDM
  ...
  object selT105: TOracleDataSet
    ...
    object selT105D_CAUSALE: TStringField
      FieldName = 'D_CAUSALE'
      Size = 40
    end
    ...
    object selT105D_CAUSALE_ORIG: TStringField
      FieldName = 'D_CAUSALE_ORIG'
      Size = 40
    end
    ...
    object selT105MSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 2000
    end
    object selT105MSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 2000
    end
  end
  ...
  object selT105RiepOre: TOracleDataSet
    SQL.Strings = (
      ...
      '  T105.STATO AUTORIZZAZIONE'
      'from   VT105_RICHIESTETIMBRATURE T105'
  ...
  object selT275Abilitate: TOracleDataSet
    SQL.Strings = (
        ...
        'select '#39'T275'#39' TIPO, T275.CODICE, T275.DESCRIZIONE, T275.TIPO_RIC' +
        'HIESTA_WEB'
      ...
      'select '#39'T305'#39' TIPO, T305.CODICE, T305.DESCRIZIONE, '#39'N'#39
  ...
  object selT106C: TOracleDataSet
    SQL.Strings = (
      'select T106.*'
      'from   T106_MOTIVAZIONIRICHIESTE T106'
      'where  T106.TIPO = :TIPO'
