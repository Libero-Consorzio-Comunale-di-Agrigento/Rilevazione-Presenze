object W009FIterCartellinoDM: TW009FIterCartellinoDM
  ...
  object selT860: TOracleDataSet
    ...
    object selT860MSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 1
    end
    object selT860MSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 1
    end
  end
  ...
  object selT070Notifiche: TOracleDataSet
    SQL.Strings = (
      'select count(*) NUMERO'
      'from   T070_SCHEDARIEPIL T070,'
      '       T860_ITER_STAMPACARTELLINI T860,'
      '       T030_ANAGRAFICO T030, V430_STORICO V430 '
      ...
      'and    T860.MESE_CARTELLINO is null'
        ...
        'and    T180F_STATORIEPILOGO('#39'T860'#39',T070.PROGRESSIVO,T070.DATA) =' +
        ' '#39'C'#39
      '')
    ReadBuffer = 13
    Optimize = False
    Variables.Data = {
      ...
      0000000000000000160000003A0044004100540041004C00410056004F005200
