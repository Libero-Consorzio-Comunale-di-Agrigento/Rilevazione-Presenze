inherited W001FIrisWebDtM: TW001FIrisWebDtM
  ...
  inherited OperSQL: TOracleQuery
    Left = 314
    Top = 104
  end
  ...
  object selT350: TOracleDataSet
    SQL.Strings = (
      'SELECT CODICE, DESCRIZIONE, '
        ...
        '       OREMINUTI(TO_CHAR(ORAINIZIO,'#39'HH24.MI'#39')) INIZIO, OREMINUTI' +
        '(TO_CHAR(ORAFINE,'#39'HH24.MI'#39')) FINE,'
      '       OREMINUTI(TOLL_CHIAMATA_INIZIO) TOLL_CHIAMATA_INIZIO, '
      '       OREMINUTI(TOLL_CHIAMATA_FINE) TOLL_CHIAMATA_FINE '
  ...
  object selT265: TOracleDataSet
    SQL.Strings = (
        ...
        ' T265.VALIDAZIONE, T265.CAUSALI_CUMULO_L133, T265.FRUIBILE,'
      '       T260.CODINTERNO, T265.CODRAGGR, T260.CONTASOLARE'
  ...
  object selT280: TOracleDataSet
    SQL.Strings = (
      'SELECT '
        ...
        '  T280.*,T280.ROWID, '#39' '#39' PULSANTE, T030A.MATRICOLA, T030A.COGNOM' +
        'E || '#39' '#39' || T030A.NOME NOMINATIVO '
      'FROM T030_ANAGRAFICO T030A, T280_MESSAGGIWEB T280'
      '--WHERE T030.PROGRESSIVO = nvl(:PROGRESSIVO,T030.PROGRESSIVO)'
      'WHERE :FILTRO_ANAG '
      '  AND T280.PROGRESSIVO = T030A.PROGRESSIVO'
      '  AND T280.FLAG IS NOT NULL'
      'ORDER BY DATA DESC, MITTENTE, FLAG')
    ReadBuffer = 200
    Optimize = False
    Variables.Data = {
      0400000001000000180000003A00460049004C00540052004F005F0041004E00
      41004700010000000000000000000000}
  ...
  object selSG101: TOracleDataSet
    SQL.Strings = (
        ...
        '       TO_CHAR(NVL(DATAADOZ,DATANAS),'#39'DDMMYYYYHH24MISS'#39') DATA_ST' +
        'R'
  ...
  object selT910: TOracleDataSet
    SQL.Strings = (
      ...
      'WHERE TEMP_B028 = '#39'N'#39
      
        'AND CODICE NOT IN (SELECT ID FROM I025_CESTINO WHERE TABELLA = '#39 +
        'T910_RIEPILOGO'#39')'
  ...
  object selP504: TOracleDataSet
    SQL.Strings = (
      ...
      '  and P504.CHIUSO = '#39'S'#39' AND P504.TIPO_OPERAZIONE <> '#39'A'#39
        ...
        '  and DECODE(P504.ANNO, 2014, P504.ANNO, P504.ANNO+1) = P500.ANN' +
        'O'
      '  and P500.WEB_STAMPA = '#39'S'#39
      '  and P500.COD_AZIENDA_BASE = '#39'BASE'#39
  ...
  object insSG122: TOracleQuery
    SQL.Strings = (
      ...
      '    (SELECT '#39'X'#39' FROM P500_CUDSETUP P500'
        ...
        'O_CIVILE='#39'S'#39' AND P500.COD_AZIENDA_BASE = '#39'BASE'#39');'
      ''
      '  -- Dettagli'
      '  NumFg:=0;'
      '  NumAL:=0;'
  ...
  object selConiuge: TOracleQuery
    SQL.Strings = (
      ...
      '  :result:=0;'
      ''
      '  select count(*) into wConta from p430_anagrafico;'
      '  '
      '  if wConta = 0 then'
      '    -- no gestione stipendi  '
      '    select count(*) into :result from dual '
      '    -- Verifica accesso al form non ancora effettuato'
      '    where not exists'
      '    -- Verifica accesso al form non ancora effettuato '
      
        '      (select '#39'x'#39' from sg120_familiaridipgen sg120 where sg120.p' +
        'rogressivo=:Progressivo'
      
        '       and to_char(sg120.data_agg,'#39'yyyy'#39')='#39'2016'#39' and sg120.confe' +
        'rma='#39'S'#39');'
      '  else  '
      '    --gestione stipendi'
      '    select count(*) into :result from dual '
      ...
      '    where not exists'
        ...
        '    -- Verifica presenza di un cedolino chiuso con conguaglio IR' +
        'PEF nel 2015'
      '    and exists'
      
        '      (select '#39'x'#39' from p441_cedolino p441, p442_cedolinovoci p44' +
        '2 where p441.id_cedolino=p442.id_cedolino'
      
        '       and p441.progressivo=:Progressivo and to_char(p441.data_c' +
        'edolino,'#39'yyyy'#39')='#39'2015'#39' and p441.chiuso='#39'S'#39
      
        '       and p442.cod_voce='#39'10240'#39' and p442.cod_voce_speciale='#39'CON' +
        'G'#39')'
      
        '    -- Verifica assenza di coniuge fiscalmente a carico almeno u' +
        'n giorno nel 2015'
      '    and not exists'
      
        '      (select '#39'x'#39' from sg101_familiari sg101 where sg101.progres' +
        'sivo=:Progressivo'
      '       and sg101.gradopar='#39'CG'#39' and sg101.tipo_detrazione='#39'DC'#39
      
        '       and '#39'2015'#39' between to_char(sg101.decorrenza,'#39'yyyy'#39') and t' +
        'o_char(sg101.decorrenza_fine,'#39'yyyy'#39')) ;'
      '  end if;       '
      'end;')
    ReadBuffer = 2
    Optimize = False
    Variables.Data = {
      0400000002000000180000003A00500052004F00470052004500530053004900
      56004F000300000000000000000000000E0000003A0052004500530055004C00
      5400030000000000000000000000}
    Left = 472
    Top = 688
  end
  object selT960CountDaLeggere: TOracleQuery
    SQL.Strings = (
      'select count(*) '
      'from   T960_DOCUMENTI_INFO T960'
      'where  T960.PROGRESSIVO = :PROGRESSIVO'
      'and    T960.DATA_LETTURA_PROGRESSIVO is null'
  ...
  object selP441CountDaLeggere: TOracleDataSet
    SQL.Strings = (
      'select '
      '  Rowid,'
      ...
      'and data_cedolino = (select max(data_cedolino) '
      '                     from p441_cedolino p441a '
      '                     where p441a.progressivo = p441.progressivo '
      '                     and p441a.chiuso = '#39'S'#39')'
      'and data_retribuzione = (select max(data_retribuzione) '
      '                         from p441_cedolino p441b '
      
        '                         where p441b.progressivo = p441.progress' +
        'ivo '
      
        '                         and p441b.data_cedolino = p441.data_ced' +
        'olino '
      '                         and p441b.chiuso = '#39'S'#39')'
      'and data_emissione = (select max(data_emissione) '
      '                      from p441_cedolino p441c '
      
        '                      where p441c.progressivo = p441.progressivo' +
        ' '
      
        '                      and p441c.data_cedolino = p441.data_cedoli' +
        'no '
      
        '                      and p441c.data_retribuzione = p441.data_re' +
        'tribuzione '
      '                      and p441c.chiuso = '#39'S'#39')'
      'and sysdate >= DATA_EMISSIONE + :WEB_CEDOLINI_GGEMISS '
      'and DATA_CEDOLINO >= :WEB_CEDOLINI_DATAMIN '
      
        'and (:WEB_CEDOLINI_MMPREC < 0 or trunc(DATA_CEDOLINO,'#39'MM'#39') >= ad' +
        'd_months(trunc(sysdate,'#39'MM'#39'),-:WEB_CEDOLINI_MMPREC))'
    ...
    Variables.Data = {
      
      49005F004D004D005000520045004300030000000000000000000000}
    OnFilterRecord = selP441FilterRecord
    Left = 792
    Top = 558
  end
  object selP504CountDaLeggere: TOracleDataSet
    SQL.Strings = (
      'select P504.PROGRESSIVO, P504.ANNO + 1 ANNO '
      'from P504_CUDTESTATE P504, P500_CUDSETUP P500'
      'where P504.PROGRESSIVO = :PROGRESSIVO'
      '  and P504.ANNO >= 2014'
      '  and P504.CHIUSO = '#39'S'#39
      '  and P504.TIPO_OPERAZIONE <> '#39'A'#39
      '  and P504.ANNO = TO_NUMBER(TO_CHAR(SYSDATE,'#39'YYYY'#39'))-1'
      '  and P504.DATA_CONSEGNA IS NULL'
  ...
  object selT030DipCF: TOracleDataSet
    SQL.Strings = (
      'select progressivo '
      'from t030_anagrafico t1 '
      'where t1.codfiscale = (select nvl(trim(t2.codfiscale),'#39'#null#'#39') '
      '                       from t030_anagrafico t2 '
      '                       where t2.progressivo = :progressivo)'
      'and t1.progressivo <> :progressivo')
    Optimize = False
    Variables.Data = {
      0400000001000000180000003A00500052004F00470052004500530053004900
      56004F00030000000000000000000000}
  ...
  object seldSG101: TOracleDataSet
    SQL.Strings = (
      
        'SELECT GRADOPAR, COGNOME, NOME, DATANAS, TIPO_DETRAZIONE, PERC_C' +
        'ARICO, DETR_FIGLIO_HANDICAP'
      'FROM SG101_FAMILIARI'
      'WHERE PROGRESSIVO = :PROGRESSIVO'
      'AND :DATA_AGG BETWEEN DECORRENZA AND DECORRENZA_FINE'
      'AND NVL(PERC_CARICO,0) > 0'
      'ORDER BY DATANAS')
    ReadBuffer = 10
    Optimize = False
    Variables.Data = {
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00004D00410054005200490043004F004C004100010000000000140000004E00
      4F004D0049004E0041005400490056004F00010000000000}
    OnCalcFields = seldSG101CalcFields
    Left = 478
    Top = 638
    object seldSG101GRADOPAR: TStringField
      FieldName = 'GRADOPAR'
      Size = 2
    end
    object seldSG101DESC_GRADO: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_GRADO'
      Size = 30
      Calculated = True
    end
    object seldSG101COGNOME: TStringField
      FieldName = 'COGNOME'
      Size = 50
    end
    object seldSG101NOME: TStringField
      FieldName = 'NOME'
      Size = 50
    end
    object seldSG101DATANAS: TDateTimeField
      FieldName = 'DATANAS'
    end
    object seldSG101TIPO_DETRAZIONE: TStringField
      FieldName = 'TIPO_DETRAZIONE'
      Size = 2
    end
    object seldSG101DESC_DETRAZIONE: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_DETRAZIONE'
      Size = 10
      Calculated = True
    end
    object seldSG101PERC_CARICO: TFloatField
      FieldName = 'PERC_CARICO'
    end
    object seldSG101DESC_PERC_CARICO: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_PERC_CARICO'
      Size = 6
      Calculated = True
    end
    object seldSG101DETR_FIGLIO_HANDICAP: TStringField
      FieldName = 'DETR_FIGLIO_HANDICAP'
      Size = 1
    end
    object seldSG101DESC_HANDICAP: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_HANDICAP'
      Size = 2
      Calculated = True
    end
  end
  object selcSG101: TOracleDataSet
    SQL.Strings = (
        ...
        'SELECT GRADOPAR, COGNOME, NOME, DATANAS, SPECIALE_ANF, INABILE_A' +
        'NF, NVL(REDDITO_ANF,0) + NVL(REDDITO_ALTRO_ANF,0) REDDITO_TOT_AN' +
        'F'
      'FROM SG101_FAMILIARI'
      'WHERE PROGRESSIVO = :PROGRESSIVO'
      'AND :DATA_AGG BETWEEN DECORRENZA AND DECORRENZA_FINE'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      00004D00410054005200490043004F004C004100010000000000140000004E00
      4F004D0049004E0041005400490056004F00010000000000}
    OnCalcFields = selcSG101CalcFields
    Left = 422
    Top = 638
    object selcSG101GRADOPAR: TStringField
      FieldName = 'GRADOPAR'
      Size = 2
    end
    object selcSG101DESC_GRADO: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_GRADO'
      Size = 30
      Calculated = True
    end
    object selcSG101COGNOME: TStringField
      FieldName = 'COGNOME'
      Size = 50
    end
    object selcSG101NOME: TStringField
      FieldName = 'NOME'
      Size = 50
    end
    object selcSG101DATANAS: TDateTimeField
      FieldName = 'DATANAS'
    end
    object selcSG101SPECIALE_ANF: TStringField
      FieldName = 'SPECIALE_ANF'
      Size = 1
    end
    object selcSG101DESC_SPECIALE: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_SPECIALE'
      Size = 2
      Calculated = True
    end
    object selcSG101INABILE_ANF: TStringField
      FieldName = 'INABILE_ANF'
      Size = 1
    end
    object selcSG101DESC_INABILE: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_INABILE'
      Size = 2
      Calculated = True
    end
    object selcSG101REDDITO_TOT_ANF: TFloatField
      FieldName = 'REDDITO_TOT_ANF'
    end
    object selcSG101DESC_REDDITO: TStringField
      FieldKind = fkCalculated
      FieldName = 'DESC_REDDITO'
      Size = 10
      Calculated = True
    end
  end
  object selT275Lookup: TOracleDataSet
    SQL.Strings = (
      ...
      '       MINMINUTI, '
      '       MAXMINUTI, '
      '       CAUSALIZZA_TIMB_INTERSECANTI,'
      '       ABBATTE_BUDGET, '
      '       NO_LIMITE_ANNUALE_LIQ'
      'from   T275_CAUPRESENZE'
      'order by CODICE')
    ReadBuffer = 100
    Optimize = False
  ...
  object selMsgNotifica: TOracleDataSet
    SQL.Strings = (
      'select :MESSAGGIO MESSAGGIO from dual')
    Optimize = False
    Left = 703
    Top = 150
  end
  object selT430CausaliAbilitate: TOracleDataSet
    SQL.Strings = (
      'select distinct'
      '         T430.ABCAUSALE1, T430.ABPRESENZA1, '
      
        '         t430f_decorrenza_dati(T430.PROGRESSIVO,T430.DATADECORRE' +
        'NZA,'#39'ABCAUSALE1,ABPRESENZA1'#39','#39'N'#39','#39'N'#39') DECORRENZA, '
      
        '         t430f_decorrenza_dati(T430.PROGRESSIVO,T430.DATADECORRE' +
        'NZA,'#39'ABCAUSALE1,ABPRESENZA1'#39','#39'N'#39','#39'S'#39') SCADENZA'
  ...
  object selT430RaggrAssenzeAbilitati: TOracleDataSet
    SQL.Strings = (
      'select T262.CODRAGGR, '
      
        '       greatest(to_date('#39'01/01/'#39'||T262.ANNO,'#39'dd/mm/yyyy'#39'),T430.D' +
        'ATADECORRENZA) DECORRENZA,'
      
        '       least(to_date('#39'31/12/'#39'||T262.ANNO,'#39'dd/mm/yyyy'#39'),T430.DATA' +
        'FINE) SCADENZA'
      
        '  from T430_STORICO T430, T262_PROFASSANN T262, T260_RAGGRASSENZ' +
        'E T260'
      ' where T430.PROGRESSIVO = :PROGRESSIVO'
      '   and T262.CODPROFILO = T430.PASSENZE  '
      
        '   and to_date('#39'01/01/'#39'||T262.ANNO,'#39'dd/mm/yyyy'#39') <= T430.DATAFIN' +
        'E'
      
        '   and to_date('#39'31/12/'#39'||T262.ANNO,'#39'dd/mm/yyyy'#39') >= T430.DATADEC' +
        'ORRENZA     '
      '   and T262.CODRAGGR = T260.CODICE'
      '   and T260.CONTASOLARE = '#39'S'#39
      '   and T430.DATADECORRENZA <= nvl(T430.FINE,T430.DATADECORRENZA)'
      '   and T430.DATAFINE >= T430.INIZIO'
      'union all'
      'select T263.CODRAGGR, T263.DAL, T263.AL'
