...
uses
  A000UInterfaccia, C018UIterAutDM,
...
type
  TW037FRichiestaScioperiDM = class(TDataModule)
    ...
    selT251MSGAUT_SI: TStringField;
    selT251MSGAUT_NO: TStringField;
...
begin
  ...
  begin
    ...
    if TipoRichiesta = T251TR_P then
      DescTipoRichiesta:='Notifica provvisoria'
    else if TipoRichiesta = T251TR_D then
      DescTipoRichiesta:='Notifica definitiva'
    else if TipoRichiesta = T251TR_E then
