...
uses
  ...
  meIWDBCheckBox, meIWCheckBox, A000UCostanti, USelT004,
  ...
  with W036DM.selSG213 do
    StampaAutomatica:=grdTabDetail.TabByIndex(2).LinkVisible and
                      (    FieldByName('DATA_COMPILAZIONE').IsNull
                       or (FieldByName('SENTENZA_CONDANNA').AsString <> VarToStr(FieldByName('SENTENZA_CONDANNA').OldValue))
                       or (FieldByName('INCOMPATIBILITA').AsString <> VarToStr(FieldByName('INCOMPATIBILITA').OldValue)));
