object W022FSchedaValutazioniDtM: TW022FSchedaValutazioniDtM
  ...
  object Q710: TOracleDataSet
    ...
    object Q710STORIA_COMMENTI_VALUTATO: TStringField
      FieldKind = fkCalculated
      FieldName = 'STORIA_COMMENTI_VALUTATO'
      Size = 4000
      Calculated = True
    end
    object Q710DATA_ACCETTAZIONE_VALUTATO: TDateTimeField
      FieldName = 'DATA_ACCETTAZIONE_VALUTATO'
    end
  end
  ...
  object Q711: TOracleDataSet
    ...
    object Q711CF_DESC_PUNTEGGIO: TStringField
      DisplayLabel = 'Descrizione punt.'
      DisplayWidth = 500
      FieldKind = fkCalculated
      FieldName = 'CF_DESC_PUNTEGGIO'
      Size = 500
      Calculated = True
    end
  end
  ...
  object selRiepilogoSchede: TOracleDataSet
    SQL.Strings = (
      'SELECT '#39'1'#39' A, /*Testata massimo stato raggiunto*/'
      
        '       SG710.CHIUSO B, T030.COGNOME || '#39' '#39' || T030.NOME || '#39' ('#39' ' +
        '|| T030.MATRICOLA || '#39')'#39' C, '
      
        '       SG710.CODREGOLA || '#39'.'#39' || TO_CHAR(SG710.STATO_AVANZAMENTO' +
        ') D,'
      
        '       DECODE(SG745.ESITO,'#39'S'#39',TO_CHAR(SG745.DATA_CONSEGNA,'#39'DD/MM' +
        '/YYYY HH24.MI'#39')) E, '
      
        '       TO_CHAR(SG710.PUNTEGGIO_FINALE_PESATO) F, SG710.VALUTABIL' +
        'E G'
      'FROM SG710_TESTATA_VALUTAZIONI SG710,'
      ...
      'UNION'
      'SELECT '#39'2'#39' A, /*Elenco di tutti gli stati*/'
      ...
      'AND SG745.TIPO_CONSEGNA (+) = '#39'PV'#39
      'UNION'
      'SELECT '#39'3'#39' A, /*Dettaglio massimo stato raggiunto*/'
  ...
  object selStoriaCommVal: TOracleQuery
    SQL.Strings = (
      'select SG710F_STORIA_COMM_VAL(:data,:progressivo,:tipo,:stato)'
      'From dual')
    Optimize = False
    Variables.Data = {
      0400000004000000180000003A00500052004F00470052004500530053004900
  ...
  object updSG710b: TOracleQuery
    SQL.Strings = (
      'update SG710_TESTATA_VALUTAZIONI'
      'set ACCETTAZIONE_VALUTATO = null'
      'where PROGRESSIVO = :PROGRESSIVO'
      'and DATA = :DATA'
      'and TIPO_VALUTAZIONE = :TIPO_VAL'
      'and STATO_AVANZAMENTO = :STATO_AVANZAMENTO')
    ...
    Variables.Data = {
      ...
      00000000000000000000120000003A005400490050004F005F00560041004C00
      050000000000000000000000240000003A0053005400410054004F005F004100
      560041004E005A0041004D0045004E0054004F00050000000000000000000000}
    Left = 272
    Top = 120
  end
  object selSG735: TOracleDataSet
    ...
    Optimize = False
    Variables.Data = {
      04000000020000000C0000003A00510055004F00540041000500000000000000
      00000000120000003A0044004100540041005F00560041004C000C0000000000
      000000000000}
    Left = 384
    Top = 120
  end
