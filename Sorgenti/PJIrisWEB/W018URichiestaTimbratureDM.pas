...
type
  TW018FRichiestaTimbratureDM = class(TDataModule)
    ...
    selT105MSGAUT_SI: TStringField;
    selT105MSGAUT_NO: TStringField;
    selT105D_CAUSALE: TStringField;
    selT105D_CAUSALE_ORIG: TStringField;
    selT106C: TOracleDataSet;
...
begin
  ...
  //Elenco causali che modificano il titolo della colonna Note
  selT106C.SetVariable('TIPO','T105C');
  selT106C.Open;
...
procedure TW018FRichiestaTimbratureDM.selT275AbilitateFilterRecord(DataSet: TDataSet; var Accept: Boolean);
begin
