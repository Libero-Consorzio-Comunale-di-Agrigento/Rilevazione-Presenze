...
uses
  ...
  meIWLink, W000UMessaggi, IWCompExtCtrls, meIWRadioGroup, meIWImageFile,
  IWCompGrids, meIWGrid;
...
begin
  ...
  DataI:=StrToDate(edtPeriodoDal.Text);
  DataF:=StrToDate(edtPeriodoAl.Text);
  if DataF < DataI then
  begin
  ...
  try
    ...
    begin
      ...
      try
        ...
        on E: Exception do
        begin
          E.Message:=Format('%s: %s',[DCOMConnection2.ServerName,E.Message]);
          raise;
        end;
      end;
      try
    ...
    begin
      ...
      try
        ...
        on E: Exception do
        begin
          E.Message:=Format('%s: %s',[DCOMConnection1.ServerName,E.Message]);
          raise;
        end;
      end;
      try
    ...
    on E:Exception do
      raise Exception.Create(Format(A000TraduzioneStringhe(A000MSG_W015_FMT_STAMPA_NON_DISPONIB),[E.message]));
  end;
end;
