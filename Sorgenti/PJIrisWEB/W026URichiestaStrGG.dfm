inherited W026FRichiestaStrGG: TW026FRichiestaStrGG
  ...
  object btnConfermaAut: TmeIWButton [15]
    Left = 85
    Top = 190
    Width = 177
    Height = 25
    ...
    Font.Size = 10
    Font.Style = []
    FriendlyName = 'btnConfermaAut'
    TabOrder = 9
    OnClick = btnConfermaAutClick
    medpDownloadButton = False
  end
  ...
  object cdsGestMese: TClientDataSet
    ...
    object cdsGestMeseID_SPEZZONE_ACCORPATO: TIntegerField
      FieldName = 'ID_SPEZZONE_ACCORPATO'
      Visible = False
    end
  end
