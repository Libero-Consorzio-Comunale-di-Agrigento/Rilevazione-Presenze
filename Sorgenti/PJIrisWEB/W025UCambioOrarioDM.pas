...
type
  ...
  private
    ...
    procedure RicavaDatiOrario(Orario: String; Data: TDateTime);
  public
    { Public declarations }
    function RicavaDescrizioneOrario(Orario: String; Data: TDateTime): String;
    function RicavaOrariScambioOrario(Orario: String; Data: TDateTime): String;
  end;
...
function TW025FCambioOrarioDM.RicavaDescrizioneOrario(Orario: String; Data: TDateTime): String;
begin
  Result:='';
  RicavaDatiOrario(Orario,Data);
  if not selaT020.Eof then
    Result:=selaT020.FieldByName('DESCRIZIONE').AsString;
end;

function TW025FCambioOrarioDM.RicavaOrariScambioOrario(Orario: String; Data: TDateTime): String;
begin
  Result:='';
  RicavaDatiOrario(Orario,Data);
  if not selaT020.Eof then
    Result:=selaT020.FieldByName('ORARI_SCAMBIO').AsString;
end;

procedure TW025FCambioOrarioDM.RicavaDatiOrario(Orario: String; Data: TDateTime);
begin
  R180SetVariable(selaT020,'ORARIO',Orario);
  R180SetVariable(selaT020,'DATA',Data);
  selaT020.Open;
end;
