object W032FRichiestaMissioniDM: TW032FRichiestaMissioniDM
  ...
  object selM140: TOracleDataSet
    ...
    object selM140MSGAUT_SI: TStringField
      FieldName = 'MSGAUT_SI'
      Size = 2000
    end
    object selM140MSGAUT_NO: TStringField
      FieldName = 'MSGAUT_NO'
      Size = 2000
    end
    object selM140CAPITOLO_TRASFERTA: TStringField
  ...
  object selM160: TOracleDataSet
    ...
    object selM160C_QTA_SPETTANTE: TStringField
      FieldKind = fkCalculated
      FieldName = 'C_QTA_SPETTANTE'
      Size = 15
      Calculated = True
    end
  ...
  object selM150: TOracleDataSet
    ...
    object selM150TIPORIMBORSO: TStringField
  ...
  object selM042Count: TOracleQuery
    SQL.Strings = (
      'select count(CODICE) NUM_REC_TOT, '
      '       count(COD_ISTAT) NUM_REC_CODISTAT'
      'from   M042_LOCALITA')
    ReadBuffer = 2
    Optimize = False
    Left = 656
  ...
  object selM042: TOracleDataSet
    SQL.Strings = (
      'select m042.codice, m042.cod_istat'
      'from   m042_localita m042'
      'order by 1')
    ReadBuffer = 500
    Optimize = False
    SequenceField.ApplyMoment = amOnNewRecord
  ...
  object selM030: TOracleDataSet
    SQL.Strings = (
      'select CODICE,DESCRIZIONE from M030_CAPITOLI_TRASFERTA M030'
      'where :DATAA between M030.DECORRENZA and M030.DECORRENZA_FINE'
      
        'and V430F_CHEKANAGRAFE(:PROGRESSIVO,:DATAA,M030.FILTRO_ANAGRAFE)' +
        ' = '#39'S'#39
      
        'and INTERSEZ_LISTE(nvl(M030.TIPO_MISSIONE,:TIPOREGISTRAZIONE),:T' +
        'IPOREGISTRAZIONE) = :TIPOREGISTRAZIONE'
      '')
    Optimize = False
    Variables.Data = {
      }
    QBEDefinition.QBEFieldDefs = {
      05000000060000002400000043004F0044005F004100520052004F0054004F00
      4E00440041004D0045004E0054004F000100000000001400000043004F004400
      5F00560041004C00550054004100010000000000140000004400450043004F00
  ...
  object selColsDefaultValues: TOracleDataSet
    SQL.Strings = (
      
        'select COLUMN_NAME,MEDPF_LONG2CHAR(TABLE_NAME,COLUMN_NAME) DEFAU' +
        'LT_VALUE'
      'from COLS'
      
        'where (TABLE_NAME = '#39'M140_RICHIESTE_MISSIONI'#39' and COLUMN_NAME in' +
        ' ('#39'FLAG_ISPETTIVA'#39','#39'FLAG_DESTINAZIONE'#39'))'
      
        'or (TABLE_NAME = '#39'M170_RICHIESTE_MEZZI'#39' and COLUMN_NAME in ('#39'COR' +
        'RESPONSIONE_SPESE'#39'))')
    Optimize = False
    Left = 768
    Top = 16
  end
  object selM030Count: TOracleDataSet
    SQL.Strings = (
      'select count(*) from M030_CAPITOLI_TRASFERTA M030')
    ReadBuffer = 2
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      05000000060000002400000043004F0044005F004100520052004F0054004F00
  ...
  object selM049: TOracleDataSet
    SQL.Strings = (
      'select M049.*'
      '  from M049_TIPOPAGAMENTO M049'
      ' order by M049.CODICE')
    Optimize = False
    Left = 32
    Top = 360
  end
  object scrCheckPercorso: TOracleQuery
    ReadBuffer = 2
    Optimize = False
    Left = 656
    Top = 440
