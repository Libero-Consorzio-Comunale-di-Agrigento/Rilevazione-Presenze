inherited P552FRegoleContoAnnualeMW: TP552FRegoleContoAnnualeMW
  OldCreateOrder = True
  ...
  object selP552Righe: TOracleDataSet
    ...
    AfterPost = selP552RigheColonneAfterPost
    BeforeDelete = selP552RigheColonneBeforeDelete
    AfterDelete = selP552RigheColonneAfterDelete
    OnCalcFields = selP552RigheColonneCalcFields
    Left = 200
    Top = 40
    ...
    object selP552RighePARAMETRO_2: TStringField
      DisplayLabel = 'Parametro 2'
      DisplayWidth = 19
      FieldName = 'PARAMETRO_2'
      Size = 1000
    end
    ...
    object selP552RigheSCRIPT_INIZIALE: TStringField
  ...
  object selP552Colonne: TOracleDataSet
    ...
    object selP552ColonnePARAMETRO_2: TStringField
      DisplayLabel = 'Parametro 2'
      DisplayWidth = 10
      FieldName = 'PARAMETRO_2'
      Size = 1000
    ...
    object selP552ColonneDATA_ACCORPAMENTO: TStringField
      DisplayLabel = 'Data accorpamento'
      FieldName = 'DATA_ACCORPAMENTO'
      Visible = False
      Size = 2
    end
    ...
    object selP552ColonneSCRIPT_INIZIALE: TStringField
      DisplayLabel = 'Script iniziale'
      FieldName = 'SCRIPT_INIZIALE'
      Visible = False
      Size = 1500
