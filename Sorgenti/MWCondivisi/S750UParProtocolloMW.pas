...
const
  DatiTipoA:array [1..29] of TDati = (
    ...
    (Ord:27;  Tipo:'DOSSIERLIST.NUMBER';                Desc:'dossierList.number';                Dato:'<#>MATRICOLA<#>'),
    (Ord:28;  Tipo:'DOSSIERLIST.OFFICECODE';            Desc:'dossierList.officeCode';            Dato:'14.00.00'),
    (Ord:29;  Tipo:'DOSSIERLIST.REGISTRYCODE';          Desc:'dossierList.registryCode';          Dato:'PERS'));
