inherited P554FElaborazioneContoAnnualeMW: TP554FElaborazioneContoAnnualeMW
  OldCreateOrder = True
  ...
  object selP552: TOracleDataSet
    SQL.Strings = (
        ...
        '1'#39',TIPO_TABELLA_RIGHE) TIPO_TABELLA_RIGHE, VALORE_COSTANTE, TRIM' +
        '(SCRIPT_INIZIALE) SCRIPT_INIZIALE'
  ...
  object selP500: TOracleDataSet
    SQL.Strings = (
      ...
      'AND P1.COD_AZIENDA_BASE = :COD_AZIENDA_BASE')
    Optimize = False
    Variables.Data = {
      04000000020000000A0000003A0041004E004E004F0005000000000000000000
      0000220000003A0043004F0044005F0041005A00490045004E00440041005F00
      4200410053004500050000000000000000000000}
    OracleDictionary.DefaultValues = True
    QBEDefinition.QBEFieldDefs = {
      050000000C0000000800000041004E004E004F000100000000000A0000005000
      41005200540045000100000000000C0000004E0055004D00450052004F000100
  ...
  object selP555: TOracleDataSet
    SQL.Strings = (
      'SELECT :IdCONTANN, -1, RIGA,COLONNA,SUM(VALORE) DATO '
      'FROM P555_CONTOANNDATIINDIVIDUALI P555'
      'WHERE ID_CONTOANN = :IdCONTANN'
      'AND (:CodAziendaBase = '#39'*'#39' OR '
      '     EXISTS (SELECT '#39'X'#39' FROM T430_STORICO T430'
      '             WHERE T430.PROGRESSIVO = P555.PROGRESSIVO'
      
        '             AND :DataElaborazione BETWEEN T430.DATADECORRENZA A' +
        'ND T430.DATAFINE'
      '             AND T430.AZIENDA_BASE = :CodAziendaBase))'
      'GROUP BY RIGA,COLONNA')
    Optimize = False
    Variables.Data = {
      
  ...
  object dsrAziendeBase: TDataSource
    AutoEdit = False
    Left = 32
    Top = 241
  end
  object ScriptIniziale: TOracleQuery
    SQL.Strings = (
      '')
    Optimize = False
    Left = 322
