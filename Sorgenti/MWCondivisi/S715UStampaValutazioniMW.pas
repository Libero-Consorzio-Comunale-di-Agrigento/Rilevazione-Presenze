...
uses
  ...
  OracleData,Variants, A000UInterfaccia, C180FunzioniGenerali, StrUtils;
...
type
  ...
  public
    function ListSG746(DIni,DFin:TDateTime;var StatiSel:String):TElencoValoriChecklist;
...
function TS715FStampaValutazioniMW.ListSG746(DIni,DFin:TDateTime;var StatiSel:String):TElencoValoriChecklist;
var Codice,StatiSelApp: String;
begin
  ...
  begin
    Close;
    SetVariable('DECORRENZA',DIni);
    SetVariable('DECORRENZA_FINE',DFin);
    Open;
    First;
    while not Eof do
    begin
      ...
      if R180InConcat(Codice,StatiSel) then
        StatiSelApp:=StatiSelApp + IfThen(StatiSelApp <> '',',') + Codice;
      Next;
    end;
  end;
  StatiSel:=StatiSelApp;
end;
