...
uses
  ...
  A000UInterfaccia, Variants, A000UMessaggi, A000UCostanti, Math, StrUtils;
...
type
  TP655FDatiINPDAPMMMW = class(TR005FDataModuleMW)
    ...
    selP660PARTE: TStringField;
    selP660NUMERO: TStringField;
    selP660DESCRIZIONE: TStringField;
    selP660NUMERICO: TStringField;
    selP660COD_ARROTONDAMENTO: TStringField;
    selP660FORMATO: TStringField;
    selP660TIPO_DATO: TStringField;
...
begin
  ...
  selP660.SetVariable('TIPO_DATO','I');//default
  selP660.SetVariable('ORDERBY','ORDER BY PARTE, NUMERO');
  selP660.Close;
  selP660.Open;
end;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Result:=A000MSG_MSG_ARROTONDAMENTO_NON_ESISTE;
        Exit;
      end;
    end;
    //Arrotondamento
...
begin
  R180SetVariable(selP660,'TIPO_DATO',IfThen(TipoDati = 0,'I','R'));
  selP660.Open;
end;
...
begin
  ...
  Result:=Format(A000MSG_DLG_FMT_CANCELLA_TESTATA,[NumDip])
end;
