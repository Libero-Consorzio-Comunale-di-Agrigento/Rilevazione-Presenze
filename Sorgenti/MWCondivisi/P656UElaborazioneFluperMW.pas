...
type
  ...
  public
    ...
    function VerificaAlternativaParteAK(DataElaborazione: TDateTime): String;
...
function TP656FElaborazioneFluperMW.VerificaAlternativaParteAK(DataElaborazione: TDateTime): String;
begin
  Result:='';
  selP660.SetVariable('DataElaborazione',DataElaborazione);
  selP660.Close;
  selP660.Open;
  if selP660.FieldByName('PARTE').AsString = 'K' then
    Result:='K'
  else
    Result:='A';
end;
