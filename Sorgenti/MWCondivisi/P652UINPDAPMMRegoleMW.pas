...
type
  ...
  public
    ...
    function CanRelazioniTabelle: Boolean;
...
function TP652FINPDAPMMRegoleMW.CanRelazioniTabelle: Boolean;
begin
 Result:=(selP660_Funzioni.FieldByName('NOME_FLUSSO').AsString = 'FLUPER') and (selP660_Funzioni.FieldByName('PARTE').AsString = 'B') and (Trim(selP660_Funzioni.FieldByName('NOME_DATO').AsString) <> '') and
    ((selP660_Funzioni.FieldByName('NUMERO').AsString = '008') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '009') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '092') or  //Struttura Impiego
     (selP660_Funzioni.FieldByName('NUMERO').AsString = '010') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '011') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '012') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '013') or //Dipart.Impiego
     (selP660_Funzioni.FieldByName('NUMERO').AsString = '014') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '016') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '018') or  //UO Impiego Strut.1
     (selP660_Funzioni.FieldByName('NUMERO').AsString = '020') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '022') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '024') or  //UO Impiego Strut.2
     (selP660_Funzioni.FieldByName('NUMERO').AsString = '093') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '094') or (selP660_Funzioni.FieldByName('NUMERO').AsString = '095'));   //UO Impiego Strut.3
end;
