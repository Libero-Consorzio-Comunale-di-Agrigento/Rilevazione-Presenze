...
type
  TB110FRichiesteTimbDM = class(TR016FDatasnapRestRichiesteDM)
  protected
...
{ TB110FRichiesteTimbraturaDM }

procedure TB110FRichiesteTimbDM.Esegui(var RRisultato: TRisultato);
var
...
begin
  ...
  try
    ...
    RRisultato.Output:=TOutputRichiesteTimb.Create;
    LRes:=TOutputRichiesteTimb(RRisultato.Output);
