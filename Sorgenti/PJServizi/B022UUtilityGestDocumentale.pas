...
begin
  try
    ...
    try
      ...
      begin
        DimensioneTotale:=DimensioneTotale + dbgT960.DataSource.DataSet.FieldByName('DIMENSIONE').AsFloat;
    ...
    if DimensioneTotale > MaxInt then
      lblDimensioneTotale.Caption:='Dimensione totale: > ' + R180GetFileSizeStr(MaxInt)
    else
      lblDimensioneTotale.Caption:='Dimensione totale: ' + R180GetFileSizeStr(Round(DimensioneTotale));
