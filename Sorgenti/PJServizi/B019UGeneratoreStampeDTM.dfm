object B019FGeneratoreStampeDtM: TB019FGeneratoreStampeDtM
  ...
  object selT926: TOracleDataSet
    SQL.Strings = (
      ...
      'where ID = :ID'
      'order by ORDINE,APPLICAZIONE,CODICE_STAMPA'
      '')
    Optimize = False
    ...
    object selT926EMAIL_INDIRIZZI_A: TStringField
      DisplayLabel = 'Email - destinatari A'
      DisplayWidth = 30
      FieldName = 'EMAIL_INDIRIZZI_A'
      Size = 2000
    end
    object selT926EMAIL_INDIRIZZI_CC: TStringField
      DisplayLabel = 'Email - destinatari CC'
      DisplayWidth = 30
      FieldName = 'EMAIL_INDIRIZZI_CC'
      Size = 2000
    end
    object selT926EMAIL_INDIRIZZI_CCN: TStringField
      DisplayLabel = 'Email - destinatari CCN'
      DisplayWidth = 30
      FieldName = 'EMAIL_INDIRIZZI_CCN'
      Size = 2000
    end
    object selT926EMAIL_OGGETTO: TStringField
      DisplayLabel = 'Email - oggetto'
      DisplayWidth = 30
      FieldName = 'EMAIL_OGGETTO'
      Size = 2000
    end
    object selT926EMAIL_TESTO: TStringField
      DisplayLabel = 'Email - testo'
      DisplayWidth = 30
      FieldName = 'EMAIL_TESTO'
      Size = 2000
    end
    object selT926EMAIL_INDIRIZZI_NOTIFICA_ELAB: TStringField
      DisplayLabel = 'Email - destinatari notifiche'
      DisplayWidth = 30
      FieldName = 'EMAIL_INDIRIZZI_NOTIFICA_ELAB'
      Size = 2000
    end
  end
