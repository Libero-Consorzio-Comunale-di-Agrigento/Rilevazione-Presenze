...
var
  ...
  begin
    ...
    begin
      ...
      PTimb.FDescCausale:=R502ProDtM.tanom2riscontrate[0].ta2testo;//R500Lin.tdescanom2[R502ProDtM.tanom2riscontrate[0].ta2puntdesc].D;
    end;
  end;
const
...
begin
  ...
  Result.AddPair('start',TJSONString.Create(TB021FUtils.ConvertiDateStr(ElencoTimb.FDataInizio)));
  Result.AddPair('end',TJSONString.Create(TB021FUtils.ConvertiDateStr(ElencoTimb.FDataFine)));
  ...
  begin
    ...
    hObj.AddPair('day',TJSONString.Create(TB021FUtils.ConvertiDateStr(Timb.FData)));
