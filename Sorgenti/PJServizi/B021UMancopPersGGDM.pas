...
begin
  Result:=DateToStr(PData,TB021FUtils.CreateFormatSettingsMonzaHSGerardo);
end;

function TB021FMancopPersGGDM.B021DateTimeToStr(const PData: TDateTime): String;
begin
  Result:=DateTimeToStr(PData,TB021FUtils.CreateFormatSettingsMonzaHSGerardo);
end;

function TB021FMancopPersGGDM.B021TryStrToDate(const PDataStr: String; var RData: TDateTime): Boolean;
begin
  Result:=TryStrToDate(PDataStr,RData,TB021FUtils.CreateFormatSettingsMonzaHSGerardo);
end;
