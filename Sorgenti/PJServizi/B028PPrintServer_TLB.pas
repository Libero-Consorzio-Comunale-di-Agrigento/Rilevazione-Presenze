...
// $Rev: 8291 $
// File generated on 15/12/2008 18.14.38 from Type Library described below.

// ************************************************************************  //
// Type Lib: Z:\Sviluppo\PJIrisWIN\A077PCOMServer.tlb (1)
...
// *********************************************************************//
  IA077COMServer = interface(IAppServer)
    ...
    procedure CreaStampa(const SelezioneAnagrafica: WideString; const CodiceStampa: WideString; 
                         const FilePDF: WideString; const Operatore: WideString; 
                         const Azienda: WideString; const Applicazione: WideString; 
                         const DBServer: WideString; Dal: TDateTime; Al: TDateTime; 
...
// *********************************************************************//
  IA077COMServerDisp = dispinterface
    ...
    procedure CreaStampa(const SelezioneAnagrafica: WideString; const CodiceStampa: WideString; 
                         ...
                         const Azienda: WideString; const Applicazione: WideString; 
                         const DBServer: WideString; Dal: TDateTime; Al: TDateTime; 
                         var DettaglioLog: OleVariant); dispid 301;
