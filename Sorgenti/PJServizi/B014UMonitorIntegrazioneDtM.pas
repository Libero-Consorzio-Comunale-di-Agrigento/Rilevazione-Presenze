...
procedure TB014FMonitorIntegrazioneDtM.AllineaAziendaIA110;
var
  Campo:String;
  NomeDato:String;
begin
  if selIA100.FieldByName('AZIENDA').AsString <> '*' then
  begin
    ...
    try
      ...
      begin
        if selIA110.FieldByName('AZIENDA').AsString <> '*' then
        begin
          selIA110.Edit;
          selIA110.FieldByName('AZIENDA').AsString:='*';
          selIA110.Post;
        end;
        selIA110.Next;
      end;
    ...
    if not selIA110.SearchRecord('CAMPO;NOME_DATO',VarArrayOf([Campo,NomeDato]),[srFromBeginning]) then
      selIA110.First;
  end;
end;
